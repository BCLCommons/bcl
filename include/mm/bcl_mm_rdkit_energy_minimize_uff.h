...
#ifndef BCL_MM_RDKIT_ENERGY_MINIMIZE_UFF_H_
#define BCL_MM_RDKIT_ENERGY_MINIMIZE_UFF_H_
...
#include "bcl_mm_rdkit_energy_uff.h"
...
namespace bcl
{
  namespace mm
  {
    ...
    //! @brief This class performs energy minimization (geometry optimization) using the Universal Force Field (UFF)
    //! implemented in RDKit. Working energy unit is kcal/mol. Any energy conversion is done after the calculation.
    //!
    //! @see @link example_mm_rdkit_energy_minimize_uff.cpp @endlink
    //! @author brownbp1
    //! @date Dec 20, 2022
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API RdkitEnergyMinimizeUff :
      public RDKitEnergyUFF
    {
    ...
    //////////////////////////////////
      ...
      RdkitEnergyMinimizeUff *Clone() const;
...
#endif // BCL_MM_RDKIT_ENERGY_MINIMIZE_UFF_H_
