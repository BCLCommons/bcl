...
#ifndef BCL_CHEMISTRY_CONSTITUTION_GRAPH_CONVERTER_H_
#define BCL_CHEMISTRY_CONSTITUTION_GRAPH_CONVERTER_H_
...
namespace bcl
{
  namespace chemistry
  {
    ...
    //!
    //! @see @link example_chemistry_constitution_graph_converter.cpp @endlink
    //! @author mendenjl
    //! @date Jan 24, 2012
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ConstitutionGraphConverter :
    ...
    //////////
      ...
      ConstitutionalBondTypeData::DataEnum  m_BondRepresentation; //!< method of representing bonds as size_ts in the graph
    ...
    //////////////////////////////////
      ...
      //! @brief default constructor, compares by atom type, chirality, and e_BondOrderAmideOrAromaticWithRingness
      ConstitutionGraphConverter();
      ...
      ConstitutionGraphConverter *Clone() const;
    ...
    ////////////////
      ...
      graph::ConstGraph< size_t, size_t> operator()( const ConstitutionInterface &CONSTITUTION) const;
    ...
    //////////////////////
      ...
      size_t GetAtomData( const AtomConstitutionalInterface &ATOM) const;
...
#endif // BCL_CHEMISTRY_CONSTITUTION_GRAPH_CONVERTER_H_
