...
#ifndef BCL_CHEMISTRY_FRAGMENT_MUTATE_ADD_H_
#define BCL_CHEMISTRY_FRAGMENT_MUTATE_ADD_H_
...
namespace bcl
{
  namespace chemistry
  {
    ...
    class BCL_API FragmentMutateAdd :
...
#endif //BCL_CHEMISTRY_FRAGMENT_MUTATE_ADD_H_
