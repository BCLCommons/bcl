...
#ifndef BCL_CHEMISTRY_HYDROGENS_HANDLER_H_
#define BCL_CHEMISTRY_HYDROGENS_HANDLER_H_
...
namespace bcl
{
  namespace chemistry
  {
    ...
    //!
    //! @see @link example_chemistry_hydrogens_handler.cpp @endlink
    //! @author mendenjl, kothiwsk
    //! @date Feb 01, 2012
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class BCL_API HydrogensHandler :
    ...
    ///////////////
      ...
      //! @param ADD_H whether to add hydrogen to each atom, if H_PREF = e_SaturatePartial
      static void HandleHydrogenPref
      (
      ...
      //! @brief handles hydrogens for atoms complete
      //! @param ATOMS the fragment to add hydrogens to
      static void Saturate( AtomVector< AtomComplete> &ATOMS);

      //! @brief removes hydrogens for atoms complete
      //! @param ATOMS the fragment from which hydrogens will be removed
      static void Remove( AtomVector< AtomComplete> &ATOMS);

      //! @brief handles hydrogens for atoms complete
      //! @param ATOMS the fragment to add hydrogens to
      static void SaturatePartial( AtomVector< AtomComplete> &ATOMS, const storage::Vector< size_t> &ADD_H);
    ...
    public:
      ...
      static storage::Vector< linal::Vector3D> DetermineCoordinates( const AtomComplete &ATOM);
      ...
      static void SetUndefinedHCoordinates( const AtomComplete &ATOM, AtomVector< AtomComplete> &VECT);

      //! @brief Set any H coordinates that are undefined
      static void UpdateHCoordinates( const AtomComplete &ATOM, AtomVector< AtomComplete> &VECT);
...
#endif // BCL_CHEMISTRY_HYDROGENS_HANDLER_H_
