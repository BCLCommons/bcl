...
#ifndef BCL_CHEMISTRY_FRAGMENT_SPLIT_RINGS_H_
#define BCL_CHEMISTRY_FRAGMENT_SPLIT_RINGS_H_
...
namespace bcl
{
  namespace chemistry
  {
    ...
    //!
    //! @see @link example_chemistry_fragment_split_rings.cpp @endlink
    //! @author kothiwsk, mendenjl
    //! @date Oct 23, 2012
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API FragmentSplitRings :
    ...
    //////////////////////////////////
      ...
      FragmentSplitRings *Clone() const;
      ...
      FragmentSplitRings( bool GET_RINGS, const size_t MIN_SIZE = size_t( 2));
...
#endif // BCL_CHEMISTRY_FRAGMENT_SPLIT_RINGS_H_
