...
#ifndef BCL_CHEMISTRY_FRAGMENT_DOCK_ENGINE_H_
#define BCL_CHEMISTRY_FRAGMENT_DOCK_ENGINE_H_
...
namespace bcl
{
  namespace chemistry
  {
    ...
    class BCL_API FragmentDockEngine :
    ...
    private:
      ...
      mutable SampleConformations m_SampleConfs;

      //! per-atom b-factor of the binding pocket
      mutable storage::Vector< double> m_BFactors;

      //! score by which to judge protein-ligand fit
      const descriptor::CheminfoProperty m_Scorer;
    ...
    //////////////////////////////////
      ...
      FragmentDockEngine *Clone() const;
    ...
    ////////////////
      ...
      FragmentComplete TransformCoordinates
      (
        const FragmentComplete &MOLECULE
      ) const;
      ...
      FragmentEnsemble SampleLigandConfsLocal
      (
        const FragmentComplete &MOLECULE
      ) const;
      ...
      FragmentEnsemble SampleLigandConfsGlobal
      (
        const FragmentComplete &MOLECULE
      ) const;
...
#endif // BCL_CHEMISTRY_FRAGMENT_DOCK_ENGINE_H_
