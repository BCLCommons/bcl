...
#ifndef BCL_CHEMISTRY_CONFORMATION_COMPARISON_BY_RMSD_H_
#define BCL_CHEMISTRY_CONFORMATION_COMPARISON_BY_RMSD_H_
...
namespace bcl
{
  namespace chemistry
  {
    ...
    //!
    //! @see @link example_chemistry_conformation_comparison_by_rmsd.cpp @endlink
    //! @author kothiwsk, mendenjl
    //! @date Mar 05, 2012
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ConformationComparisonByRmsd :
      ...
      public signal::Slots
    {
      ...
      mutable storage::HashMap< size_t, quality::RMSDPreprocessor> m_Cache;
    ...
    //////////////////////////////////
      ...
      ConformationComparisonByRmsd *Clone() const;
...
#endif // BCL_CHEMISTRY_CONFORMATION_COMPARISON_BY_RMSD_H_
