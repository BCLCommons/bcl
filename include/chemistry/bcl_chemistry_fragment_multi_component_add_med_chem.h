...
#ifndef BCL_CHEMISTRY_FRAGMENT_MULTI_COMPONENT_ADD_MED_CHEM_H_
#define BCL_CHEMISTRY_FRAGMENT_MULTI_COMPONENT_ADD_MED_CHEM_H_
...
namespace bcl
{
  namespace chemistry
  {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //!
    //! @class FragmentMultiComponentAddMedChem
    //! @brief Simultaneously append multiple fragments to a starting scaffold using Rb, Sr, Y, and Zr as attachment point
    //! dummy atoms.
    //!
    //! @see @link example_chemistry_fragment_multi_component_add_med_chem.cpp @endlink
    //! @author brownbp1
    //! @date Mar 04, 2022
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API FragmentMultiComponentAddMedChem :
    ...
    private:
      ...
      util::ShPtr< FragmentEnsemble> m_FragmentPoolRb;
      util::ShPtr< FragmentEnsemble> m_FragmentPoolSr;
      util::ShPtr< FragmentEnsemble> m_FragmentPoolY;
      util::ShPtr< FragmentEnsemble> m_FragmentPoolZ;
      std::string m_MedChemFilenameRb;
      std::string m_MedChemFilenameSr;
      std::string m_MedChemFilenameY;
      std::string m_MedChemFilenameZ;

      //! reactive atoms
      storage::Set< ElementType> m_Elements;

      //! remove excess dummy atoms post-reaction
      bool m_RemoveExcessDummyAtoms;

      //! remove undefined atoms
      bool m_RemoveUndefinedAtoms;
    ...
    //////////////////////////////////
      ...
      FragmentMultiComponentAddMedChem();
      ...
      FragmentMultiComponentAddMedChem *Clone() const;
    ...
    ////////////////
      ...
      storage::Pair< FragmentComplete, size_t> ChooseFragmentFromPool
      (
...
#endif //BCL_CHEMISTRY_FRAGMENT_MULTI_COMPONENT_ADD_MED_CHEM_H_
