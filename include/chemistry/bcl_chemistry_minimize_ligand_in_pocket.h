...
#ifndef BCL_CHEMISTRY_MINIMIZE_LIGAND_IN_POCKET_H_
#define BCL_CHEMISTRY_MINIMIZE_LIGAND_IN_POCKET_H_
...
namespace bcl
{
  namespace chemistry
  {
    ...
    //!
    //! @see @link example_chemistry_minimize_ligand_in_pocket.cpp @endlink
    //! @author brownbp1, mendenjl
    //! @date Jan 04, 2019
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MinimizeLigandInPocket :
    ...
    private:
      ...
      //! max number of unimproved iterations allowed
      const size_t m_IterationLimit;

      //! start the ligand centered at this position
      const linal::Vector3D m_StartPosition;
    ...
    //////////////////////////////////
      ...
      MinimizeLigandInPocket *Clone() const;
    ...
    ////////////////
      ...
      storage::Pair< FragmentComplete, double> OrientLigandInPocketEngine
      (
...
#endif // BCL_CHEMISTRY_MINIMIZE_LIGAND_IN_POCKET_H_
