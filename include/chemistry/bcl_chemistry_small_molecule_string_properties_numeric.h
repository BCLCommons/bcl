...
#ifndef BCL_CHEMISTRY_SMALL_MOLECULE_STRING_PROPERTIES_NUMERIC_H_
#define BCL_CHEMISTRY_SMALL_MOLECULE_STRING_PROPERTIES_NUMERIC_H_
...
namespace bcl
{
  namespace chemistry
  {
    ...
    //!
    //! @see @link example_chemistry_small_molecule_string_properties_numeric.cpp @endlink
    //! @author mendenjl
    //! @date Nov 29, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API SmallMoleculeStringPropertiesNumeric :
    ...
    //////////
      ...
      //! own pointer to the property
      mutable descriptor::CheminfoProperty m_Property;
    ...
    //////////////////////////////////
      ...
      SmallMoleculeStringPropertiesNumeric( const std::string &ALIAS = "Numeric");

      //! virtual copy constructor
      SmallMoleculeStringPropertiesNumeric *Clone() const;
...
#endif // BCL_CHEMISTRY_SMALL_MOLECULE_STRING_PROPERTIES_NUMERIC_H_
