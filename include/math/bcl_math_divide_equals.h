...
#ifndef BCL_MATH_DIVIDE_EQUALS_H_
#define BCL_MATH_DIVIDE_EQUALS_H_
...
namespace bcl
{
  namespace math
  {
    ...
    //////////////////////////////////
      ...
      DivideEquals *Clone() const
      {
        return new DivideEquals( *this);
      }
    ...
    /////////////////
      ...
      {
        static const std::string s_name( "Divide");
        return s_name;
      }
    ...
    template< typename t_ArgumentType>
    const util::SiPtr< const util::ObjectInterface> DivideEquals< t_ArgumentType>::s_Instance
    (
      util::Enumerated< AssignmentOperationInterface< t_ArgumentType> >::AddInstance( new DivideEquals< t_ArgumentType>())
    );
  ...
  /////////////////////////////
    ...
    BCL_EXPIMP_TEMPLATE template class BCL_API DivideEquals< double>;
    BCL_EXPIMP_TEMPLATE template class BCL_API DivideEquals< float>;

  } // namespace math
} // namespace bcl

#endif // BCL_MATH_DIVIDE_EQUALS_H_
