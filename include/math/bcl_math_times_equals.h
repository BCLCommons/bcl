...
#ifndef BCL_MATH_TIMES_EQUALS_H_
#define BCL_MATH_TIMES_EQUALS_H_
...
namespace bcl
{
  namespace math
  {
    ...
    //////////////////////////////////
      ...
      TimesEquals *Clone() const
      {
        return new TimesEquals( *this);
      }
    ...
    /////////////////
      ...
      //! @return overwritten to return true
    ...
    }; // template class TimesEquals

    // register the class with the enumerated class instance
    template< typename t_ArgumentType>
    const util::SiPtr< const util::ObjectInterface> TimesEquals< t_ArgumentType>::s_Instance
    (
      util::Enumerated< AssignmentOperationInterface< t_ArgumentType> >::AddInstance( new TimesEquals< t_ArgumentType>())
    );
  ...
  /////////////////////////////
    ...
    BCL_EXPIMP_TEMPLATE template class BCL_API TimesEquals< double>;
    BCL_EXPIMP_TEMPLATE template class BCL_API TimesEquals< float>;

  } // namespace math
} // namespace bcl

#endif // BCL_MATH_TIMES_EQUALS_H_
