...
#ifndef BCL_MATH_MINUS_EQUALS_H_
#define BCL_MATH_MINUS_EQUALS_H_
...
namespace bcl
{
  namespace math
  {
    ...
    /////////////////
      ...
      {
        static const std::string s_name( "Subtract");
        return s_name;
      }
    ...
    }; // template class MinusEquals

    // register the class with the enumerated class instance
    template< typename t_ArgumentType>
    const util::SiPtr< const util::ObjectInterface> MinusEquals< t_ArgumentType>::s_Instance
    (
      util::Enumerated< AssignmentOperationInterface< t_ArgumentType> >::AddInstance( new MinusEquals< t_ArgumentType>())
    );
  ...
  /////////////////////////////
    ...
    BCL_EXPIMP_TEMPLATE template class BCL_API MinusEquals< double>;
    BCL_EXPIMP_TEMPLATE template class BCL_API MinusEquals< float>;

  } // namespace math
} // namespace bcl

#endif // BCL_MATH_MINUS_EQUALS_H_
