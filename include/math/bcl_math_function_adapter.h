...
#ifndef BCL_MATH_FUNCTION_ADAPTER_H_
#define BCL_MATH_FUNCTION_ADAPTER_H_
...
namespace bcl
{
  namespace math
  {
    ...
    //! one a->c
    //!
    //! @see @link example_math_function_adapter.cpp @endlink
    //! @author woetzen
    //! @date 08.06.2009
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////
      ...
      //! first function a->b
      util::ShPtr< FunctionInterfaceSerializable< t_ArgumentType, t_IntermediateType> > m_FunctionAB;

      //! second Function b->c
      util::ShPtr< FunctionInterfaceSerializable< t_IntermediateType, t_ResultType> > m_FunctionBC;
    ...
    //////////////////////////////////
      ...
      FunctionAdapter
      (
        const util::ShPtr< FunctionInterfaceSerializable< t_ArgumentType, t_IntermediateType> > &SP_FUNCTION_AB,
        const util::ShPtr< FunctionInterfaceSerializable< t_IntermediateType, t_ResultType> > &SP_FUNCTION_BC
      ) :
      ...
      FunctionAdapter< t_ArgumentType, t_IntermediateType, t_ResultType> *Clone() const
      {
        return new FunctionAdapter< t_ArgumentType, t_IntermediateType, t_ResultType>( *this);
      }
    ...
    }; // template class FunctionAdapter

  } // namespace math
} // namespace bcl

#endif //BCL_MATH_FUNCTION_ADAPTER_H_
