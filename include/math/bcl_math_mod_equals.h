...
#ifndef BCL_MATH_MOD_EQUALS_H_
#define BCL_MATH_MOD_EQUALS_H_
...
namespace bcl
{
  namespace math
  {
    ...
    /////////////////
      ...
      {
        static const std::string s_name( "Mod");
        return s_name;
      }
    ...
    }; // template class ModEquals

    // register the class with the enumerated class instance
    template< typename t_ArgumentType>
    const util::SiPtr< const util::ObjectInterface> ModEquals< t_ArgumentType>::s_Instance
    (
      util::Enumerated< AssignmentOperationInterface< t_ArgumentType> >::AddInstance( new ModEquals< t_ArgumentType>())
    );
  ...
  /////////////////////////////
    ...
    BCL_EXPIMP_TEMPLATE template class BCL_API ModEquals< double>;
    BCL_EXPIMP_TEMPLATE template class BCL_API ModEquals< float>;

  } // namespace math
} // namespace bcl

#endif // BCL_MATH_MOD_EQUALS_H_
