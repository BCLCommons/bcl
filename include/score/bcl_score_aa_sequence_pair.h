...
#ifndef BCL_SCORE_AA_SEQUENCE_PAIR_H_
#define BCL_SCORE_AA_SEQUENCE_PAIR_H_
...
namespace bcl
{
  namespace score
  {
    ...
    //! @brief FunctionInterface derived class for scoring a pair of sses
    //! @details This is a FunctionInterface derived class for scoring a pair of sses, using a pairwise
    //! amino acid interaction potential.
    //!
    //! @see @link example_score_aa_sequence_pair.cpp @endlink
    //! @author woetzen
    //! @date 16.01.2008
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API AASequencePair :
    ...
    //////////
      ...
      util::Implementation< AAPairDistanceInterface> m_ScoreAAPair;

      //! normalize by number of scored aa pairs (score != 0)
      bool m_Normalize;

      //! function to generate the neighbor list
      util::ShPtr< math::BinaryFunctionInterface< assemble::SSE, assemble::SSE, assemble::AANeighborListContainer> > m_AANeighborListContainerGenerator;
    ...
    //////////////////////////////////
      ...
      AASequencePair( const AAPairDistanceInterface &AA_PAIR_POTENTIAL, const bool NORMALIZE);

      //! @brief virtual copy constructor
      //! @return pointer to a new AASequencePair copied from this one
      AASequencePair *Clone() const;
...
#endif //BCL_SCORE_AA_SEQUENCE_PAIR_H_
