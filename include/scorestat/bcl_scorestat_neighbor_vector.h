...
#ifndef BCL_SCORESTAT_NEIGHBOR_VECTOR_H_
#define BCL_SCORESTAT_NEIGHBOR_VECTOR_H_
...
namespace bcl
{
  namespace scorestat
  {
    ...
    //! @brief extracts sasa neighbor vector statistics from protein models
    //!
    //! @see @link example_scorestat_neighbor_vector.cpp @endlink
    //! @author lib14
    //! @date May 16th, 2015
    //////////////////////////////////////////////////////////////////////

    class BCL_API NeighborVector :
    ...
    //////////
        ...
        double m_NVLowerBound;

        //! upper bound for calculating neighbor count
        double m_NVUpperBound;
    ...
    //////////////////////////////////
      ...
      NeighborVector( const bool SPLIT_ENVIRONMENT);

      //! @brief virtual copy constructor
      NeighborVector *Clone() const;
    ...
    }; // end class NeighborVector
  } // namespace scorestat
} // namespace bcl

#endif // BCL_SCORESTAT_NEIGHBOR_VECTOR_H_
