...
#ifndef BCL_SCORESTAT_SSE_COUNT_H_
#define BCL_SCORESTAT_SSE_COUNT_H_
...
namespace bcl
{
  namespace scorestat
  {
    ...
    //!
    //! @class SSECount
    //! @brief extracts secondary structure element occurrence statistics from protein models
    //!
    //! @see @link example_sse_count_statistics.cpp @endlink
    //! @author lib14
    //! @date jan 08, 2015
    //////////////////////////////////////////////////////////////////////

    class BCL_API SSECount :
...
#endif // BCL_SCORESTAT_SSE_COUNT_H_
