...
#ifndef BCL_SCORESTAT_SSE_MEMBRANE_ALIGNMENT_H_
#define BCL_SCORESTAT_SSE_MEMBRANE_ALIGNMENT_H_
...
namespace bcl
{
  namespace scorestat
  {
    ...
    //! @brief Extracts membrane alignment statistics of secondary structure element.
    //!        Basically, the angle between membrane normal and SSE main axis.
    //! @see @link example_sse_membrane_alignment_statistics.cpp @endlink
    //! @author lib14
    //! @date Jan 08, 2015
    //////////////////////////////////////////////////////////////////////
    ...
    }; // end class SSEMembraneAlignment
  } // namespace scorestat
} // namespace bcl

#endif // BCL_SCORESTAT_SSE_MEMBRANE_ALIGNMENT_H_
