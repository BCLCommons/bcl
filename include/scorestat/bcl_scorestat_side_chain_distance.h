...
#ifndef BCL_SCORESTAT_SIDE_CHAIN_DISTANCE_H_
#define BCL_SCORESTAT_SIDE_CHAIN_DISTANCE_H_
...
namespace bcl
{
  namespace scorestat
  {
    /////////////////////////////////////////////////////////////////////
    //!
    //! @class SideChainDistance
    //! @brief extracts statistics of distances of side chain center of mass to sse from protein models
    //!
    //! @see @link example_sidechain_com_sse_distance_statistics.cpp @endlink
    //! @author lib14
    //! @date Jan 10, 2015
    //////////////////////////////////////////////////////////////////////

    class BCL_API SideChainDistance :
    ...
    }; // end class SideChainDistance
  } // namespace scorestat
} // namespace bcl

#endif // BCL_SCORESTAT_SIDE_CHAIN_DISTANCE_H_
