...
#ifndef BCL_SCORESTAT_RADIUS_OF_GYRATION_H_
#define BCL_SCORESTAT_RADIUS_OF_GYRATION_H_
...
namespace bcl
{
  namespace scorestat
  {
    ...
    //! @brief extracts radius of gyration statistics from protein models
    //!
    //! @see @link example_scorestat_radius_of_gyration.cpp @endlink
    //! @author lib14
    //! @date Dec 18, 2014
    //////////////////////////////////////////////////////////////////////
    ...
    }; // end class RadiusOfGyration
  } // namespace scorestat
} // namespace bcl

#endif // BCL_SCORESTAT_RADIUS_OF_GYRATION_H_
