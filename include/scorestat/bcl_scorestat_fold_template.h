...
#ifndef BCL_SCORESTAT_FOLD_TEMPLATE_H_
#define BCL_SCORESTAT_FOLD_TEMPLATE_H_
...
namespace bcl
{
  namespace scorestat
  {
    ...
    //!
    //! @class FoldTemplate
    //! @brief extracts fold template from protein models
    //!
    //! @see @link example_scorestat_fold_template.cpp @endlink
    //! @author lib14
    //! @date Dec 17, 2014
    //////////////////////////////////////////////////////////////////////
    ...
    }; // end class FoldTemplate
  } // namespace scorestat
} // namespace bcl

#endif // BCL_SCORESTAT_FOLD_TEMPLATE_H_
