...
#ifndef BCL_SCORESTAT_LOOP_DISTANCE_H_
#define BCL_SCORESTAT_LOOP_DISTANCE_H_
...
namespace bcl
{
  namespace scorestat
  {
    ...
    //!
    //! @class LoopDistance
    //! @brief extracts loop distance statistics from protein models
    //!
    //! @see @link example_scorestat_loop_distance.cpp @endlink
    //! @author lib14
    //! @date Nov 1, 2014
    //////////////////////////////////////////////////////////////////////

    class BCL_API LoopDistance :
    ...
    //////////
        ...
        //! the postfix of the output file
...
#endif // BCL_SCORESTAT_LOOP_DISTANCE_H_
