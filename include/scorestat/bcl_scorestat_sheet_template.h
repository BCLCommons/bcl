...
#ifndef BCL_SCORESTAT_SHEET_TEMPLATE_H_
#define BCL_SCORESTAT_SHEET_TEMPLATE_H_
...
namespace bcl
{
  namespace scorestat
  {
    ...
    //!
    //! @class SheetTemplate
    //! @brief extracts sheet templates from protein models
    //!
    //! @see @link example_scorestat_sheet_template.cpp @endlink
    //! @author lib14
    //! @date Jan 19, 2015
    //////////////////////////////////////////////////////////////////////

    class BCL_API SheetTemplate :
    ...
    }; // end class SheetTemplate
  } // namespace scorestat
} // namespace bcl

#endif // BCL_SCORESTAT_SHEET_TEMPLATE_H_
