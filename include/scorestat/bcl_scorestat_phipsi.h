...
#ifndef BCL_SCORESTAT_PHIPSI_H_
#define BCL_SCORESTAT_PHIPSI_H_
...
namespace bcl
{
  namespace scorestat
  {
    ...
    //!
    //! @class PhiPsi
    //! @brief extracts Phi/Psi dihedral statistics from protein models
    //!
    //! @see @link example_scorestat_phipsi.cpp @endlink
    //! @author lib14
    //! @date Jan 07, 2015
    //////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        //! enum of output options
        enum OutputOption
        {
          e_Histogram2D,
          e_NumberOutputOptions
        };
        ...
        typedef util::WrapperEnum< OutputOption, &GetOutputOptionName, e_NumberOutputOptions> OutputOptionEnum;
    ...
    //////////
        ...
        //! number of bins of the Phi/Psi dihedral histogram
    ...
    /////////////////
      ...
      const size_t &GetNumberOfBins() const;
