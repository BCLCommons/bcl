...
#ifndef BCL_SCORESTAT_AA_COUNT_H_
#define BCL_SCORESTAT_AA_COUNT_H_
...
namespace bcl
{
  namespace scorestat
  {
    ...
    //!
    //! @class AACount
    //! @brief extracts amino acid occurrence statistics from protein models
    //!
    //! @see @link example_aa_count_statistics.cpp @endlink
    //! @author lib14
    //! @date Dec 18, 2014
    //////////////////////////////////////////////////////////////////////

    class BCL_API AACount :
...
#endif // BCL_SCORESTAT_AA_COUNT_H_
