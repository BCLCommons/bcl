...
#ifndef BCL_DESCRIPTOR_BASE_TRIPLET_H_
#define BCL_DESCRIPTOR_BASE_TRIPLET_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!
    //! @class BaseTriplet
    //! @brief A base class for overall descriptors of a element pairs, e.g. AA contacts, atom distances
    //!
    ...
    //////////////////////////////////
      ...
      //! @return pointer to new BaseTriplet
      virtual BaseTriplet< t_DataType, t_ReturnType> *Clone() const = 0;
    ...
    private:
      ...
      {
        Calculate( ITR( 0), ITR( 1), ITR( 2), STORAGE);
      }

      //! @brief calculate the descriptors
      //! @param ELEMENT_A, ELEMENT_B, ELEMENT_C: the element triplet of interest
      //! @param STORAGE storage for the descriptor
      virtual void Calculate
      (
        const iterate::Generic< t_DataType> &ELEMENT_A,
        const iterate::Generic< t_DataType> &ELEMENT_B,
        const iterate::Generic< t_DataType> &ELEMENT_C,
    ...
    }; // template class BaseTriplet

  } // namespace descriptor
} // namespace bcl

#endif // BCL_DESCRIPTOR_BASE_TRIPLET_H_
