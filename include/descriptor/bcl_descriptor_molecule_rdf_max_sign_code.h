...
#ifndef BCL_DESCRIPTOR_MOLECULE_RDF_MAX_SIGN_CODE_H_
#define BCL_DESCRIPTOR_MOLECULE_RDF_MAX_SIGN_CODE_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!          This version of the RDF returns 3 values for every bin:
    ...
    //!          Unlike in RDFSign, this property returns the maximum of all values given to the bin
    //!
    //! @see @link example_descriptor_molecule_rdf_max_sign_code.cpp @endlink
    //! @author kothiwsk, glickzl, mendenjl
    //! @date Feb 13, 2014
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MoleculeRDFMaxSignCode :
    ...
    //////////////////////////////////
      ...
      MoleculeRDFMaxSignCode *Clone() const;
...
#endif // BCL_DESCRIPTOR_MOLECULE_RDF_MAX_SIGN_CODE_H_
