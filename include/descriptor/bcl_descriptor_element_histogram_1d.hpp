...
#ifndef BCL_DESCRIPTOR_ELEMENT_HISTOGRAM_1D_HPP_
#define BCL_DESCRIPTOR_ELEMENT_HISTOGRAM_1D_HPP_

// include header of this class
#include "bcl_descriptor_element_histogram_1d.h"
...
namespace bcl
{
  namespace descriptor
  {
    ...
    ElementHistogram1D< t_DataType>::ElementHistogram1D() :
      m_Descriptor(),
      m_Min( 0.0),
      m_Max( 1.0),
      m_BinSize( 1.0),
    ...
    template< typename t_DataType>
    ElementHistogram1D< t_DataType> *ElementHistogram1D< t_DataType>::Clone() const
    {
      return new ElementHistogram1D( *this);
    }
  ...
  /////////////////
    ...
    template< typename t_DataType>
    const std::string &ElementHistogram1D< t_DataType>::GetClassIdentifier() const
    {
    ...
    template< typename t_DataType>
    const std::string &ElementHistogram1D< t_DataType>::GetAlias() const
    {
      static const std::string s_alias( "ElementHistogram1D");
      return s_alias;
    }
    ...
    template< typename t_DataType>
    size_t ElementHistogram1D< t_DataType>::GetNormalSizeOfFeatures() const
    {
      return m_NumberBins;
    }
  ...
  //////////////////////
    ...
    template< typename t_DataType>
    io::Serializer ElementHistogram1D< t_DataType>::GetSerializer() const
    {
    ...
    template< typename t_DataType>
    void ElementHistogram1D< t_DataType>::Calculate
    (
    ...
    //! implementations
    template< typename t_DataType>
    iterate::Generic< Base< t_DataType, float> > ElementHistogram1D< t_DataType>::GetInternalDescriptors()
    {
  ...
  //////////////////////
    ...
    template< typename t_DataType>
    bool ElementHistogram1D< t_DataType>::ReadInitializerSuccessHook
    (
    ...
    )
    {
      ...
      {
        ERR_STREAM << "ElementHistogram1D descriptors only work with element-wise descriptors";
        return false;
      }
...
#endif // BCL_DESCRIPTOR_ELEMENT_HISTOGRAM_1D_HPP_
