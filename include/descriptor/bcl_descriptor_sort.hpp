...
namespace bcl
{
  ...
  //////////////////////////////////
    ...
    Sort< t_DataType>::Sort( const bool &ASCENDING) :
    ...
    template< typename t_DataType>
    Sort< t_DataType> *Sort< t_DataType>::Clone() const
    {
  ...
  /////////////////
    ...
    template< typename t_DataType>
    const std::string &Sort< t_DataType>::GetClassIdentifier() const
    {
    ...
    template< typename t_DataType>
    const std::string &Sort< t_DataType>::GetAlias() const
    {
      static const std::string s_NameAsc( "SortAsc"), s_NameDesc( "SortDesc");
    ...
    template< typename t_DataType>
    size_t Sort< t_DataType>::GetNormalDimension() const
    {
    ...
    template< typename t_DataType>
    size_t Sort< t_DataType>::GetNormalSizeOfFeatures() const
    {
    ...
    template< typename t_DataType>
    void Sort< t_DataType>::SetProperty( const util::Implementation< Base< t_DataType, float> > &PROPERTY)
    {
      m_Property = PROPERTY;
    }
  ...
  //////////////////////
    ...
    template< typename t_DataType>
    io::Serializer Sort< t_DataType>::GetSerializer() const
    {
      io::Serializer parameters;
      parameters.SetClassDescription
      (
        "sort property values in " + std::string( m_Ascending ? "ascending" : "descending") + " order"
      );

      parameters.AddInitializer
      (
        "",
        "descriptor to sort property values",
  ...
  ////////////////
    ...
    //! implementations
    template< typename t_DataType>
    iterate::Generic< Base< t_DataType, float> > Sort< t_DataType>::GetInternalDescriptors()
    {
    ...
    template< typename t_DataType>
    Type::Symmetry Sort< t_DataType>::GetSymmetry() const
    {
    ...
    template< typename t_DataType>
    bool Sort< t_DataType>::ConsiderRepeatedElements() const
    {
    ...
    //! dimension
    template< typename t_DataType>
    void Sort< t_DataType>::RecalculateImpl
    (
    ...
    )
    {
      ...
      {
        std::sort( STORAGE.Begin(), STORAGE.End(), std::greater< float>());
      }
    }
