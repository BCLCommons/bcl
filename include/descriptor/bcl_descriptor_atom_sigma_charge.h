...
#ifndef BCL_DESCRIPTOR_ATOM_SIGMA_CHARGE_H_
#define BCL_DESCRIPTOR_ATOM_SIGMA_CHARGE_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //! @brief calculates the sigma charge for every atom in a molecule
    //!
    //! @see @link example_descriptor_atom_sigma_charge.cpp @endlink
    //! @author kothiwsk, mendenjl, geanesa
    //! @date Dec 14, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API AtomSigmaCharge :
    ...
    //////////////////////////////////
      ...
      AtomSigmaCharge( const bool &GET_CHARGE = true);

      //! @brief virtual copy constructor
      AtomSigmaCharge *Clone() const;
...
#endif // BCL_DESCRIPTOR_ATOM_SIGMA_CHARGE_H_
