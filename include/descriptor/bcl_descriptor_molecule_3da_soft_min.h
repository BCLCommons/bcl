...
#ifndef BCL_DESCRIPTOR_MOLECULE_3DA_SOFT_MIN_H_
#define BCL_DESCRIPTOR_MOLECULE_3DA_SOFT_MIN_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //! @brief code object for 3DA Soft min
    //! @details Calculates normal 3da, except that rather than sum, the min of each bin is found
    //!          After all 3da values have been computed, the maxes are smoothed over the remaining bins
    //!
    //! @see @link example_descriptor_molecule_3da_soft_min.cpp @endlink
    //! @author kothiwsk, mendenjl
    //! @date Feb 12, 2014
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API Molecule3DASoftMin :
    ...
    //////////////////////////////////
      ...
      Molecule3DASoftMin *Clone() const;
...
#endif // BCL_DESCRIPTOR_MOLECULE_3DA_SOFT_MIN_H_
