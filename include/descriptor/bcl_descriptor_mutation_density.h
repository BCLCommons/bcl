...
#ifndef BCL_DESCRIPTOR_MUTATION_DENSITY_H_
#define BCL_DESCRIPTOR_MUTATION_DENSITY_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //! @brief MutationDensity gives the normalized position of an amino acid within the membrane the values are from
    //! (0-1.0) starting at inner membrane going to outer membrane. Based on Octopus TM predictions i = 0 o = 1.0
    //!
    //! @see @link example_descriptor_mutation_density.cpp @endlink
    //! @author mendenjl
    //! @date Feb 01, 2019
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MutationDensity :
    ...
    private:
      ...
      storage::Map< util::SiPtr< const biol::AABase>, Iterator< biol::Mutation> > m_Mutations;

      //! voxel grid for fast lookup of AAs in the given distance
      assemble::VoxelGridMutation m_VoxelGrid;
      ...
      //! default value, applied with pseudocount weight
      linal::Vector< float> m_DefaultValue;

      //! Pseudocounts to add
      float m_PseudocountWeight;
...
#endif // BCL_DESCRIPTOR_MUTATION_DENSITY_H_
