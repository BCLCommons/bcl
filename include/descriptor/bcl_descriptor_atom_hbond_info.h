...
#ifndef BCL_DESCRIPTOR_ATOM_HBOND_INFO_H_
#define BCL_DESCRIPTOR_ATOM_HBOND_INFO_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!
    //! @see @link example_descriptor_atom_hbond_info.cpp @endlink
    //! @author kothiwsk, mendenjl, geanesar
    //! @date Dec 14, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API AtomHBondInfo :
    ...
    ///////////
      ...
      enum Method
      {
        e_Acceptor, //! Whenther atom is an acceptor
        e_Donor //! Whenther atom is a donor
      };
    ...
    //////////
      ...
      Method m_Type; //!< Type of HBond interaction
    ...
    //////////////////////////////////
      ...
      AtomHBondInfo( const Method &METHOD);

      //! @brief virtual copy constructor
      AtomHBondInfo *Clone() const;
...
#endif // BCL_DESCRIPTOR_ATOM_HBOND_INFO_H_
