...
#ifndef BCL_DESCRIPTOR_ATOM_STEREOCENTERS_H_
#define BCL_DESCRIPTOR_ATOM_STEREOCENTERS_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //! @brief assigns stereocenter R/S for each atom
    //! @details
    ...
    //!
    //! @see @link example_descriptor_atom_stereocenters.cpp @endlink
    //! @author kothiwsk, mendenjl
    //! @date Feb 17, 2014
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API AtomStereocenters :
    ...
    //////////
      ...
      linal::Vector< float> m_Stereocenters; //!< Calculated stereocenters for the current molecule
    ...
    protected:
      ...
      //! @brief Recalculates the stereocenters for the current molecule
      void RecalculateStereocenters();
...
#endif // BCL_DESCRIPTOR_ATOM_STEREOCENTERS_H_
