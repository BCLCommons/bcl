...
#ifndef BCL_DESCRIPTOR_MUTATION_NEAREST_SPATIALLY_H_
#define BCL_DESCRIPTOR_MUTATION_NEAREST_SPATIALLY_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //! @brief MutationNearestSpatially gives the normalized position of an amino acid within the membrane the values are from
    //! (0-1.0) starting at inner membrane going to outer membrane. Based on Octopus TM predictions i = 0 o = 1.0
    //!
    //! @see @link example_descriptor_mutation_nearest_spatially.cpp @endlink
    //! @author mendenjl
    //! @date Jan 31, 2019
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MutationNearestSpatially :
    ...
    private:
      ...
      //! bool of whether to include the distance to each mutant
      bool m_IncludeSeqDistances;

      //! bool of whether to include the direction of each mutant (x-y-z offset from this mutant)
      bool m_IncludeDirection;

      //! bool of whether to include the direction of each mutant (x-y-z offset from this mutant)
      bool m_IncludeSeqDirection;

      //! bool, whether to skip undefined values
    ...
    //////////////////////////////////
      ...
      MutationNearestSpatially();

      //! @brief virtual copy constructor
      MutationNearestSpatially *Clone() const;
...
#endif // BCL_DESCRIPTOR_MUTATION_NEAREST_SPATIALLY_H_
