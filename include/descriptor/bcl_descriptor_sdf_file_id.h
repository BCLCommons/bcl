...
#ifndef BCL_DESCRIPTOR_SDF_FILE_ID_H_
#define BCL_DESCRIPTOR_SDF_FILE_ID_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!
    //! @see @link example_descriptor_sdf_file_id.cpp @endlink
    //!
    //! @author kothiwsk
    //! @date Nov 10, 2014
    //!
    ...
    //////////
      ...
      chemistry::MoleculeStorageFile::FindTypeEnum     m_Level;

      storage::Vector< chemistry::MoleculeStorageFile> m_MoleculeStorage;
    ...
    //////////////////////////////////
      ...
      SdfFileId( chemistry::MoleculeStorageFile::FindTypeEnum TYPE);

      //! @brief virtual copy constructor
      SdfFileId *Clone() const;
...
#endif // BCL_DESCRIPTOR_SDF_FILE_ID_H_
