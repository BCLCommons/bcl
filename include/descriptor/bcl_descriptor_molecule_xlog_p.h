...
#ifndef BCL_DESCRIPTOR_MOLECULE_XLOG_P_H_
#define BCL_DESCRIPTOR_MOLECULE_XLOG_P_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!
    //! @class MoleculeXLogP
    //! Calculates the LogP of a molecule using a multitasking deep neural network.
    //! doi::
    //!
    //! @see @link example_descriptor_molecule_xlog_p.cpp @endlink
    //! @author brownbp1, mendenjl
    //! @date Mar 22, 2020
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MoleculeXLogP :
...
#endif // BCL_DESCRIPTOR_MOLECULE_XLOG_P_H_
