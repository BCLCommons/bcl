...
#ifndef BCL_DESCRIPTOR_AA_TRIPLET_LOOKUP_H_
#define BCL_DESCRIPTOR_AA_TRIPLET_LOOKUP_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //! @brief Obtains probabilities of aa quintuplets (5-letters) from a file; optionally with smoothing
    //!
    //! @see @link example_descriptor_aa_triplet_lookup.cpp @endlink
    //! @author mendenjl
    //! @date Apr 16, 2014
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API AATripletLookup :
    ...
    //////////
      ...
      //! Type used to store SS propensities in the order Helix Strand Coil phi/psi angles
      typedef linal::VectorND< float, 3> Propensity;
    ...
    //////////
      ...
      //! threshold above which to consider each blast-probability type
      float m_BlastProbabilityThreshold;
    ...
    //////////////////////////////////
      ...
      AATripletLookup() :
        m_BlastProbabilityThreshold( 1.0)
      {
      }

      //! @brief virtual copy constructor
      AATripletLookup *Clone() const;
...
#endif // BCL_DESCRIPTOR_AA_TRIPLET_LOOKUP_H_
