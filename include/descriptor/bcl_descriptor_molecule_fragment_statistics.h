...
#ifndef BCL_DESCRIPTOR_MOLECULE_FRAGMENT_STATISTICS_H_
#define BCL_DESCRIPTOR_MOLECULE_FRAGMENT_STATISTICS_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!
    //! @see @link example_descriptor_molecule_fragment_statistics.cpp @endlink
    //! @author mendenjl
    //! @date Jan 16, 2015
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MoleculeFragmentStatistics :
    ...
    private:
      ...
      CheminfoProperty m_Weighting;  //!< weighting property, may be undefined
    ...
    //////////////////////////////////
      ...
      MoleculeFragmentStatistics *Clone() const;
...
#endif // BCL_DESCRIPTOR_MOLECULE_FRAGMENT_STATISTICS_H_
