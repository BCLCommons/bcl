...
#ifndef BCL_DESCRIPTOR_AA_MOLECULE_PROPERTY_H_
#define BCL_DESCRIPTOR_AA_MOLECULE_PROPERTY_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!
    //! @see @link example_descriptor_aa_molecule_property.cpp @endlink
    //! @author mendenjl
    //! @date Sep 17, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API AAMoleculeProperty :
    ...
    //////////
      ...
      //! true if the property is already cached on the aa type's fragments
      bool m_IsCachedOnAA;

      //! property string; cached for speed
      util::ObjectDataLabel m_PropertyString;

      //! store on double for each pointer to a AABase
      storage::Map< util::SiPtr< const biol::AABase>, linal::Vector< float>, biol::AALessThanSeqID> m_AAMoleculePropertyStorage;
    ...
    //////////////////////////////////
      ...
      AAMoleculeProperty *Clone() const;
...
#endif // BCL_DESCRIPTOR_AA_MOLECULE_PROPERTY_H_
