...
#ifndef BCL_DESCRIPTOR_POWER_SPECTRUM_H_
#define BCL_DESCRIPTOR_POWER_SPECTRUM_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!
    //! @class PowerSpectrum
    //! @brief computes the periodogram at specified frequency intervals, see http://en.wikipedia.org/wiki/PowerSpectrum
    ...
    //////////
      ...
      storage::Vector< size_t>                         m_PeriodicBinMapping; //!< Mapping from period to output bin
      ...
      ReplaceUndefinedValues< t_DataType>              m_UndefinedReplacer;  //!< handles replacement of undefined values
    ...
    //////////////////////////////////
      ...
      explicit PowerSpectrum( const bool &REFLECT);

      //! @brief Clone function
      //! @return pointer to new PowerSpectrum
      PowerSpectrum< t_DataType> *Clone() const;
  ...
  /////////////////////////////
    ...
    BCL_EXPIMP_TEMPLATE template class BCL_API PowerSpectrum< bcl::biol::AABase>;
    BCL_EXPIMP_TEMPLATE template class BCL_API PowerSpectrum< char>;

  } // namespace descriptor
} // namespace bcl

#endif // BCL_DESCRIPTOR_POWER_SPECTRUM_H_
