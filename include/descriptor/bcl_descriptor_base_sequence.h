...
#ifndef BCL_DESCRIPTOR_BASE_SEQUENCE_H_
#define BCL_DESCRIPTOR_BASE_SEQUENCE_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!
    //! @class BaseSequence
    //! @brief A base class for overall descriptors of a sequence
    //!
    ...
    //////////////////////////////////
      ...
      //! @return pointer to new BaseSequence
      virtual BaseSequence< t_DataType, t_ReturnType> *Clone() const = 0;
    ...
    /////////////////
      ...
      linal::VectorConstReference< t_ReturnType> operator()( const SequenceInterface< t_DataType> &SEQUENCE)
      {
        Base< t_DataType, t_ReturnType>::SetObject( SEQUENCE);
        return Base< t_DataType, t_ReturnType>::operator()( Iterator< t_DataType>( Base< t_DataType, t_ReturnType>::GetType()));
      }
      ...
      {
        return Base< t_DataType, t_ReturnType>::operator()( ITR);
      }
    ...
    private:
      ...
      //! @param STORAGE storage for the descriptor
      virtual void Calculate( linal::VectorReference< t_ReturnType> &STORAGE) = 0;
...
#endif // BCL_DESCRIPTOR_BASE_SEQUENCE_H_
