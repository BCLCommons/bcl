...
#ifndef BCL_DESCRIPTOR_ATOM_TYPE_PROPERTY_RETRIEVER_H_
#define BCL_DESCRIPTOR_ATOM_TYPE_PROPERTY_RETRIEVER_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //!
    //! @see @link example_descriptor_atom_type_property_retriever.cpp @endlink
    //! @author mendenjl, kothiwsk
    //! @date Feb 11, 2014
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API AtomTypePropertyRetriever :
    ...
    //////////
      ...
      chemistry::AtomTypeData::PropertyEnum  m_Property;    //!< property to retrieve from each atom in the small molecule
    ...
    //////////////////////////////////
      ...
      AtomTypePropertyRetriever();

      //! @brief constructor from a property
      //! @param PROPERTY the property to retrieve
      explicit AtomTypePropertyRetriever( const chemistry::AtomTypeData::Properties &PROPERTY);

      //! @brief virtual copy constructor
      AtomTypePropertyRetriever *Clone() const;
...
#endif //BCL_DESCRIPTOR_ATOM_TYPE_PROPERTY_RETRIEVER_H_
