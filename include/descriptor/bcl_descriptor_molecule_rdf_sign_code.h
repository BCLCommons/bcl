...
#ifndef BCL_DESCRIPTOR_MOLECULE_RDF_SIGN_CODE_H_
#define BCL_DESCRIPTOR_MOLECULE_RDF_SIGN_CODE_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //! @details This class provides methods for calculating RDF related input code
    ...
    //!
    //! @see @link example_descriptor_molecule_rdf_sign_code.cpp @endlink
    //! @author kothiwsk, glickzl, mendenjl
    //! @date Feb 13, 2014
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MoleculeRDFSignCode :
    ...
    //////////////////////////////////
      ...
      MoleculeRDFSignCode *Clone() const;
...
#endif // BCL_DESCRIPTOR_MOLECULE_RDF_SIGN_CODE_H_
