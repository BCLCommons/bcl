...
#ifndef BCL_DESCRIPTOR_STRUCTURE_COUNT_H_
#define BCL_DESCRIPTOR_STRUCTURE_COUNT_H_
...
namespace bcl
{
  namespace descriptor
  {
    ...
    //! @brief Returns the number of matches for each substructure in the given file in each molecule 
    //!
    //! @see @link example_descriptor_structure_count.cpp @endlink
    //! @author geanesar
    //! @date Jul 31, 2015
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API StructureCount :
...
#endif // BCL_DESCRIPTOR_STRUCTURE_COUNT_H_
