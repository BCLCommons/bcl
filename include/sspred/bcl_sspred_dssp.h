...
#ifndef BCL_SSPRED_DSSP_H_
#define BCL_SSPRED_DSSP_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class Dssp
    //! @brief stores prediction for Dssp
    //! @details stores prediction for Dssp, which is a
    //!
    //! @see @link example_sspred_dssp.cpp @endlink
    //! @author mendenjl
    //! @date Aug 19, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////
      ...
      //! native SSType defined by the Dssp algorithm
    ...
    //////////////////////////////////
      ...
      Dssp( const biol::SSType &SS_TYPE);
