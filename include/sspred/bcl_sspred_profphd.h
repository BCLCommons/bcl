...
#ifndef BCL_SSPRED_PROFPHD_H_
#define BCL_SSPRED_PROFPHD_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class PROFphd
    //! @brief stores predictions from PROFphd
    //! @details stores predictions from PROFphd, which is a secondary structure algorithm used for soluble proteins
    //!
    //! @see @link example_sspred_profphd.cpp @endlink
    //! @author karakam
    //! @date Jun 3, 2008
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API PROFphd :
    ...
    //////////////////////////////////
      ...
      PROFphd( const linal::Vector3D &VECTOR);
