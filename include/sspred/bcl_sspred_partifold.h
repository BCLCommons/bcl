...
#ifndef BCL_SSPRED_PARTIFOLD_H_
#define BCL_SSPRED_PARTIFOLD_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class PARTIFOLD
    //! @brief stores the prediction for PARTIFOLD
    //! @details stores the prediction for PARTIFOLD, which is a TM beta-barrel predictor. Output format
    //! is per residue. http://partifold.csail.mit.edu/
    //!
    //! @see @link example_sspred_partifold.cpp @endlink
    //! @author koehlej, weinerbe
    //! @date Sep 9, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API PARTIFOLD :
    ...
    //////////////////////////////////
      ...
      PARTIFOLD( const linal::Vector3D &VECTOR);

      //! @brief Clone function
      //! @return pointer to new PARTIFOLD
      PARTIFOLD *Clone() const;
