...
#ifndef BCL_SSPRED_KAKSI_H_
#define BCL_SSPRED_KAKSI_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class Kaksi
    //! @brief stores prediction for Kaksi
    //! @details stores prediction for Kaksi, which is a TM-helix topology predictor. http://Kaksi.cbr.su.se/
    //!
    //! @see @link example_sspred_kaksi.cpp @endlink
    //! @author mendenjl
    //! @date Jul 15, 2014
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////
      ...
      Kaksi( const linal::Vector3D &VECTOR);
