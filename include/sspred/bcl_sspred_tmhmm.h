...
#ifndef BCL_SSPRED_TMHMM_H_
#define BCL_SSPRED_TMHMM_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class TMHMM
    //! @brief stores prediction from TMHMM
    //! @details stores prediction from TMHMM, which is a hidden markov model based secondary structure prediction
    //! algorithm commonly used for membrane proteins
    //!
    //! @see @link example_sspred_tmhmm.cpp @endlink
    //! @author karakam
    //! @date Jun 3, 2008
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////
      ...
      TMHMM( const linal::Vector3D &VECTOR);
