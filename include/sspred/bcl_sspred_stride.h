...
#ifndef BCL_SSPRED_STRIDE_H_
#define BCL_SSPRED_STRIDE_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class Stride
    //! @brief stores prediction for Stride
    //! @details stores prediction for Stride, which is a TM-helix topology predictor. http://Stride.cbr.su.se/
    //!
    //! @see @link example_sspred_stride.cpp @endlink
    //! @author mendenjl
    //! @date Jun 18, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API Stride :
    ...
    //////////
      ...
      //! native SSType defined by the Stride algorithm
    ...
    //////////////////////////////////
      ...
      Stride( const biol::SSType &SS_TYPE);
