...
#ifndef BCL_SSPRED_CONPRED_H_
#define BCL_SSPRED_CONPRED_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class CONPRED
    //! @brief stores CONPRED predictions
    //! @details stores predictions from CONPRED which is a secondary structure prediction method specialized on
    //! prediction of transmembrane regions
    //!
    //! @see @link example_sspred_conpred.cpp @endlink
    //! @author karakam
    //! @date Jun 3, 2008
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API CONPRED :
    ...
    //////////////////////////////////
      ...
      CONPRED( const linal::Vector3D &VECTOR);
