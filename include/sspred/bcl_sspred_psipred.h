...
#ifndef BCL_SSPRED_PSIPRED_H_
#define BCL_SSPRED_PSIPRED_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class PSIPRED
    //! @details stores PSIPRED prediction
    //! @details stores predictions from PSIPRED, which is very commonly used secondary structure prediction algorithm
    //! that specializes no soluble proteins.
    //!
    //! @see @link example_sspred_psipred.cpp @endlink
    //! @author karakam
    //! @date Jun 3, 2008
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API PSIPRED :
    ...
    //////////////////////////////////
      ...
      PSIPRED( const linal::Vector3D &VECTOR);
