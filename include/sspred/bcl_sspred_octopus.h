...
#ifndef BCL_SSPRED_OCTOPUS_H_
#define BCL_SSPRED_OCTOPUS_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class OCTOPUS
    //! @brief stores prediction for OCTOPUS
    //! @details stores prediction for OCTOPUS, which is a TM-helix topology predictor. http://octopus.cbr.su.se/
    //!
    //! @see @link example_sspred_octopus.cpp @endlink
    //! @author koehlej, weinerbe
    //! @date Sep 2, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API OCTOPUS :
      public MethodInterface
    {

    public:

      //! Octopus prediction types
      enum Prediction
      {
        e_Inside    = int( 'i'),
        e_Membrane  = int( 'M'),
        e_Outside   = int( 'o'),
        e_Soluble   = int( 'g'),
        e_ReentrantInside = int( 'r'),
        e_ReentrantOutside = int( 'R'),
        s_NumberPredictions
      };
    ...
    ////////////////
      ...
      //! @brief get the octopus prediction
