...
#ifndef BCL_SSPRED_PROFTMB_H_
#define BCL_SSPRED_PROFTMB_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class PROFTMB
    //! @brief stores PROFTMB predictions
    //! @details stores predictions from PROFTMB which is a secondary structure prediction method specialized on
    //! prediction of transmembrane regions
    //!
    //! @see @link example_sspred_proftmb.cpp @endlink
    //! @author karakam
    //! @date Jun 3, 2008
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API PROFTMB :
    ...
    //////////
      ...
      linal::Matrix< double> m_Prediction; //!< vector to store 9 state prediction
    ...
    //////////////////////////////////
      ...
      PROFTMB( const linal::Matrix< double> &MATRIX);
