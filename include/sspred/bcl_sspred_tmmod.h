...
#ifndef BCL_SSPRED_TMMOD_H_
#define BCL_SSPRED_TMMOD_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class TMMOD
    //! @brief stores prediction for TMMOD
    //! @details stores predictions for TMMOD, which is secondary structure prediction algorithm specialized in
    //! transmembrane proteins
    //!
    //! @see @link example_sspred_tmmod.cpp @endlink
    //! @author karakam
    //! @date Jun 3, 2008
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////
      ...
      TMMOD( const linal::Vector3D &VECTOR);
