...
#ifndef BCL_SSPRED_B2TMPRED_H_
#define BCL_SSPRED_B2TMPRED_H_
...
namespace bcl
{
  namespace sspred
  {
    ...
    //!
    //! @class B2TMPRED
    //! @brief class for storing B2TMPRED prediction
    //! @details stores predictions from B2TMPRED which is a secondary structure prediction method specialized on
    //! prediction of transmembrane regions
    //!
    //! @see @link example_sspred_b2tmpred.cpp @endlink
    //! @author karakam
    //! @date Jun 3, 2008
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API B2TMPRED :
    ...
    //////////////////////////////////
      ...
      B2TMPRED( const linal::Vector3D &VECTOR);

      //! @brief Clone function
      //! @return pointer to new B2TMPRED
      B2TMPRED *Clone() const;
