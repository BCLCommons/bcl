...
#ifndef BCL_COMMAND_PARAMETER_CHECK_ALLOWED_H_
#define BCL_COMMAND_PARAMETER_CHECK_ALLOWED_H_
...
namespace bcl
{
  namespace command
  {
    ...
    //!
    //! @see @link example_command_parameter_check_allowed.cpp @endlink
    //! @author heinzes1, woetzen, karakam
    //! @date 10/12/2006
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ParameterCheckAllowed :
    ...
    //////////
      ...
      storage::Vector< std::string> m_AllowedParameters; //!< this vector contains the allowed parameters
...
#endif //BCL_COMMAND_PARAMETER_CHECK_ALLOWED_H_
