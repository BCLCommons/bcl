...
#ifndef BCL_COMMAND_PARAMETER_CHECK_DEFAULT_H_
#define BCL_COMMAND_PARAMETER_CHECK_DEFAULT_H_
...
namespace bcl
{
  namespace command
  {
    ...
    //! @brief This class is a default parameter check class that always returns true
    //!
    //! @see @link example_command_parameter_check_default.cpp @endlink
    //! @author heinzes1, woetzen, karakam
    //! @date 10/12/2006
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ParameterCheckDefault :
    ...
    //////////////////////////////////
      ...
      //! @return pointer to new ParameterCheckDefault object
      ParameterCheckDefault *Clone() const;
...
#endif //BCL_COMMAND_PARAMETER_CHECK_DEFAULT_H_
