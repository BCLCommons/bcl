...
#ifndef BCL_COMMAND_FLAG_STATIC_AND_DYNAMIC_H_
#define BCL_COMMAND_FLAG_STATIC_AND_DYNAMIC_H_
...
namespace bcl
{
  namespace command
  {
    ...
    //!
    //! @see @link example_command_flag_static_and_dynamic.cpp @endlink
    //! @author heinzes1, woetzen, karakam
    //! @date 10/12/2006
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API FlagStaticAndDynamic :
    ...
    //////////
      ...
      std::string                            m_Name;                   //!< name of flag
      std::string                            m_Description;            //!< description for flag
      bool                                   m_WasSetInCommandline;    //!< stores whether the flag was set in the command line
      ...
      util::ShPtrVector< ParameterInterface> m_ParameterList;          //!< all parameters for that command flag object
      util::ShPtr< ParameterInterface>       m_TemplateParameter;      //!< template parameter - every parameter has to be like this one
      size_t                                 m_NumberStaticParameters; //!< number of static parameters, that were added using PushBack
    ...
    //////////////////////////////////
      ...
      FlagStaticAndDynamic *Clone() const;
    ...
    /////////////////
      ...
      //! @return number of static parameters, added with PushBack
      size_t GetNumberStaticParameters() const
      {
        return m_NumberStaticParameters;
      }

      //! @brief returns the number of dynamic parameters
      //! @return number of dynamic parameters, added while reading from command line
      size_t GetNumberDynamicParameters() const
      {
        return m_ParameterList.GetSize() - m_NumberStaticParameters;
      }
      ...
      util::SiPtrVector< const ParameterInterface> GetDynamicParameterList() const;
    ...
    ////////////////
      ...
      //! @brief adds static PARAMETER to the m_ParameterList
      //! @param PARAMETER - a ShPtr to the parameter that should be added to the list
      void PushBack( const util::ShPtr< ParameterInterface> &PARAMETER)
      {
        m_ParameterList.PushBack( PARAMETER);
        ++m_NumberStaticParameters;
      }
...
#endif // BCL_COMMAND_FLAG_STATIC_AND_DYNAMIC_H_
