...
#ifndef BCL_OPTI_CRITERION_ALL_H_
#define BCL_OPTI_CRITERION_ALL_H_
...
namespace bcl
{
  namespace opti
  {
    ...
    //! @details CriterionAll stores one or more CriterionInterface derived classes and provides a single function
    ...
    //!
    //! @see @link example_opti_criterion_all.cpp @endlink
    //! @author mendenjl
    //! @date Jul 18, 2017
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////
      ...
      //! @return pointer to a new CriterionAll< t_ArgumentType, t_ResultType>
      CriterionAll *Clone() const
      {
        return new CriterionAll< t_ArgumentType, t_ResultType>( *this);
      }
    ...
    /////////////////
      ...
      {
        static const std::string s_alias( "And");
        return s_alias;
      }
    ...
    protected:
      ...
      io::Serializer GetSerializer() const
      {
        ...
        serializer.SetClassDescription( "Triggers when all of the internal criteria are met");
    ...
    }; // template class CriterionAll< t_ArgumentType, t_ResultType>

    // instantiate s_Instance
    template< typename t_ArgumentType, typename t_ResultType>
    const util::SiPtr< const util::ObjectInterface> CriterionAll< t_ArgumentType, t_ResultType>::s_Instance
    (
      util::Enumerated< CriterionInterface< t_ArgumentType, t_ResultType> >::AddInstance
      (
        new CriterionAll< t_ArgumentType, t_ResultType>()
      )
    );
...
#endif // BCL_OPTI_CRITERION_ALL_H_
