...
#ifndef BCL_MC_MUTATE_LOOP_FRAGMENT_REPLACE_H_
#define BCL_MC_MUTATE_LOOP_FRAGMENT_REPLACE_H_
...
namespace bcl
{
  namespace mc
  {
    ...
    //! @brief Replaces a loop fragment in the given protein model
    //!
    //! @see @link example_mc_mutate_loop_fragment_replace.cpp @endlink
    //! @author fischea
    //! @date Mar 14, 2017
    //!
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class BCL_API MutateLoopFragmentReplace :
    ...
    public:
      ...
      MutateLoopFragmentReplace( const std::string &LOOP_LIBRARY_FILENAME = GetDefaultLibraryPath());

      //! @brief copy constructor
      //! @return pointer to a new MutateLoopFragmentReplace
      MutateLoopFragmentReplace *Clone() const;
    ...
    private:
      ...
      bool IsPartiallyDefined( const biol::AASequence &SEQUENCE) const;
      ...
      util::ShPtr< fold::LoopParameters> SelectFragment( const biol::AASequence &SEQUENCE) const;
...
#endif // BCL_MC_MUTATE_LOOP_FRAGMENT_REPLACE_H_
