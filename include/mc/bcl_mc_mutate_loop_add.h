...
#ifndef BCL_MC_MUTATE_LOOP_ADD_H_
#define BCL_MC_MUTATE_LOOP_ADD_H_
...
#include "bcl_mc_mutate_loop_add_resize.h"
...
namespace bcl
{
  namespace mc
  {
    ...
    //!
    //! @see @link example_mc_mutate_loop_add.cpp @endlink
    //! @author fischea
    //! @date Mar 8, 2016
    //!
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class BCL_API MutateLoopAdd :
    ...
    public:
      ...
      MutateLoopAdd( const std::string &LOOP_LIBRARY_FILENAME = GetDefaultLibraryPath());

      //! @brief copy constructor
      //! @return pointer to a new MutateLoopAdd
      MutateLoopAdd *Clone() const;
...
#endif // BCL_MC_MUTATE_LOOP_ADD_H_
