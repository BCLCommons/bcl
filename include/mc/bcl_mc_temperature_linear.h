...
#ifndef BCL_MC_TEMPERATURE_LINEAR_H_
#define BCL_MC_TEMPERATURE_LINEAR_H_
...
namespace bcl
{
  namespace mc
  {
    ...
    //! @brief Allows linear adjustment of the temperature
    //! @details TemperatureInterface derived class that allows changing the temperature linearly, from a given start
    //! temperature to a given end temperature and number of total expected number of iterations
    //!
    //! @see @link example_mc_temperature_linear.cpp @endlink
    //! @author karakam, woetzen, fischea
    //! @date 08.14.2008
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API TemperatureLinear :
    ...
    //////////
      ...
      //! magnitude of temperature adjustment as delta or scaling
      double m_Delta;
...
#endif //BCL_MC_TEMPERATURE_LINEAR_H_
