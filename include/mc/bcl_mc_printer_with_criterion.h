...
#ifndef BCL_MC_PRINTER_WITH_CRITERION_H_
#define BCL_MC_PRINTER_WITH_CRITERION_H_
...
namespace bcl
{
  namespace mc
  {
    ...
    //! @detail Prints when no criterion is specified or when the specified criterion is met.
    //!
    //! @tparam t_ArgumentType argument to the mc optimization
    //! @tparam t_ResultType the type of the objective to optimize on
    //!
    //! @see @link example_mc_printer_with_criterion.cpp @endlink
    //! @author pinojc, fischea
    //! @date Dec 3, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private:
      ...
      util::ShPtr< opti::CriterionInterface< t_ArgumentType, t_ResultType> > m_PrintCriteria;
    ...
    //////////////////////////////////
      ...
      PrinterWithCriterion
      (
        const util::ShPtr< PrintInterface< t_ArgumentType, t_ResultType> > &PRINTER,
        const util::ShPtr< opti::CriterionInterface< t_ArgumentType, t_ResultType> > &PRINT_CRITERIA
      ) :
        m_Printer( PRINTER),
      ...
      //! @return pointer to new PrinterWithCriterion< t_ArgumentType, t_ResultType>
    ...
    /////////////////
      ...
      {
        m_Printer->Initialize( ROUND_NUMBER);
      }
      ...
      {
        m_Printer->Initialize( ROUND_NUMBER, STAGE_NUMBER);
      }
    ...
    protected:
      ...
      io::Serializer GetSerializer() const
      {
       ...
       }; // template class PrinterWithCriterion< t_ArgumentType, t_ResultType>
...
#endif // BCL_MC_PRINTER_WITH_CRITERION_H_
