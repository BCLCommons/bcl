...
#ifndef BCL_MC_MUTATE_LOOP_FRAGMENT_ADD_H_
#define BCL_MC_MUTATE_LOOP_FRAGMENT_ADD_H_
...
namespace bcl
{
  namespace mc
  {
    ...
    //! @brief Adds a loop fragment to the given protein model
    //!
    //! @see @link example_mc_mutate_loop_fragment_add.cpp @endlink
    //! @author fischea
    //! @date Mar 1, 2017
    //!
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class BCL_API MutateLoopFragmentAdd :
    ...
    private:
      ...
      fold::LocatorMissingCoordinates m_LoopLocator;
    ...
    public:
      ...
      MutateLoopFragmentAdd( const std::string &LOOP_LIBRARY_FILENAME = GetDefaultLibraryPath());

      //! @brief copy constructor
      //! @return pointer to a new MutateLoopFragmentAdd
      MutateLoopFragmentAdd *Clone() const;
...
#endif // BCL_MC_MUTATE_LOOP_FRAGMENT_ADD_H_
