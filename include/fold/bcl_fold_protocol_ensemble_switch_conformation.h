...
#ifndef BCL_FOLD_PROTOCOL_ENSEMBLE_SWITCH_CONFORMATION_H_
#define BCL_FOLD_PROTOCOL_ENSEMBLE_SWITCH_CONFORMATION_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    class BCL_API ProtocolEnsembleSwitchConformation :
    ...
    //////////////////////////////////
      ...
      ProtocolEnsembleSwitchConformation();

      //! @brief Clone function
      //! @return pointer to new ProtocolEnsembleSwitchConformation
      ProtocolEnsembleSwitchConformation *Clone() const;
    ...
    /////////////////
      ...
      static ProtocolEnsembleSwitchConformation &GetInstance();
    ...
    //////////////////////
      ...
      SwitchConformation( const assemble::ProteinModel &MODEL);
...
#endif // BCL_FOLD_PROTOCOL_ENSEMBLE_SWITCH_CONFORMATION_H_ 
