...
#ifndef BCL_FOLD_MUTATE_PROTEIN_MODEL_SSE_PAIR_CLASH_H_
#define BCL_FOLD_MUTATE_PROTEIN_MODEL_SSE_PAIR_CLASH_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    //!
    //! @see @link example_fold_mutate_protein_model_sse_pair_clash.cpp @endlink
    //! @author mendenjl
    //! @date Jan 08, 2018
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MutateProteinModelSSEPairClash :
    ...
    //////////////////////////////////
      ...
      MutateProteinModelSSEPairClash( const size_t &MAX_SSES_TO_MOVE = util::GetUndefinedSize_t());

      //! @brief Clone function
      //! @return pointer to new MutateProteinModelSSEPairClash
      MutateProteinModelSSEPairClash *Clone() const;
...
#endif // BCL_FOLD_MUTATE_PROTEIN_MODEL_SSE_PAIR_CLASH_H_
