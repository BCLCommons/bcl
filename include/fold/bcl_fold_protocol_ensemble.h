...
#ifndef BCL_FOLD_PROTOCOL_ENSEMBLE_H_
#define BCL_FOLD_PROTOCOL_ENSEMBLE_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    //!
    //! @see @remarks example unnecessary
    //! @author alexanns
    //! @date Apr 12, 2012
    //!
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ProtocolEnsemble :
...
//      Mutate e_MutateEnsembleSwitchConformationWorstScore;
//      Mutate e_MutateEnsembleCombineSwitchConformationWorstScore;
    ...
    /////////////////
      ...
      static ProtocolEnsemble &GetInstance();

      //! @brief returns class name
      //! @return the class name as const ref std::string
      const std::string &GetClassIdentifier() const;

//      static util::ShPtr< math::MutateInterface< assemble::ProteinModel> > GetMutateProteinModelSwitchConformation
//      (
//        const util::ShPtr< math::FunctionInterfaceSerializable< assemble::ProteinModel, double> > &SCORE
//      );
//
//      static util::ShPtr< math::MutateInterface< assemble::ProteinModel> >
...
//      );
    ...
    ///////////
      ...
      static util::ShPtr< command::FlagInterface> &GetFlagEnsembleSize();
...
#endif // BCL_FOLD_PROTOCOL_ENSEMBLE_H_ 
