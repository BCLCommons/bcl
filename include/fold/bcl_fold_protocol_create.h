...
#ifndef BCL_FOLD_PROTOCOL_CREATE_H_
#define BCL_FOLD_PROTOCOL_CREATE_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    //! @brief Initial protocol for de-novo folding. Gets all SSEs into the model w/o clashes or loop-closure issues
    //!
    ...
    /////////////////
      ...
      static ProtocolCreate &GetInstance();
...
#endif // BCL_FOLD_PROTOCOL_CREATE_H_
