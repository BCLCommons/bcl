...
#ifndef BCL_FOLD_PROTOCOL_RESTRAINT_H_
#define BCL_FOLD_PROTOCOL_RESTRAINT_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    //! @brief protocol for using restraints in folding run
    //! @details protocol introduces scores for using restraints such as NOE, RDC, EPR restraints
    //!
    ...
    class BCL_API ProtocolRestraint :
    ...
    /////////////////
      ...
      static ProtocolRestraint &GetInstance();
...
#endif // BCL_FOLD_PROTOCOL_RESTRAINT_H_
