...
#ifndef BCL_FOLD_PROTOCOL_LOOP_CLOSE_H_
#define BCL_FOLD_PROTOCOL_LOOP_CLOSE_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    //!
    //! @example unnecessary
    //! @author alexanns, karakam, woetzen
    //! @date Dec 12, 2010
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ProtocolLoopClose :
    ...
    //////////
      ...
      Mutate e_MutateLoopDomainCCD;          //!< ccd loop domain move to bring end closer to other side
      Mutate e_MutateLoopDomainRamachandran; //!< loop domain phi psi change base on ramachandran

      Score e_ScoreLoopDomainClosure;
      Score e_ScorePhiPsiSSPredClose;
    ...
    /////////////////
      ...
      static ProtocolLoopClose &GetInstance();
    ...
    ///////////
      ...
      static util::ShPtr< command::FlagInterface> &GetFlagRamachandranMutateProbability();
      ...
      static util::ShPtr< command::FlagInterface> &GetFlagUseFullFraction();
    ...
    public:
      ...
      static void AddLoopCoordinates( assemble::ProteinModel &MODEL);
      ...
      static util::ShPtr< assemble::ProteinModel> AddNitrogenHydrogens( const assemble::ProteinModel &MODEL);

      //! @brief split coils at non-petide connection
      //! @param MODEL the protein model to be changed
      static void SplitCoilsAtNonPetideBond( assemble::ProteinModel &MODEL);

      //! @brief split sse into coils that are not connected
      //! @param SSE the sse to split
      //! @return list of coils
      static util::ShPtrList< assemble::SSE> SplitSSEAtNonPetideBond( const assemble::SSE &SS_ELEMENT);
...
#endif // BCL_FOLD_PROTOCOL_LOOP_CLOSE_H_ 
