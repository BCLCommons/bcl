...
#ifndef BCL_FOLD_PROTOCOL_REFINEMENT_H_
#define BCL_FOLD_PROTOCOL_REFINEMENT_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    //! @brief Assembly protocol that modifies the default protocol to only use large-scale mutates
    //! @details Assembly protocol uses the same scores as the default score. However, it only utilizes a subset of the
    //! mutates defined in the default protocol. It only uses the large step-size moves to increase efficiency of the
    //! search.
    //!
    ...
    class BCL_API ProtocolRefinement :
    ...
    public:
      ...
      ProtocolRefinement *Clone() const;
    ...
    /////////////////
      ...
      static ProtocolRefinement &GetInstance();
...
#endif // BCL_FOLD_PROTOCOL_REFINEMENT_H_ 
