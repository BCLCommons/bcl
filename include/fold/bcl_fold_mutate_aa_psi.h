...
#ifndef BCL_FOLD_MUTATE_AA_PSI_H_
#define BCL_FOLD_MUTATE_AA_PSI_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    //!
    //! @class MutateAAPsi
    //! @brief changes the psi angle of an amino acid by a given radian amount.
    //! @details The rotation is performed around the CA->C bond vector, so the CA and C positions are fixed. The oxygen
    //! atom attached to the C atom is rotated accordingly.
    //!
    //! @see @link example_fold_mutate_aa_psi.cpp @endlink
    //! @author alexanns
    //! @date Sep 3, 2010
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MutateAAPsi :
    ...
    //////////
      ...
      //! the amount in radians by which psi should be rotated
      double m_Rotation;
    ...
    //////////////////////////////////
      ...
      MutateAAPsi( const double ROTATION);

      //! @brief Clone function
      //! @return pointer to new MutateAAPsi
      MutateAAPsi *Clone() const;
...
#endif // BCL_FOLD_MUTATE_AA_PSI_H_ 
