...
#ifndef BCL_FOLD_PROTOCOL_ASSEMBLY_H_
#define BCL_FOLD_PROTOCOL_ASSEMBLY_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    class BCL_API ProtocolAssembly :
    ...
    /////////////////
      ...
      static ProtocolAssembly &GetInstance();
...
#endif // BCL_FOLD_PROTOCOL_ASSEMBLY_H_ 
