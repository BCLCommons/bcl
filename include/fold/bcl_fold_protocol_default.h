...
#ifndef BCL_FOLD_PROTOCOL_DEFAULT_H_
#define BCL_FOLD_PROTOCOL_DEFAULT_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    //! @brief default folding protocol
    //! @details folding protocol that forms the basis of all other protocols. This protocol is always the starting
    //! point when the Setup is initialized, other protocols change this protocol accordingly. The default protocol
    //! introduces necessary components for a de novo folding run
    //!
    ...
    /////////////////
      ...
      static ProtocolDefault &GetInstance();
    ...
    public:
      ...
      static void AddRandomSSEToStartModel( assemble::ProteinModel &START_MODEL);
...
#endif // BCL_FOLD_PROTOCOL_DEFAULT_H_ 
