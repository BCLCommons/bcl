...
#ifndef BCL_FOLD_PROTOCOL_ENSEMBLE_FILTER_H_
#define BCL_FOLD_PROTOCOL_ENSEMBLE_FILTER_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    class BCL_API ProtocolEnsembleFilter :
    ...
    //////////////////////////////////
      ...
      ProtocolEnsembleFilter();

      //! @brief Clone function
      //! @return pointer to new ProtocolEnsembleFilter
      ProtocolEnsembleFilter *Clone() const;
    ...
    /////////////////
      ...
      static ProtocolEnsembleFilter &GetInstance();
    ...
    ///////////
      ...
      static util::ShPtr< command::FlagInterface> &GetFlagFilterScoreFunctions();

      //! @brief return command line flag for specifying the domains
      //! @return command line flag for specifying domains
      static util::ShPtr< command::FlagInterface> &GetFlagFilterNumberToKeep();
...
#endif // BCL_FOLD_PROTOCOL_ENSEMBLE_FILTER_H_ 
