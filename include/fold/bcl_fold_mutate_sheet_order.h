...
#ifndef BCL_FOLD_MUTATE_SHEET_ORDER_H_
#define BCL_FOLD_MUTATE_SHEET_ORDER_H_
...
namespace bcl
{
  namespace fold
  {
    ...
    //! @brief Mutate class to order the strands in given sheet by sequence order
    //! @details This mutate class sorts all the strands in the given sheet using the sequence order.
    //!
    //! @see @link example_fold_mutate_sheet_order.cpp @endlink
    //! @author karakam
    //! @date Mar 15, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MutateSheetOrder :
    ...
    //////////////////////////////////
      ...
      MutateSheetOrder( const double PARALLEL_PROBABILITY);

      //! @brief Clone function
      //! @return pointer to new MutateSheetOrder
      MutateSheetOrder *Clone() const;
    ...
    /////////////////
      ...
      //! @brief return probability of ordering into parallel conformation
      //! @return probability of ordering into parallel conformation
      double GetParallelProbability() const
      {
        return m_ParallelProbability;
      }
...
#endif // BCL_FOLD_MUTATE_SHEET_ORDER_H_ 
