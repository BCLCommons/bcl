...
#ifndef BCL_ASSEMBLE_AA_NEIGHBOR_LIST_CONTAINER_GENERATOR_SSE_PAIR_H_
#define BCL_ASSEMBLE_AA_NEIGHBOR_LIST_CONTAINER_GENERATOR_SSE_PAIR_H_
...
namespace bcl
{
  namespace assemble
  {
    ...
    class BCL_API AANeighborListContainerGeneratorSSEPair :
      public math::BinaryFunctionInterfaceSerializable< SSE, SSE, AANeighborListContainer>
    {
    ...
    private:
      ...
      AANeighborListContainerGeneratorSSEPair
      (
    ...
    public:
      ...
      AANeighborListContainerGeneratorSSEPair *Clone() const;
    ...
    ///////////////
      ...
      AANeighborListContainer operator()( const SSE &ELEMENT_A, const SSE &ELEMENT_B) const;
    ...
    //////////////////////
      ...
      static util::ShPtr< math::BinaryFunctionInterface< SSE, SSE, AANeighborListContainer> > AANeighborListGenerator
      (
        const double DISTANCE_CUTOFF,
        const size_t MIN_SEQ_SEPARATION,
        const bool CONSIDER_DIFFERENT_CHAIN,
...
#endif // BCL_ASSEMBLE_AA_NEIGHBOR_LIST_CONTAINER_GENERATOR_SSE_PAIR_H_ 
