...
#ifndef BCL_ASSEMBLE_AA_NEIGHBOR_VECTOR_H_
#define BCL_ASSEMBLE_AA_NEIGHBOR_VECTOR_H_
...
namespace bcl
{
  namespace assemble
  {
    ...
    //! @brief This is a AAExposureInterface derived class for determining the neighbor vector length for an AA
    //! @details Using the AANeighborList it sums up all normalized vectors to the neighbors and returns the resulting length.
    //!
    //! @see @link example_assemble_aa_neighbor_vector.cpp @endlink
    //! @author woetzen
    //! @date Apr 17, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API AANeighborVector :
    ...
    //////////
      ...
      //! schem to be used in outputting
      std::string m_Scheme;

      //! @brief the lower and higher threshold for neighbors
      //! there weight for the neighbor count and the consideration for the neighbor vector is influenced by those
      //! threshold distances
      //! all AAs < Low  in distance are counted as one neighbor
      //! all AAs > High in distance are not counted as a neighbor
      //! all AAs between these bounds are given a weight between 0 and 1
      math::Range< double> m_ThresholdLowHigh;
    ...
    //////////
      ...
      static const math::Range< double> &GetDefaultThresholdLowHigh();
    ...
    //////////////////////////////////
      ...
      AANeighborVector( const std::string &SCHEME = GetDefaultScheme());

      //! @brief virtual copy constructor
      //! @return pointer to a new AANeighborVector object copied from this one
      AANeighborVector *Clone() const;
    ...
    ///////////////
      ...
      //! @brief calculate neighbor vector norm for a given amino acid and its AANeighborList
      //! @return neighbor vector norm for a given amino acid and its AANeighborList
...
#endif //BCL_ASSEMBLE_AA_NEIGHBOR_VECTOR_H_
