...
namespace bcl
{
  ...
  /////////////////////////////
    ...
    BCL_EXPIMP_TEMPLATE template class BCL_API Enumerate< bcl::util::ShPtr< bcl::assemble::SSEGeometryPackerInterface< bcl::assemble::SSEGeometryPacking> >, bcl::assemble::SSEGeometryPackingPickers>;
