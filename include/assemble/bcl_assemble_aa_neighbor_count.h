...
#ifndef BCL_ASSEMBLE_AA_NEIGHBOR_COUNT_H_
#define BCL_ASSEMBLE_AA_NEIGHBOR_COUNT_H_
...
namespace bcl
{
  namespace assemble
  {
    ...
    //! @brief This is a AAExposureInterface derived class for determining the neighbor count for an AA
    //! @details Using the AANeighborList is counts the number of neighbors within a given radius
    //!
    //! @see @link example_assemble_aa_neighbor_count.cpp @endlink
    //! @author woetzen
    //! @date Apr 17, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API AANeighborCount :
    ...
    //////////
      ...
      static const size_t GetDefaultMinimalSequenceSeparation();
    ...
    //////////////////////////////////
      ...
      AANeighborCount( const std::string &SCHEME = GetDefaultScheme());

      //! @brief virtual copy constructor
      //! @return pointer to a new AANeighborCount object copied from this one
      AANeighborCount *Clone() const;
    ...
    ///////////////
      ...
      //! @brief calculate neighbor count amino acid AANeighborList
      //! @return inverse exposure neighbor potential for a given amino acid and its AANeighborList
...
#endif //BCL_ASSEMBLE_AA_NEIGHBOR_COUNT_H_
