...
#ifndef BCL_ASSEMBLE_SSE_POOL_SPLIT_SSE_H_
#define BCL_ASSEMBLE_SSE_POOL_SPLIT_SSE_H_
...
namespace bcl
{
  namespace assemble
  {
    ...
    //!
    //! @see @link example_assemble_sse_pool_split_sse.cpp @endlink
    //! @author woetzen
    //! @date Jun 18, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API SSEPoolSplitSSE :
    ...
    //////////
      ...
      //! optional mutate for one random resulting sse from the split
      util::ShPtr< math::MutateInterface< SSE> > m_SSEMutate;
...
#endif // BCL_ASSEMBLE_SSE_POOL_SPLIT_SSE_H_
