...
#ifndef BCL_ASSEMBLE_PROTEIN_WITH_CACHE_DATASET_FROM_FILE_H_
#define BCL_ASSEMBLE_PROTEIN_WITH_CACHE_DATASET_FROM_FILE_H_
...
namespace bcl
{
  namespace assemble
  {
    ...
    //!
    //! @see @link example_assemble_protein_with_cache_dataset_from_file.cpp @endlink
    //! @author mendenjl
    //! @date Jan 15, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ProteinWithCacheDatasetFromFile :
      public ProteinWithCacheStorageFile,
    ...
    //////////
      ...
      mutable util::ShPtr< descriptor::DatasetBuilder< biol::AABase> > m_Builder;
    ...
    //////////////////////////////////
      ...
      ProteinWithCacheDatasetFromFile( const bool &REQUIRE_COORDINATES);

      //! @brief copy constructor, clones builder
      ProteinWithCacheDatasetFromFile( const ProteinWithCacheDatasetFromFile &PARENT);

      //! @brief Clone function
      //! @return pointer to new ProteinWithCacheDatasetFromFile
      ProteinWithCacheDatasetFromFile *Clone() const;
...
#endif // BCL_ASSEMBLE_PROTEIN_WITH_CACHE_DATASET_FROM_FILE_H_
