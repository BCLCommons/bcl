...
#ifndef BCL_MODEL_DTREE_SEQUENCE_DATA_PARTITION_FUNCTION_H_
#define BCL_MODEL_DTREE_SEQUENCE_DATA_PARTITION_FUNCTION_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //! @brief Split such that the decision tree always forms a sequence
    //!
    //! @see @link example_model_dtree_sequence_data_partition_function.cpp @endlink
    //! @author mendenjl
    //! @date Dec 14, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API DtreeSequenceDataPartitionFunction :
    ...
    //////////////////////////////////
      ...
      //! copy constructor
      DtreeSequenceDataPartitionFunction *Clone() const;
...
#endif //BCL_MODEL_DTREE_SEQUENCE_DATA_PARTITION_FUNCTION_H_
