...
#ifndef BCL_MODEL_APPROXIMATOR_NEURAL_NETWORK_H_
#define BCL_MODEL_APPROXIMATOR_NEURAL_NETWORK_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_approximator_neural_network.cpp @endlink
    //! @author mueller, mendenjl
    //! @date Jul 06, 2009
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ApproximatorNeuralNetwork :
    ...
    //////////
      ...
      //! Training schedule; handles balancing and shuffling
      TrainingSchedule m_TrainingSchedule;
      ...
      storage::Vector< storage::Vector< storage::Vector< size_t> > > m_ChosenDropped;
      storage::Vector< storage::Vector< storage::Vector< storage::Vector< size_t> > > > m_NeuronIndices; //!< Indices of all available neurons in the range
    ...
    //////////////////////////////////
      ...
      ApproximatorNeuralNetwork( const bool &PRETRAIN = false);
      ...
      (
        ...
        const RescaleFeatureDataSet::TypeEnum RESCALE_TYPE = RescaleFeatureDataSet::e_AveStd
      );

      //! @brief copy constructor
      //! @return a new ApproximatorNeuralNetwork copied from this instance
      ApproximatorNeuralNetwork *Clone() const;
    ...
    private:
      ...
      //!        updated
      void UpdateDroppedNeurons( const size_t &THREAD_ID = util::GetUndefined< size_t>());
...
#endif // BCL_MODEL_APPROXIMATOR_NEURAL_NETWORK_H_
