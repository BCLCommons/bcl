...
#ifndef BCL_MODEL_OBJECTIVE_FUNCTION_SELECTIVE_H_
#define BCL_MODEL_OBJECTIVE_FUNCTION_SELECTIVE_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_objective_function_selective.cpp @endlink
    //! @author kothiwsk
    //! @date Apr 11, 2014
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ObjectiveFunctionSelective :
    ...
    //////////
      ...
      //! experimental data that is reduced to consider only one putatative active conformation among all
      FeatureDataSet< float> m_ExperimentalPruned;

      //! Sequence Identification label (Normally DBId)
      util::ObjectDataLabel m_DbIdLabel;

      //! mapping between db_id and features (conformations)
      storage::Map< std::string, storage::Vector< size_t> > m_MappingIds;
    ...
    //////////////////////////////////
      ...
      //! @return pointer to new ObjectiveFunctionSelective
      ObjectiveFunctionSelective *Clone() const;
    ...
    /////////////////
      ...
      {
        static const std::string s_Name( "Selective");
        return s_Name;
      }
...
#endif // BCL_MODEL_OBJECTIVE_FUNCTION_SELECTIVE_H_
