...
#ifndef BCL_MODEL_APPROXIMATOR_LINEAR_REGRESSION_H_
#define BCL_MODEL_APPROXIMATOR_LINEAR_REGRESSION_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_approximator_linear_regression.cpp @endlink
    //! @author mendenjl
    //! @date Sep 04, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ApproximatorLinearRegression :
    ...
    private:
      ...
      util::Implementation< linal::MatrixInversionInterface< float> > m_MatrixSolver;
      float                   m_LastObjectiveFunctionResult; //!< last objective function result
      util::ShPtr< Interface> m_Weights;                     //!< current model
    ...
    //////////////////////////////////
      ...
      ApproximatorLinearRegression();

      //! @brief clone function
      //! @return pointer to new ApproximatorLinearRegression
      ApproximatorLinearRegression *Clone() const
      {
        return new ApproximatorLinearRegression( *this);
      }
...
#endif // BCL_MODEL_APPROXIMATOR_LINEAR_REGRESSION_H_
