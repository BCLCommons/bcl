...
#ifndef BCL_MODEL_COLLECT_FEATURES_ABOVE_H_
#define BCL_MODEL_COLLECT_FEATURES_ABOVE_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @author mendenjl
    //! @see @link example_model_collect_features_above.cpp @endlink
    //! @date Apr 03, 2012
    //!
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API CollectFeaturesAbove :
    ...
    //////////
      ...
      float m_Threshold; //!< number of features to keep
    ...
    //////////////////////////////////
      ...
      explicit CollectFeaturesAbove( const float &THRESHOLD);

      //! @brief Clone function
      //! @return pointer to new CollectFeaturesAbove
      CollectFeaturesAbove *Clone() const;
...
#endif // BCL_MODEL_COLLECT_FEATURES_ABOVE_H_
