...
#ifndef BCL_MODEL_RETRIEVE_DATA_SET_YSCRAMBLE_H_
#define BCL_MODEL_RETRIEVE_DATA_SET_YSCRAMBLE_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //! @brief randomizes the order of the results for validation of training and feature selection procedures
    //!
    //! @see @link example_model_retrieve_data_set_yscramble.cpp @endlink
    //! Reference for method: Wold S, Eriksson L (1995). "Statistical validation of QSAR results".
    //!   In Waterbeemd, Han van de. Chemometric methods in molecular design. Weinheim: VCH. pp. 309–318.
    //! @author mendenjl
    //! @date Apr 29, 2015
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API RetrieveDataSetYscramble :
    ...
    //////////////////////////////////
      ...
      //! @return pointer to new RetrieveDataSetYscramble
      RetrieveDataSetYscramble *Clone() const;
...
#endif // BCL_MODEL_RETRIEVE_DATA_SET_YSCRAMBLE_H_
