...
#ifndef BCL_MODEL_RETRIEVE_DATA_SET_RESCALED_H_
#define BCL_MODEL_RETRIEVE_DATA_SET_RESCALED_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_retrieve_data_set_rescaled.cpp @endlink
    //! @author mendenjl
    //! @date Jul 06, 2017
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API RetrieveDataSetRescaled :
    ...
    //////////
      ...
      //! scaling type
      RescaleFeatureDataSet::TypeEnum m_RescaleInputType;

      //! rescale to range
      math::Range< float> m_RescaleInputRange;

      //! scaling type
      RescaleFeatureDataSet::TypeEnum m_RescaleOutputType;

      //! rescale to range
      math::Range< float> m_RescaleOutputRange;
    ...
    //////////////////////////////////
      ...
      RetrieveDataSetRescaled();

      //! @brief Clone function
      //! @return pointer to new RetrieveDataSetRescaled
      RetrieveDataSetRescaled *Clone() const;
...
#endif // BCL_MODEL_RETRIEVE_DATA_SET_RESCALED_H_
