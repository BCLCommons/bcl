...
#ifndef BCL_MODEL_OBJECTIVE_FUNCTION_ACCURACY_WITH_EXCLUDED_RANGE_H_
#define BCL_MODEL_OBJECTIVE_FUNCTION_ACCURACY_WITH_EXCLUDED_RANGE_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_objective_function_accuracy_with_excluded_range.cpp @endlink
    //! @author mendenjl
    //! @date Jul 18, 2012
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ObjectiveFunctionAccuracyWithExcludedRange :
    ...
    //////////
      ...
      //! activity cutoff low; values below this will be counted towards the accuracy
      float m_ActivityCutoffLow;

      //! activity cutoff high; values above this will be counted towards the accuracy
      float m_ActivityCutoffHigh;
    ...
    //////////////////////////////////
      ...
      ObjectiveFunctionAccuracyWithExcludedRange();

      //! @brief constructor taking all necessary parameters
      //! @param ACTIVITY_CUTOFF the activity cutoff
      ObjectiveFunctionAccuracyWithExcludedRange( const float &ACTIVITY_CUTOFF);

      //! @brief Clone function
      //! @return pointer to new Evaluator
      ObjectiveFunctionAccuracyWithExcludedRange *Clone() const;
    ...
    /////////////////
      ...
      {
        static const std::string s_Name( "AccuracyOutsideRange");
        return s_Name;
      }
...
#endif //BCL_MODEL_OBJECTIVE_FUNCTION_ACCURACY_WITH_EXCLUDED_RANGE_H_
