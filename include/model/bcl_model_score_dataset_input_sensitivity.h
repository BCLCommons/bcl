...
#ifndef BCL_MODEL_SCORE_DATASET_INPUT_SENSITIVITY_H
#define BCL_MODEL_SCORE_DATASET_INPUT_SENSITIVITY_H
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @author mendenjl
    //! @see @link example_model_score_dataset_input_sensitivity.cpp @endlink
    //! @date Apr 04, 2012
    //!
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ScoreDatasetInputSensitivity :
    ...
    //////////
      ...
      float m_Delta; //!< Amount to perturb each descriptor by
    ...
    //////////////////////////////////
      ...
      ScoreDatasetInputSensitivity *Clone() const;
...
#endif // BCL_MODEL_SCORE_DATASET_INPUT_SENSITIVITY_H
