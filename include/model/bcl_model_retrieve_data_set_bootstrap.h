...
#ifndef BCL_MODEL_RETRIEVE_DATA_SET_BOOTSTRAP_H_
#define BCL_MODEL_RETRIEVE_DATA_SET_BOOTSTRAP_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_retrieve_data_set_bootstrap.cpp @endlink
    //! @author mendenjl
    //! @date May 07, 2018
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API RetrieveDataSetBootstrap :
    ...
    //////////////////////////////////
      ...
      //! @return pointer to new RetrieveDataSetBootstrap
      RetrieveDataSetBootstrap *Clone() const;
...
#endif // BCL_MODEL_RETRIEVE_DATA_SET_BOOTSTRAP_H_
