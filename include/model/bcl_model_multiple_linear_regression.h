...
#ifndef BCL_MODEL_MULTIPLE_LINEAR_REGRESSION_H_
#define BCL_MODEL_MULTIPLE_LINEAR_REGRESSION_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_multiple_linear_regression.cpp @endlink
    //! @author mendenjl
    //! @date Aug 19, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API MultipleLinearRegression :
      public Interface
    {
    ...
    //////////////////////////////////
      ...
      MultipleLinearRegression( const linal::MatrixConstInterface< float> &WEIGHTS);

      //! @brief Clone is the virtual copy constructor
      MultipleLinearRegression *Clone() const;
...
#endif // BCL_MODEL_MULTIPLE_LINEAR_REGRESSION_H_
