...
#ifndef BCL_MODEL_NEURAL_NETWORK_PERTURB_ATTENUATE_H_
#define BCL_MODEL_NEURAL_NETWORK_PERTURB_ATTENUATE_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_neural_network_perturb_attenuate.cpp @endlink
    //! @author mendenjl
    //! @date Apr 30, 2013
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API NeuralNetworkPerturbAttenuate :
    ...
    //////////
      ...
      //! amount to attenuate weights as function of current weight amplitude
      math::Polynomial m_Attenuation;
    ...
    //////////////////////////////////
      ...
      NeuralNetworkPerturbAttenuate *Clone() const;
...
#endif // BCL_MODEL_NEURAL_NETWORK_PERTURB_ATTENUATE_H_
