...
#ifndef BCL_MODEL_OBJECTIVE_FUNCTION_BOOTSTRAP_H_
#define BCL_MODEL_OBJECTIVE_FUNCTION_BOOTSTRAP_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_objective_function_bootstrap.cpp @endlink
    //! @author mendenjl
    //! @date Oct 26, 2015
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ObjectiveFunctionBootstrap :
    ...
    //////////
      ...
      //! number of times to select bootstrap samples
      size_t m_NumberBootstraps;

      //! Confidence interval to report, defaults to 95% (0.95)
      double m_ConfidenceInterval;

      //! Real ids
      FeatureDataSet< char> m_RealIds;
    ...
    //////////////////////////////////
      ...
      ObjectiveFunctionBootstrap();

      //! @brief Clone function
      //! @return pointer to new ObjectiveFunctionBootstrap
      ObjectiveFunctionBootstrap *Clone() const;
...
#endif // BCL_MODEL_OBJECTIVE_FUNCTION_BOOTSTRAP_H_
