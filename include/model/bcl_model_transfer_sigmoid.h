...
#ifndef BCL_MODEL_TRANSFER_SIGMOID_H_
#define BCL_MODEL_TRANSFER_SIGMOID_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //! @brief This class is a sigmoid function suitable as transfer Function for ANN objects only.
    ...
    //!
    //! @see @link example_model_transfer_sigmoid.cpp @endlink
    //! @author meilerj
    //! @date 08.09.2004
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API TransferSigmoid :
...
#endif // BCL_MODEL_TRANSFER_SIGMOID_H_
