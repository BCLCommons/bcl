...
#ifndef BCL_MODEL_NEURAL_NETWORK_UPDATE_WEIGHTS_SIMPLE_PROPAGATION_H_
#define BCL_MODEL_NEURAL_NETWORK_UPDATE_WEIGHTS_SIMPLE_PROPAGATION_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_neural_network_update_weights_simple_propagation.cpp @endlink
    //! @author mendenjl
    //! @date May 12, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API NeuralNetworkUpdateWeightsSimplePropagation :
    ...
    //////////////////////////////////
      ...
      NeuralNetworkUpdateWeightsSimplePropagation();

      //! @brief copy constructor
      //! @return a new NeuralNetworkUpdateWeightsSimplePropagation copied from this instance
      NeuralNetworkUpdateWeightsSimplePropagation *Clone() const;
...
#endif // BCL_MODEL_NEURAL_NETWORK_UPDATE_WEIGHTS_SIMPLE_PROPAGATION_H_
