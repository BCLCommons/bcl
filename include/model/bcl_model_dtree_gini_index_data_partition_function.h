...
#ifndef BCL_MODEL_DTREE_GINI_INDEX_DATA_PARTITION_FUNCTION_H_
#define BCL_MODEL_DTREE_GINI_INDEX_DATA_PARTITION_FUNCTION_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_dtree_gini_index_data_partition_function.cpp @endlink
    //! @author mendenjl
    //! @date May 14, 2011
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API DtreeGiniIndexDataPartitionFunction :
    ...
    //////////////////////////////////
      ...
      //! copy constructor
      DtreeGiniIndexDataPartitionFunction *Clone() const;
...
#endif //BCL_MODEL_DTREE_GINI_INDEX_DATA_PARTITION_FUNCTION_H_
