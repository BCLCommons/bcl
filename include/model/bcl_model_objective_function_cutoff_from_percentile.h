...
#ifndef BCL_MODEL_OBJECTIVE_FUNCTION_CUTOFF_FROM_PERCENTILE_H_
#define BCL_MODEL_OBJECTIVE_FUNCTION_CUTOFF_FROM_PERCENTILE_H_
...
namespace bcl
{
  namespace model
  {
    ...
    //!
    //! @see @link example_model_objective_function_cutoff_from_percentile.cpp @endlink
    //! @author mendenjl
    //! @date Jun 29, 2017
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ObjectiveFunctionCutoffFromPercentile :
    ...
    //////////
      ...
      //! percentile; will be used to determine cutoff for results in data
      float m_Percentile;
    ...
    //////////////////////////////////
      ...
      ObjectiveFunctionCutoffFromPercentile();

      //! @brief Clone function
      //! @return pointer to new ObjectiveFunctionCutoffFromPercentile
      ObjectiveFunctionCutoffFromPercentile *Clone() const;
    ...
    /////////////////
      ...
      {
        static const std::string s_Name( "PercentileCutoff");
        return s_Name;
      }
...
#endif // BCL_MODEL_OBJECTIVE_FUNCTION_CUTOFF_FROM_PERCENTILE_H_
