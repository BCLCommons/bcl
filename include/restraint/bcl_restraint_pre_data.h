...
#ifndef BCL_RESTRAINT_PRE_DATA_H_
#define BCL_RESTRAINT_PRE_DATA_H_
...
namespace bcl
{
  namespace restraint
  {
    ...
    //!
    //! @class PREData
    //! @brief restraint::Interface derived class implements functionality for a restraint based on PRE data
    //!
    //! @see @link example_restraint_pre_data.cpp @endlink
    //! @author weinerbe
    //! @date Jan 14, 2012
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API PREData :
      public Interface
    {
    ...
    //////////
      ...
      //! the score used internally
      static const util::SiPtr< const score::RestraintAtomDistance> s_Score;

    public:

      //! PRE restraint score
      static fold::Score e_ScorePRERestraint;
    ...
    //////////////////////////////////
      ...
      PREData( const HandlerBase< util::ShPtrVector< AtomDistance> > &HANDLER);
...
#endif // BCL_RESTRAINT_PRE_DATA_H_
