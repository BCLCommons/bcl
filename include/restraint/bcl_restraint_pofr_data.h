...
#ifndef BCL_RESTRAINT_POFR_DATA_H_
#define BCL_RESTRAINT_POFR_DATA_H_
...
namespace bcl
{
  namespace restraint
  {
    ...
    //!
    //! @class PofrData
    //! @brief restraint::Interface derived class implements functionality for a restraint based on PofR data
    //!
    //! @see @link example_restraint_pofr_data.cpp @endlink
    //! @author putnamdk
    //! @date July 14, 2015
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API PofrData :
      public Interface
    {
    ...
    //////////
      ...
      util::Implementation< SasDensityData> m_Data;
    ...
    public:
      ...
      //! pofr restraint
      static fold::Score e_ScorePofrRestraint;
    ...
    /////////////////
      ...
      const SasDensityData &GetDensityData() const;
...
#endif // BCL_RESTRAINT_POFR_DATA_H_
