...
#ifndef BCL_RESTRAINT_SAS_OPTIMIZATION_H_
#define BCL_RESTRAINT_SAS_OPTIMIZATION_H_
...
namespace bcl
{
  namespace restraint
  {
    ...
    //!
    //! @see @link example_restraint_SasOptimization.cpp @endlink
    //! @author putnamdk
    //! @date May 29, 2013
    //!
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API SasOptimization :
      public util::ObjectInterface
    {

    public:

      static const float default_C1Min;
      static const float default_C1Max;
      static const float default_C2Min;
      static const float default_C2Max;
      static const float default_C1StepSize;
      static const float default_C2StepSize;
    ...
    //////////
      ...
      SasTransformation m_transformation;
    ...
    /////////////////
      ...
      void SetScoreFunction( const score::SasType::ScoreFunctionEnum &SCORE_FUNCTION)
      {
      ...
      void SetTransformationTypes( const SasTransformation &TRANSFORMATION_TYPES)
      {
      ...
      void SetSasType( const bool &SAS_TYPE)
      {
        m_Sans = SAS_TYPE;
      }

      void SetDeuteriumExchangeParameter( const float &DEUTERIUM_EXCHANGE_PARAMETER)
      {
...
#endif // BCL_RESTRAINT_SAS_OPTIMIZATION_H_
