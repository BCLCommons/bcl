...
#ifndef BCL_OPENCL_APPROXIMATOR_RESILIENT_PROPAGATION_H_
#define BCL_OPENCL_APPROXIMATOR_RESILIENT_PROPAGATION_H_
...
namespace bcl
{
  namespace opencl
  {
    ...
    //! @brief opencl implementation of resilient propagation for training neural networks - optimized for GPU
    //!
    //! @see @link example_opencl_approximator_resilient_propagation.cpp @endlink
    //! @author loweew
    //! @date Apr 12, 2011
    //!
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    class BCL_API ApproximatorResilientPropagation :
    ...
    //////////
      ...
      //! trans errors buffers
      storage::Vector< Matrix< float> >                  m_TransErrorsBuffers;

      //! slopes bias buffers
      storage::Vector< Vector< float> >                  m_SlopesBiasBuffers;

      //! prev slopes bias buffers
      storage::Vector< Vector< float> >                  m_PrevSlopesBiasBuffers;
      ...
      //! prev slopes weight buffers
      storage::Vector< Matrix< float> >                  m_PrevSlopesWeightBuffers;
    ...
    //////////////////////////////////
      ...
      ApproximatorResilientPropagation();
      ...
      ApproximatorResilientPropagation *Clone() const;
    ...
    private:
      ...
      //! @param LAYER the layer number
      void PerformWeightsUpdate( const size_t &LAYER);

      //! @brief performs the resilient update algorithm
      //! @param LAYER the layer number
      void PerformBiasUpdate( const size_t &LAYER);
...
#endif // BCL_OPENCL_APPROXIMATOR_RESILIENT_PROPAGATION_H_
