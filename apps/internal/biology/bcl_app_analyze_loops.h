...
#ifndef BCL_APP_ANALYZE_LOOPS_H_
#define BCL_APP_ANALYZE_LOOPS_H_
...
namespace bcl
{
  namespace app
  {
    ...
    //!
    //! @class AnalyzeLoops
    //! @brief Constructs missing loop regions in protein models.
    //!
    //! @see @link example_app_analyze_loops.cpp @endlink
    //! @author fischea
    //! @date Dec 29, 2015
    //!
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    class BCL_API AnalyzeLoops :
      public Interface
    {
    ...
    public:
      ...
      static const ApplicationType AnalyzeLoopss_Instance;

    private:

      //! flag for the input PDB for which to construct missing loop regions
      util::ShPtr< command::FlagStatic> m_InputPDB;

      //! flag for the prefix of the output files
      util::ShPtr< command::FlagStatic> m_OutputPrefix;

      //! flag for ignoring terminal loop
      util::ShPtr< command::FlagStatic> m_IgnoreTermLoops;
...
#endif // BCL_APP_ANALYZE_LOOPS_H_
