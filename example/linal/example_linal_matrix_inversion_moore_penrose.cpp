...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_linal_matrix_inversion_moore_penrose.cpp
  //!
  //! @author mendenjl
  //! @date
  ...
  class ExampleLinalMatrixInversionMoorePenrose :
    public ExampleInterface
  {
  public:

    ExampleLinalMatrixInversionMoorePenrose *Clone() const
    { return new ExampleLinalMatrixInversionMoorePenrose( *this);}
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      // output of ma
      BCL_MessageStd( " this is a random 8x8 matrix ma\n" + format_matrix( ma));

      // invert and output t1
      BCL_MessageStd( "mai is the inverse of matrix ma");
      linal::MatrixInversionMoorePenrose< double> mai( ma);
      BCL_ExampleCheck( linal::MatrixInversionMoorePenrose< double>( ma).IsDefined(), true);
  ...
  }; // end ExampleLinalMatrixInversionMoorePenrose

  const ExampleClass::EnumType ExampleLinalMatrixInversionMoorePenrose::s_Instance
  (
    GetExamples().AddEnum( ExampleLinalMatrixInversionMoorePenrose())
  );
