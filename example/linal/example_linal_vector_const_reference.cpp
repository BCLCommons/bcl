...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_linal_vector_const_reference.cpp
  //!
  //! @author mendenjl
  //! @date
  ...
  class ExampleLinalVectorConstReference :
    public ExampleInterface
  {
  public:

    ExampleLinalVectorConstReference *Clone() const
    {
      return new ExampleLinalVectorConstReference( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      //! default constructor
      linal::VectorConstReference< double> vector_a;

      //! constructing from rows, cols, pointer to data
      linal::VectorConstReference< double> vector_b( 3, vector_orig.Begin());

      //! constructing from VectorInterface
      linal::VectorConstReference< double> vector_ref_c( vector_c);
    ...
    /////////////////
      ...
      BCL_ExampleCheck( vector_a.GetSize(), 0);
    ...
    ///////////////
      ...
      vector_a = vector_orig;
      BCL_ExampleCheck( vector_a, vector_orig);
  ...
  }; //end ExampleLinalVectorConstReference

  const ExampleClass::EnumType ExampleLinalVectorConstReference::s_Instance
  (
    GetExamples().AddEnum( ExampleLinalVectorConstReference())
  );
