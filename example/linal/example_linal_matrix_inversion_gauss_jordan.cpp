...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_linal_matrix_inversion_gauss_jordan.cpp
  //!
  //! @author mendenjl
  //! @date
  ...
  class ExampleLinalMatrixInversionGaussJordan :
    public ExampleInterface
  {
  public:

    ExampleLinalMatrixInversionGaussJordan *Clone() const
    { return new ExampleLinalMatrixInversionGaussJordan( *this);}
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      linal::MatrixInversionGaussJordan< double> mai( ma);
      BCL_ExampleCheck( linal::MatrixInversionGaussJordan< double>( ma).IsDefined(), true);
  ...
  }; // end ExampleLinalMatrixInversionGaussJordan

  const ExampleClass::EnumType ExampleLinalMatrixInversionGaussJordan::s_Instance
  (
    GetExamples().AddEnum( ExampleLinalMatrixInversionGaussJordan())
  );
