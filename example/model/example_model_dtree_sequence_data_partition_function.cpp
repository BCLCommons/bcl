...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_dtree_sequence_data_partition_function.cpp
  //!
  //! @author mendenjl
  //! @date Dec 14, 2013
  ...
  class ExampleModelDtreeSequenceDataPartitionFunction :
    public ExampleInterface
  {
  public:

    ExampleModelDtreeSequenceDataPartitionFunction *Clone() const
    {
      return new ExampleModelDtreeSequenceDataPartitionFunction( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      model::DtreeSequenceDataPartitionFunction default_function;

      // make data partition function
      util::ShPtr< model::DtreeSequenceDataPartitionFunction> function
      (
        new model::DtreeSequenceDataPartitionFunction()
      );
    ...
    ///////////////
      ...
      (
        model::DtreeSequenceDataPartitionFunction()( feature_result_and_state)
      );
    ...
    //////////////////////
      ...
      model::DtreeSequenceDataPartitionFunction function_read;
      // read bcl object
  ...
  }; //ExampleClass::ExampleModelDtreeSequenceDataPartitionFunction

  const ExampleClass::EnumType ExampleModelDtreeSequenceDataPartitionFunction::s_Instance
  (
    GetExamples().AddEnum( ExampleModelDtreeSequenceDataPartitionFunction())
  );
