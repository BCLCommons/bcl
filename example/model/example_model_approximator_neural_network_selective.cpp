...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_approximator_neural_network_selective.cpp
  //!
  //! @author kothiwsk
  //! @date Apr 20, 2015
  ...
  class ExampleModelApproximatorNeuralNetworkSelective :
    public ExampleInterface
  {
  public:

    ExampleModelApproximatorNeuralNetworkSelective *Clone() const
    {
      return new ExampleModelApproximatorNeuralNetworkSelective( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      // default constructor
      model::ApproximatorNeuralNetworkSelective irp_default;
      ...
      (
        new model::ApproximatorNeuralNetworkSelective
        (
  ...
  }; //end ExampleModelApproximatorNeuralNetworkSelective

  const ExampleClass::EnumType ExampleModelApproximatorNeuralNetworkSelective::s_Instance
  (
    GetExamples().AddEnum( ExampleModelApproximatorNeuralNetworkSelective())
  );
