...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_feature_data_set.cpp
  //!
  //! @author loweew
  //! @date Nov 6, 2010
  ...
  class ExampleModelFeatureDataSet :
    public ExampleInterface
  {
  public:

    ExampleModelFeatureDataSet *Clone() const
    {
      return new ExampleModelFeatureDataSet( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      model::FeatureDataSet< float> feature_ds( features);
      model::FeatureDataSet< float> feature_ds_b( features);

      // constructing feature data set of results from data set interface
      model::FeatureDataSet< float> result_ds( results);

      // copy constructor
      util::ShPtr< model::FeatureDataSet< float> > feat_ds_clone( feature_ds.Clone());
    ...
    /////////////////
      ...
      // HasOwnership()
      BCL_ExampleCheck( feat_ds_clone->HasOwnership(), true);
    ...
    ////////////////
      ...
      BCL_ExampleCheck( feature_ds_b.GetMatrix()( 1, 1), float( 2));
    ...
    ///////////////
      ...
      // operator[]()
      BCL_ExampleCheck( feat_ds_clone->operator []( 1), feat_ds_clone->GetMatrix().Begin() + 3);
  ...
  }; //end ExampleModelFeatureDataSet

  const ExampleClass::EnumType ExampleModelFeatureDataSet::s_Instance
  (
    GetExamples().AddEnum( ExampleModelFeatureDataSet())
  );
