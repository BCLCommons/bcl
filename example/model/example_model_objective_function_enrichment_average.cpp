...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_objective_function_enrichment_average.cpp
  //!
  //! @author butkiem1
  //! @date Mar 14, 2011
  ...
  class ExampleModelObjectiveFunctionEnrichmentAverage :
    public ExampleInterface
  {
  public:

    ExampleModelObjectiveFunctionEnrichmentAverage *Clone() const
    {
      return new ExampleModelObjectiveFunctionEnrichmentAverage( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      //! default constructor
      model::ObjectiveFunctionEnrichmentAverage objective_function_default;
      ...
      (
        monitor_frds, util::ObjectDataLabel( "EnrichmentAverage")
      );

      //! constructor with parameters with specialization (here objective function rmsd)
      model::ObjectiveFunctionWrapper objective_function
      (
        monitor_frds, util::ObjectDataLabel( "EnrichmentAverage(cutoff=0.5,enrichment max=0.05,step size=0.005,parity=1)")
      );
    ...
    /////////////////
      ...
      objective_function_default_by_label.SetData( monitor_frds, rescale_in);

      // check get and set methods
      BCL_ExampleAssert( objective_function_default_by_label.GetData()->GetSize(), size_t( 100));
    ...
    ///////////////
      ...
      (
        ...
        true,
        "operator(), expected 1, but got " + util::Format()( objective_function( neural_network_model))
      );
    ...
    //////////////////////
      ...
      model::ObjectiveFunctionEnrichmentAverage objective_function_read;
      // read bcl object
  ...
  }; //end ExampleModelObjectiveFunctionEnrichmentAverage

  const ExampleClass::EnumType ExampleModelObjectiveFunctionEnrichmentAverage::s_Instance
  (
    GetExamples().AddEnum( ExampleModelObjectiveFunctionEnrichmentAverage())
  );
