...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_neural_network_update_weights_simple_propagation.cpp
  //!
  //! @author mendenjl
  //! @date May 12, 2011
  ...
  class ExampleModelNeuralNetworkUpdateWeightsSimplePropagation :
    public ExampleInterface
  {
  public:

    ExampleModelNeuralNetworkUpdateWeightsSimplePropagation *Clone() const
    {
      return new ExampleModelNeuralNetworkUpdateWeightsSimplePropagation( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      // default constructor
      model::NeuralNetworkUpdateWeightsSimplePropagation weight_updater_default;
  ...
  }; //end ExampleModelNeuralNetworkUpdateWeightsSimplePropagation

  const ExampleClass::EnumType ExampleModelNeuralNetworkUpdateWeightsSimplePropagation::s_Instance
  (
    GetExamples().AddEnum( ExampleModelNeuralNetworkUpdateWeightsSimplePropagation())
  );
