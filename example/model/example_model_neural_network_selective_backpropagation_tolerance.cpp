...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_neural_network_selective_backpropagation_tolerance.cpp
  //!
  //! @author mendenjl
  //! @date Nov 15, 2013
  ...
  class ExampleModelNeuralNetworkSelectiveBackpropagationTolerance :
    public ExampleInterface
  {
  public:

    ExampleModelNeuralNetworkSelectiveBackpropagationTolerance *Clone() const
    {
      return new ExampleModelNeuralNetworkSelectiveBackpropagationTolerance( *this);
    }
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      model::NeuralNetworkSelectiveBackpropagationTolerance backprop_selector;
      ...
      util::Implementation< model::NeuralNetworkSelectiveBackpropagationInterface>
        backprop_selector_up_to_1_off( "Tolerant(tolerance=1.0)");

      // construct a second version that should backpropagate everything
      util::Implementation< model::NeuralNetworkSelectiveBackpropagationInterface>
        backprop_selector_all_impl( "Tolerant(tolerance=0)");
      ...
      // test alias
      BCL_ExampleCheck( backprop_selector.GetAlias(), "Tolerant");
  ...
  const ExampleClass::EnumType ExampleModelNeuralNetworkSelectiveBackpropagationTolerance::s_Instance
  (
    GetExamples().AddEnum( ExampleModelNeuralNetworkSelectiveBackpropagationTolerance())
  );
