...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_approximator_kohonen_network.cpp
  //!
  //! @author mendenjl
  //! @date Sep 03, 2013
  ...
  class ExampleModelApproximatorKohonenNetwork :
    public ExampleInterface
  {
  public:

    ExampleModelApproximatorKohonenNetwork *Clone() const
    {
      return new ExampleModelApproximatorKohonenNetwork( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      //default constructor
      model::ApproximatorKohonenNetwork default_constructor;
      ...
      util::ShPtr< model::ApproximatorKohonenNetwork> sp_iterate
      (
        new model::ApproximatorKohonenNetwork
        (
          dimensions,
          iterations,
          initial_radius,
          objective,
          10,
          model::ApproximatorKohonenNetwork::e_Gaussian
        )
      );
    ...
    ///////////////
      ...
      for( size_t counter( 0), iterations( 20); counter < iterations; ++counter)
      {
        sp_iterate->Next();
  ...
  }; //end ExampleClass::ExampleModelApproximatorKohonenNetwork

  const ExampleClass::EnumType ExampleModelApproximatorKohonenNetwork::s_Instance
  (
    GetExamples().AddEnum( ExampleModelApproximatorKohonenNetwork())
  );
