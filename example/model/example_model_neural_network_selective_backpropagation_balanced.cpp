...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_neural_network_selective_backpropagation_balanced.cpp
  //!
  //! @author mendenjl
  //! @date Jun 10, 2013
  ...
  class ExampleModelNeuralNetworkSelectiveBackpropagationBalanced :
    public ExampleInterface
  {
  public:

    ExampleModelNeuralNetworkSelectiveBackpropagationBalanced *Clone() const
    {
      return new ExampleModelNeuralNetworkSelectiveBackpropagationBalanced( *this);
    }
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      model::NeuralNetworkSelectiveBackpropagationBalanced backprop_selector;
      ...
      // test alias
      BCL_ExampleCheck( backprop_selector.GetAlias(), "Balanced");
      ...
      // now test more trivial cases: test that nothing is backpropagated if the predictions are exactly right
      ...
      BCL_ExampleIndirectCheck( backprop_count_below, backprop_count_above, "Balancing when results were correct");
      BCL_ExampleIndirectCheck( backprop_count_below, 0, "nothing should be backpropagated given correct results");
  ...
  const ExampleClass::EnumType ExampleModelNeuralNetworkSelectiveBackpropagationBalanced::s_Instance
  (
    GetExamples().AddEnum( ExampleModelNeuralNetworkSelectiveBackpropagationBalanced())
  );
