...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_approximator_restricted_boltzmann_machine.cpp
  //!
  //! @author mendenjl
  //! @date Sep 04, 2013
  ...
  class ExampleModelApproximatorRestrictedBoltzmannMachine :
    public ExampleInterface
  {
  public:

    ExampleModelApproximatorRestrictedBoltzmannMachine *Clone() const
    {
      return new ExampleModelApproximatorRestrictedBoltzmannMachine( *this);
    }
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      (
        new model::RescaleFeatureDataSet( *features_results_frds->GetFeaturesPtr(), model::RestrictedBoltzmannMachineLayer::s_DefaultInputRange)
      );
    ...
    //////////////////////////////////
      ...
      // default constructor
      model::ApproximatorRestrictedBoltzmannMachine irp_default;
      ...
      (
        new model::ApproximatorRestrictedBoltzmannMachine
        (
    ...
    ////////////////
      ...
      // The following code, used for testing ANN outputs, causes weights divergence, likely due to incorrect derivative
      // calculations.  See http://www.icml-2011.org/papers/98_icmlpaper.pdf for explanation and better derivative
      // approximations that may make this work properly
//
//      BCL_MessageStd
//      (
...
//      util::ShPtr< model::IterateInterface> sp_iterate_simple
//      (
//        new model::ApproximatorRestrictedBoltzmannMachine
//        (
//          features_results_xor_frds,
//          0,
//          storage::Vector< size_t>( 1, size_t( 2)),
//          sp_objective_function_xor,
//          util::Implementation< model::NeuralNetworkUpdateWeightsInterface>( "Resilient(max change=0.01)"),
//          util::Implementation< model::NeuralNetworkUpdateWeightsInterface>( "Resilient(max change=0.01)"),
//          10,
//          model::RestrictedBoltzmannMachineLayer::e_Binomial
//        )
//      );
//
//      // reset the counter
//      sp_counter->Reset();
//
//      // give the counter to the new iterate
//      sp_iterate_simple->SetCounter( sp_counter);
//
//      // iterate (train) the network one step
//      const util::ShPtr< storage::Pair< util::ShPtr< model::Interface>, float> > improved_pair_xor
//      (
//        sp_iterate_simple->operator ()()
//      );
//
//      // check the output of the untrained network
//      BCL_MessageStd
...
//      );
//
//      const size_t total_steps_xor( 1000);
//      for( size_t step_number( 1); step_number < total_steps_xor; ++step_number)
//      {
//        final_pair = sp_iterate_simple->operator ()();
...
//      );
  ...
  }; //end ExampleModelApproximatorRestrictedBoltzmannMachine

  const ExampleClass::EnumType ExampleModelApproximatorRestrictedBoltzmannMachine::s_Instance
  (
    GetExamples().AddEnum( ExampleModelApproximatorRestrictedBoltzmannMachine())
  );
