...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_objective_function_contingency_matrix_measure_monitoring_dataset.cpp
  //!
  //! @author mendenjl
  //! @date Nov 05, 2013
  ...
  class ExampleModelObjectiveFunctionContingencyMatrixMeasure :
    public ExampleInterface
  {
  public:

    ExampleModelObjectiveFunctionContingencyMatrixMeasure *Clone() const
    {
      return new ExampleModelObjectiveFunctionContingencyMatrixMeasure( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      model::ObjectiveFunctionContingencyMatrixMeasure function_default;
      ...
      (
        ...
        (
          model::ObjectiveFunctionContingencyMatrixMeasure
          (
            activity_cutoff,
            math::ContingencyMatrixMeasures( math::ContingencyMatrixMeasures::e_Accuracy)
          )
        )
      );
  ...
  }; //end ExampleModelObjectiveFunctionContingencyMatrixMeasure

  const ExampleClass::EnumType ExampleModelObjectiveFunctionContingencyMatrixMeasure::s_Instance
  (
    GetExamples().AddEnum( ExampleModelObjectiveFunctionContingencyMatrixMeasure())
  );
