...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_objective_function_accuracy_monitoring_dataset.cpp
  //!
  ...
  class ExampleModelObjectiveFunctionAccuracy :
    public ExampleInterface
  {
  public:

    ExampleModelObjectiveFunctionAccuracy *Clone() const
    {
      return new ExampleModelObjectiveFunctionAccuracy( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      model::ObjectiveFunctionAccuracy function_default;
  ...
  }; //end ExampleModelObjectiveFunctionAccuracy

  const ExampleClass::EnumType ExampleModelObjectiveFunctionAccuracy::s_Instance
  (
    GetExamples().AddEnum( ExampleModelObjectiveFunctionAccuracy())
  );
