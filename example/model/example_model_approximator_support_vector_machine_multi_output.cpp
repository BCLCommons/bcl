...
namespace bcl
{
  ...
  class ExampleModelApproximatorSupportVectorMachineMultiOutput :
    public ExampleInterface
  {
  public:

    ExampleModelApproximatorSupportVectorMachineMultiOutput *Clone() const
    {
      return new ExampleModelApproximatorSupportVectorMachineMultiOutput( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      util::ShPtr< model::Interface> svr_model( new model::SupportVectorMachineMultiOutput( kernel));

      // construct iterate for svm training from properties
      util::ShPtr< model::ApproximatorBase> sp_iterate
      (
        new model::ApproximatorSupportVectorMachineMultiOutput
        (
          float( 1),              // parameter C
          svr_model,              // svm model
  ...
  }; //end ExampleModelApproximatorSupportVectorMachineMultiOutput

  const ExampleClass::EnumType ExampleModelApproximatorSupportVectorMachineMultiOutput::s_Instance
  (
    GetExamples().AddEnum( ExampleModelApproximatorSupportVectorMachineMultiOutput())
  );
