...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_retrieve_data_set_bootstrap.cpp
  //!
  //! @author mendenjl
  //! @date May 07, 2018
  ...
  class ExampleModelRetrieveDataSetBootstrap :
    public ExampleInterface
  {
  public:

    ExampleModelRetrieveDataSetBootstrap *Clone() const
    {
      return new ExampleModelRetrieveDataSetBootstrap( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      // default constructor
      model::RetrieveDataSetBootstrap default_retrieve_data_set_chunk;
      ...
      // create a model::RetrieveDataSetBootstrap as an implementation of the retrieve data set base
    ...
    /////////////////
      ...
      BCL_ExampleCheck( model::RetrieveDataSetBootstrap().GetAlias(), "Bootstrap");
  ...
  }; //end ExampleModelRetrieveDataSetBootstrap

  const ExampleClass::EnumType ExampleModelRetrieveDataSetBootstrap::s_Instance
  (
    GetExamples().AddEnum( ExampleModelRetrieveDataSetBootstrap())
  );
