...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_kohonen_network_average.cpp
  //!
  ...
  class ExampleModelKohonenNetworkAverage :
    public ExampleInterface
  {
  public:

    ExampleModelKohonenNetworkAverage *Clone() const
    {
      return new ExampleModelKohonenNetworkAverage( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      // default constructor
      model::KohonenNetworkAverage default_network;
      ...
      // full constructor
      model::KohonenNetworkAverage network( map_dimensions, rescale_in);
    ...
    //////////////////////
      ...
      model::KohonenNetworkAverage network_read;
  ...
  }; //end ExampleClass::ExampleModelKohonenNetworkAverage

  const ExampleClass::EnumType ExampleModelKohonenNetworkAverage::s_Instance
  (
    GetExamples().AddEnum( ExampleModelKohonenNetworkAverage())
  );
