...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_model_support_vector_machine.cpp
  //!
  ...
  class ExampleModelSupportVectorMachine :
    public ExampleInterface
  {
  public:

    ExampleModelSupportVectorMachine *Clone() const
    {
      return new ExampleModelSupportVectorMachine( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      model::SupportVectorMachine svm_default;

      model::SupportVectorMachine svm_init( kernel, rescale_feature, rescale_result);
      ...
      model::SupportVectorMachine svm_copy( svm_init);

      util::ShPtr< model::SupportVectorMachine> svm_clone( svm_init.Clone());
  ...
  }; //end ExampleModelSupportVectorMachine

  const ExampleClass::EnumType ExampleModelSupportVectorMachine::s_Instance
  (
    GetExamples().AddEnum( ExampleModelSupportVectorMachine())
  );
