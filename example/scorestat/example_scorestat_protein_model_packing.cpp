...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_scorestat_protein_model_packing.cpp
  //!
  //! @author mendenjl
  //! @date Mar 09, 2017
  ...
  class ExampleScorestatProteinModelPacking :
    public ExampleInterface
  {
  public:

    ExampleScorestatProteinModelPacking *Clone() const
    {
      return new ExampleScorestatProteinModelPacking( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      scorestat::ProteinModelPacking loop_dist_along_sse_unnorm;

      BCL_MessageStd( "test clone");
      util::ShPtr< scorestat::ProteinModelPacking> sp_loop( loop_dist_along_sse_unnorm.Clone());
  ...
  }; //end ExampleScorestatProteinModelPacking

  const ExampleClass::EnumType ExampleScorestatProteinModelPacking::s_Instance
  (
    GetExamples().AddEnum( ExampleScorestatProteinModelPacking())
  );
