...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_scorestat_loop_closure.cpp
  //! @brief this example tests the implementation of LoopClosure for extracting loop closure statistics from a protein
  //!        ensemble
  //!
  //! @author lib14
  ...
  class ExampleScorestatLoopClosure :
  ...
  //////////////////////////////////
    ...
    //! @return a pointer to a new ExampleScorestatLoopClosure object
    ExampleScorestatLoopClosure *Clone() const
    {
      return new ExampleScorestatLoopClosure( *this);
    }
  ...
  ////////////////
    ...
    int Run() const
    {
      ...
      const scorestat::LoopClosure loop_closure_default;
      ...
      loop_closure_default.WriteAnalysisFile( output_prefix, protein_ensemble);

      // check results
      const std::string written_file( output_prefix + loop_closure_default.GetOutFilePostfix());
      ...
      (
        ...
        "expected_" + loop_closure_default.GetOutFilePostfix()
      );
    ...
    //! single instance of this class
    const ExampleClass::EnumType ExampleScorestatLoopClosure::s_Instance
    (
      GetExamples().AddEnum( ExampleScorestatLoopClosure())
    );
