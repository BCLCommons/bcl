...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_sdf_mdl_handler.cpp
  //!
  ...
  class ExampleSdfMdlHandler :
    public ExampleInterface
  {
  public:

    ExampleSdfMdlHandler *Clone() const
    {
      return new ExampleSdfMdlHandler( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      sdf::MdlHandler handler_default;

      // check constructor with parameters
      sdf::MdlHandler handler( read);

      // check clone
      util::ShPtr< sdf::MdlHandler> sp_handler( handler.Clone());
    ...
    /////////////////
      ...
      BCL_ExampleCheck( sdf::MdlHandler::IsTerminalLine( "$$$$\r"), true);
      BCL_ExampleCheck( sdf::MdlHandler::IsTerminalLine( "$$$$"),   true);

      // try is terminal line with a line that is not terminal
      BCL_ExampleCheck( sdf::MdlHandler::IsTerminalLine( "$$$"),    false);
  ...
  }; //end ExampleSdfMdlHandler

  const ExampleClass::EnumType ExampleSdfMdlHandler::s_Instance
  (
    GetExamples().AddEnum( ExampleSdfMdlHandler())
  );
