...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_sdf_molfile_handler.cpp
  //!
  //! @author geanesar
  //! @date
  ...
  class ExampleSdfMolfileHandler :
    public ExampleInterface
  {
  public:

    ExampleSdfMolfileHandler *Clone() const
    {
      return new ExampleSdfMolfileHandler( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      sdf::MolfileHandler handler_default;

      // check constructor with parameters
      sdf::MolfileHandler handler( read);

      // check clone
      util::ShPtr< sdf::MolfileHandler> sp_handler( handler.Clone());
    ...
    /////////////////
      ...
      BCL_ExampleCheck( sdf::MolfileHandler::IsTerminalLine( "$$$$\r"), true);
      BCL_ExampleCheck( sdf::MolfileHandler::IsTerminalLine( "$$$$"),   true);

      // try is terminal line with a line that is not terminal
      BCL_ExampleCheck( sdf::MolfileHandler::IsTerminalLine( "$$$"),    false);
  ...
  }; //end ExampleSdfMolfileHandler

  const ExampleClass::EnumType ExampleSdfMolfileHandler::s_Instance
  (
    GetExamples().AddEnum( ExampleSdfMolfileHandler())
  );
