...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_fold_mutate_protein_model_sse_pair.cpp
  //!
  //! @author karakam
  //! @date
  ...
  class ExampleFoldMutateProteinModelSSEPair :
    public ExampleInterface
  {
  public:

    ExampleFoldMutateProteinModelSSEPair *Clone() const
    { return new ExampleFoldMutateProteinModelSSEPair( *this);}
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      fold::MutateProteinModelSSEPair mutate_sse_pair
      (
        sp_sse_pair_collect,
        3.0,             // 3.0 max translation
        math::g_Pi / 3.0 // 60 degress max rotation
      );
  ...
  }; //end ExampleFoldMutateProteinModelSSEPair

  const ExampleClass::EnumType ExampleFoldMutateProteinModelSSEPair::s_Instance
  (
    GetExamples().AddEnum( ExampleFoldMutateProteinModelSSEPair())
  );
