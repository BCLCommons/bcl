...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_fold_mutate_protein_model_strand_switch_sheet.cpp
  //!
  //! @author karakam
  //! @date Nov 6, 2010
  ...
  class ExampleFoldMutateProteinModelStrandSwitchSheet :
    public ExampleInterface
  {
  public:

    ExampleFoldMutateProteinModelStrandSwitchSheet *Clone() const
    {
      return new ExampleFoldMutateProteinModelStrandSwitchSheet( *this);
    }
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      // construct placement
      fold::PlacementStrandNextToSheet placement( 0.5);
    ...
    //////////////////////////////////
      ...
      fold::MutateProteinModelStrandSwitchSheet mutate_def;

      BCL_MessageStd( "test constructor from a placement and a scheme");
      fold::MutateProteinModelStrandSwitchSheet mutate( placement, "test_scheme");

      BCL_MessageStd( "test copy constructor");
      fold::MutateProteinModelStrandSwitchSheet mutate_copy( mutate);

      BCL_MessageStd( "test clone");
      util::ShPtr< fold::MutateProteinModelStrandSwitchSheet> sp_mutate( mutate.Clone());
    ...
    ///////////////
      ...
      // model with two unpaired strands
      {
        ...
        (
          model_with_two_unpaired_strands, AddExampleOutputPathToFilename( mutate, "mutate_strand_switch_sheet_a_0.pdb")
        );
        ...
        Proteins::WriteModelToPDB
        (
          *result_a.GetArgument(), AddExampleOutputPathToFilename( mutate, "mutate_strand_switch_sheet_a_1.pdb")
        );

        // collect the sheets
        util::ShPtrVector< assemble::Domain> sheets_a( assemble::CollectorSheet().Collect( *result_a.GetArgument()));
        BCL_Example_Check
        (
          sheets_a.GetSize() == 1 && sheets_a( 0)->GetNumberSSEs() == 2,
          "The result_a should have a model with only one sheet with two strands not " +
          util::Format()( sheets_a.GetSize())
        );
      }
      ...
      // model with one unpaired strand and a sheet of two strands
      {
        ...
        (
          ...
          AddExampleOutputPathToFilename( mutate, "mutate_strand_switch_sheet_b_0.pdb")
        );
        ...
        Proteins::WriteModelToPDB
        (
          *result_b.GetArgument(), AddExampleOutputPathToFilename( mutate, "mutate_strand_switch_sheet_b_1.pdb")
        );

        // collect the sheets
        util::ShPtrVector< assemble::Domain> sheets_b( assemble::CollectorSheet().Collect( *result_b.GetArgument()));
        BCL_Example_Check
        (
          ( sheets_b.GetSize() == 1 && sheets_b( 0)->GetNumberSSEs() == 3) ||
          (
            sheets_b.GetSize() == 2
            &&
            (
              ( sheets_b( 0)->GetNumberSSEs() == 1 && sheets_b( 1)->GetNumberSSEs() == 2) ||
              ( sheets_b( 0)->GetNumberSSEs() == 2 && sheets_b( 1)->GetNumberSSEs() == 1)
            )
          ),
          "The result_b should have a model either with 2 sheets( 2:1/1:2) or 1 sheet (3)"
        );
      ...
      // model with two unpaired strands and a sheet of two strands
      {
        ...
        (
          ...
          AddExampleOutputPathToFilename( mutate, "mutate_strand_switch_sheet_c_0.pdb")
        );
        ...
        Proteins::WriteModelToPDB
        (
          *result_c.GetArgument(), AddExampleOutputPathToFilename( mutate, "mutate_strand_switch_sheet_c_1.pdb")
        );

        // collect the sheets
        util::ShPtrVector< assemble::Domain> sheets_c( assemble::CollectorSheet().Collect( *result_c.GetArgument()));
        BCL_Example_Check
        (
          (
            sheets_c.GetSize() == 2
            &&
            (
              ( sheets_c( 0)->GetNumberSSEs() == 2 && sheets_c( 1)->GetNumberSSEs() == 2) ||
              ( sheets_c( 0)->GetNumberSSEs() == 3 && sheets_c( 1)->GetNumberSSEs() == 1) ||
              ( sheets_c( 0)->GetNumberSSEs() == 1 && sheets_c( 1)->GetNumberSSEs() == 3)
            )
          )
          ||
          (
            ...
            &&
            (
              ( sheets_c( 0)->GetNumberSSEs() == 2 && sheets_c( 1)->GetNumberSSEs() == 1 && sheets_c( 2)->GetNumberSSEs() == 1) ||
              ( sheets_c( 0)->GetNumberSSEs() == 1 && sheets_c( 1)->GetNumberSSEs() == 2 && sheets_c( 2)->GetNumberSSEs() == 1) ||
              ( sheets_c( 0)->GetNumberSSEs() == 1 && sheets_c( 1)->GetNumberSSEs() == 1 && sheets_c( 2)->GetNumberSSEs() == 2)
            )
          ),
          "The result_c should have a model either with 2 sheets( 2:2/1:3/3:1) or with 3 sheets( 2:1:1/1:2:1/1:1:2)"
        );
      }
    ...
    //////////////////////
      ...
      fold::MutateProteinModelStrandSwitchSheet mutate_read;
  ...
  }; //end ExampleFoldMutateProteinModelStrandSwitchSheet

  const ExampleClass::EnumType ExampleFoldMutateProteinModelStrandSwitchSheet::s_Instance
  (
    GetExamples().AddEnum( ExampleFoldMutateProteinModelStrandSwitchSheet())
  );
