...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_opti_criterion_combine.cpp
  //! @brief this example tests the implementation of the CriterionCombine
  //!
  //! @author fischea
  //! @date 12/13/2012
  ...
  class ExampleOptiCriterionCombine :
  ...
  public:
    ...
    //! @return pointer to a new ExampleOptiCriterionCombine
    ExampleOptiCriterionCombine *Clone() const
    {
      return new ExampleOptiCriterionCombine( *this);
    }
  ...
  ////////////////
    ...
    //////////////////////////////////
      ...
      util::ShPtr< opti::CriterionCombine< double, double> > sp_criterion_combine
      (
        new opti::CriterionCombine< double, double>( criteria_list)
      );
    ...
    /////////////////
      ...
      (
        ...
        ( GetStaticClassName< opti::CriterionCombine< double, double> >())
      );
    ...
    //////////////////////
      ...
      // read criterion
      opti::CriterionCombine< double, double> criterion_read;
  ...
  const ExampleClass::EnumType ExampleOptiCriterionCombine::s_Instance
  (
    GetExamples().AddEnum( ExampleOptiCriterionCombine())
  );
