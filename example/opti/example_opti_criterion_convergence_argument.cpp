...
namespace bcl
{
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_opti_criterion_convergence_argument.cpp
  //! @brief tests the implementation of the CriterionConvergenceArgument
  //!
  //! @author fischea
  //! @date 12/13/2012
  ...
  class ExampleOptiCriterionConvergenceArgument :
  ...
  public:
    ...
    //! @return pointer to a new ExampleOptiCriterionConvergenceArgument
    ExampleOptiCriterionConvergenceArgument *Clone() const
    {
      return new ExampleOptiCriterionConvergenceArgument( *this);
    }
  ...
  ////////////////
    ...
    //////////////////////////////////
      ...
      util::ShPtr< opti::CriterionConvergenceArgument< double, double> > sp_criterion
      (
        new opti::CriterionConvergenceArgument< double, double>( 3, 0.25)
      );
      ...
      // clone the criterion
      util::ShPtr< opti::CriterionConvergenceArgument< double, double> > sp_criterion_clone( sp_criterion->Clone());
    ...
    /////////////////
      ...
      (
        ...
        ( GetStaticClassName< opti::CriterionConvergenceArgument< double, double> >())
      );
    ...
    //////////////////////
      ...
      // read criterion
      opti::CriterionConvergenceArgument< double, double> criterion_read;
  ...
  const ExampleClass::EnumType ExampleOptiCriterionConvergenceArgument::s_Instance
  (
    GetExamples().AddEnum( ExampleOptiCriterionConvergenceArgument())
  );
