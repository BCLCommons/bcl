...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_biol_protein_mutation_set.cpp
  //!
  //! @author mendenjl
  //! @date
  ...
  class ExampleBiolProteinMutationSet :
    public ExampleInterface
  {
  public:

    ExampleBiolProteinMutationSet *Clone() const
    { return new ExampleBiolProteinMutationSet( *this);}
...
//      biol::ProteinMutationSet protein_model( factory.ProteinModelFromPDB( pdb), false);
//
...
//      biol::ProteinMutationSet protein_model_with_coords( factory.ProteinModelFromPDB( pdb), true);
//
...
//      BCL_ExampleCheck( protein_model_with_coords.GetSize(), 710);
  ...
  }; //end ExampleBiolProteinMutationSet

  const ExampleClass::EnumType ExampleBiolProteinMutationSet::s_Instance
  (
    GetExamples().AddEnum( ExampleBiolProteinMutationSet())
  );
