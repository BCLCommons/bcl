...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_assemble_sse_pool_insert_coil_into_sse.cpp
  //! @brief example that demonstrates how to use the SSEPoolInsertCoilIntoSSE
  //!
  //! @author woetzen
  //! @date Jun 18, 2011
  ...
  class ExampleAssembleSSEPoolInsertCoilIntoSSE :
    public ExampleInterface
  {
  public:

    ExampleAssembleSSEPoolInsertCoilIntoSSE *Clone() const
    {
      return new ExampleAssembleSSEPoolInsertCoilIntoSSE( *this);
    }
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      // pick
      util::ShPtr< assemble::LocatorSSE> sp_locate_sse( new assemble::LocatorSSE( 'A', 23, 34));
    ...
    //////////////////////////////////
      ...
      assemble::SSEPoolInsertCoilIntoSSE ssepool_split
      (
        method,
        sp_locate_sse,
        2
    ...
    /////////////////
      ...
      // class identifier
      BCL_ExampleCheck( ssepool_split.GetClassIdentifier(), GetStaticClassName< assemble::SSEPoolInsertCoilIntoSSE>());

      // scheme
      BCL_ExampleCheck( ssepool_split.GetScheme(), assemble::SSEPoolInsertCoilIntoSSE::GetDefaultScheme());
    ...
    //////////////////////
      ...
      io::OFStream write;
      BCL_ExampleMustOpenOutputFile( write, AddExampleOutputPathToFilename( ssepool_split, "pool_insert_coil.bcl"));
      sp_pool->WriteSSEPool( write);
      io::File::CloseClearFStream( write);

      // write bcl object
      WriteBCLObject( ssepool_split);
      assemble::SSEPoolInsertCoilIntoSSE ssepool_split_read
      (
  ...
  }; //end ExampleAssembleSSEPoolInsertCoilIntoSSE

  const ExampleClass::EnumType ExampleAssembleSSEPoolInsertCoilIntoSSE::s_Instance
  (
    GetExamples().AddEnum( ExampleAssembleSSEPoolInsertCoilIntoSSE())
  );
