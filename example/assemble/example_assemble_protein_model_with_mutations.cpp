...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_assemble_protein_model_with_mutations.cpp
  //!
  //! @author mendenjl
  //! @date
  ...
  class ExampleAssembleProteinModelWithMutations :
    public ExampleInterface
  {
  public:

    ExampleAssembleProteinModelWithMutations *Clone() const
    { return new ExampleAssembleProteinModelWithMutations( *this);}
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      assemble::ProteinModelWithMutations protein_model( factory.ProteinModelFromPDB( pdb), false);
      ...
      assemble::ProteinModelWithMutations protein_model_with_coords( factory.ProteinModelFromPDB( pdb), true);
  ...
  }; //end ExampleAssembleProteinModelWithMutations

  const ExampleClass::EnumType ExampleAssembleProteinModelWithMutations::s_Instance
  (
    GetExamples().AddEnum( ExampleAssembleProteinModelWithMutations())
  );
