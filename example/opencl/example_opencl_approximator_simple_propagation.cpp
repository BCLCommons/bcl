...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_opencl_approximator_simple_propagation.cpp
  //!
  //! @author mendenjl
  //! @date Sep 04, 2013
  ...
  class ExampleOpenclApproximatorSimplePropagation :
    public ExampleInterface
  {
  public:

    ExampleOpenclApproximatorSimplePropagation *Clone() const
    {
      return new ExampleOpenclApproximatorSimplePropagation( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      storage::Vector< size_t> architecture( 1, size_t( 8));
      ...
      (
        new opencl::ApproximatorSimplePropagation
        (
    ...
    /////////////////
      ...
      // class identifiers
      BCL_ExampleCheck( sp_iterate->GetClassIdentifier(), "bcl::opencl::ApproximatorSimplePropagation");
    ...
    ////////////////
      ...
      sp_iterate->SetCriterion( opti::CriterionNumberIterations< util::ShPtr< model::Interface>, float>( 1));
  ...
  }; //end ExampleOpenclApproximatorSimplePropagation

  const ExampleClass::EnumType ExampleOpenclApproximatorSimplePropagation::s_Instance
  (
    GetExamples().AddEnum( ExampleOpenclApproximatorSimplePropagation())
  );
