...
#include "cluster/bcl_cluster_linkage_single.h"
...
namespace bcl
{
  namespace cluster
  {
    // explicit instantiation of LinkageSingle< double >
    template class LinkageSingle< double, double>;
  } // namespace cluster

  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_cluster_linkage_single.cpp
  //!
  //! @author alexanns
  //! @date Nov 6, 2010 
  ...
  class ExampleClusterLinkageSingle :
    public ExampleInterface
  {
  public:

    ExampleClusterLinkageSingle *Clone() const
    {
      return new ExampleClusterLinkageSingle( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      cluster::LinkageSingle< double, double> linkage_copy( linkage_func);

      // test clone constructor
      BCL_MessageStd( "test clone constructor");
      util::ShPtr< cluster::LinkageSingle< double, double> > linkage_clone( linkage_copy.Clone());
      ...
      (
        ...
        && linkage_clone->operator()( node_c, node_b) == 4.0,
          "using the operator() to check construction worked incorrectly, linkage_func should return 3.0 but returned"
    ...
    ///////////////
      ...
      BCL_Example_Check
      (
        math::EqualWithinTolerance( distance, 2.0),
        "distance between node_a_b_c and node_d_e should be 2.0 and is calculated as "
...
//    );
  ...
  private:
    ...
    }; // helper class ExampleClusterLinkageSingle

    static const ExampleClass::EnumType s_Instance;

  }; // end ExampleClusterLinkageSingle

  const ExampleClass::EnumType ExampleClusterLinkageSingle::s_Instance
  (
    GetExamples().AddEnum( ExampleClusterLinkageSingle())
  );
} // namespace bcl
