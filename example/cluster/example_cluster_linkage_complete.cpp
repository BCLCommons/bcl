...
namespace bcl
{
  namespace cluster
  {
    // explicit instantiation of LinkageComplete< double >
    template class LinkageComplete< double, double>;
  } // namespace cluster

  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_cluster_linkage_complete.cpp
  //!
  //! @author alexanns
  //! @date Nov 6, 2010 
  ...
  class ExampleClusterLinkageComplete :
    public ExampleInterface
  {
  public:

    ExampleClusterLinkageComplete *Clone() const
    {
      return new ExampleClusterLinkageComplete( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      cluster::LinkageComplete< double, double> linkage_copy( linkage_func);

      // test clone constructor
      BCL_MessageStd( "test clone constructor");
      util::ShPtr< cluster::LinkageComplete< double, double> > linkage_clone( linkage_copy.Clone());
    ...
    ///////////////
      ...
      BCL_Example_Check
      (
        math::EqualWithinTolerance( distance, 10.0),
        "distance between node_a_b_c and node_d_e should be 10 and is calculated as "
...
//    );
  ...
  private:
    ...
    }; // helper class ExampleClusterLinkageComplete

    static const ExampleClass::EnumType s_Instance;

  }; //end ExampleClusterLinkageComplete

  const ExampleClass::EnumType ExampleClusterLinkageComplete::s_Instance
  (
    GetExamples().AddEnum( ExampleClusterLinkageComplete())
  );
} // namespace bcl
