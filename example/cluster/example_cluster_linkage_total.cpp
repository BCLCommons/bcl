...
#include "cluster/bcl_cluster_linkage_total.h"
...
namespace bcl
{
  namespace cluster
  {
    // explicit instantiation of LinkageTotal< double >
    template class LinkageTotal< double, double>;
  } // namespace cluster

  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_cluster_linkage_total.cpp
  //!
  //! @author alexanns
  //! @date Nov 6, 2010 
  ...
  class ExampleClusterLinkageTotal :
    public ExampleInterface
  {
  public:

    ExampleClusterLinkageTotal *Clone() const
    {
      return new ExampleClusterLinkageTotal( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      cluster::LinkageTotal< double, double> linkage_copy( linkage_func);

      // test clone constructor
      BCL_MessageStd( "test clone constructor");
      util::ShPtr< cluster::LinkageTotal< double, double> > linkage_clone( linkage_copy.Clone());
    ...
    ///////////////
      ...
      double distance( linkage_copy( node_a_b_c, node_d_e)), expected_distance( 5.2);

      // make sure that the correct distance was calculated
      BCL_Example_Check
      (
        math::EqualWithinTolerance( distance, expected_distance),
        "distance between node_a_b_c and node_d_e should be " + util::Format()( expected_distance)
        + " and is calculated as " + util::Format()( linkage_copy( node_a_b_c, node_d_e))
      );
...
//    );
  ...
  }; //end ExampleClusterLinkageTotal

  const ExampleClass::EnumType ExampleClusterLinkageTotal::s_Instance
  (
    GetExamples().AddEnum( ExampleClusterLinkageTotal())
  );
} // namespace bcl
