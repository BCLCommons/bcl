...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_chemistry_fragment_split_rings.cpp
  //!
  //! @author kothiwsk
  //! @date Oct 23, 2012
  ...
  class ExampleChemistryFragmentSplitRings :
    public ExampleInterface
  {
  public:

    ExampleChemistryFragmentSplitRings *Clone() const
    { return new ExampleChemistryFragmentSplitRings( *this);}
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      chemistry::FragmentSplitRings chains( false);
    ...
    static const ExampleClass::EnumType ExampleChemistryFragmentSplitRings_Instance;

  }; //end ExampleChemistryFragmentSplitRings

  const ExampleClass::EnumType ExampleChemistryFragmentSplitRings::ExampleChemistryFragmentSplitRings_Instance
  (
    GetExamples().AddEnum( ExampleChemistryFragmentSplitRings())
  );
