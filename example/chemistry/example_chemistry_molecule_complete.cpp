...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_chemistry_molecule_complete.cpp
  //! @details Tests ChemistryMoleculeComplete class which contains small molecule configuration data
  //!
  //! @author mendenjl
  //! @date
  ...
  class ExampleChemistryMoleculeComplete :
    public ExampleInterface
  {
  public:

    ExampleChemistryMoleculeComplete *Clone() const
    {
      return new ExampleChemistryMoleculeComplete( *this);
    }
  ...
  const ExampleClass::EnumType ExampleChemistryMoleculeComplete::s_Instance
  (
    GetExamples().AddEnum( ExampleChemistryMoleculeComplete())
  );
