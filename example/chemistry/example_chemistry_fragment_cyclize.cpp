...
//  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  //!
//  //! @example example_chemistry_fragment_cyclize.cpp
//  //!
...
//  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//  class ExampleChemistryFragmentCyclize :
//    public ExampleInterface
//  {
//  public:
//
//    ExampleChemistryFragmentCyclize *Clone() const
//    {
//      return new ExampleChemistryFragmentCyclize( *this);
//    }
//
//  /////////////////
//  // data access //
...
//      chemistry::FragmentCyclize fragment_cyclize;
//
//      // clone function
//      util::ShPtr< chemistry::FragmentCyclize> fragment_cyclize_clone( fragment_cyclize.Clone());
//      BCL_ExampleCheck( fragment_cyclize_clone.IsDefined(), true);
//
//      // construct with arguments
////      chemistry::FragmentCyclize fragment_cyclizeer
////      (
...
//      io::IFStream input;
//      BCL_ExampleMustOpenInputFile( input, AddExampleInputPathToFilename( e_Chemistry, "36.sdf"));
//
//      // read in ensemble
...
////      {
////        new_mutate = fragment_cyclize( d6w);
...
////      const std::string fragment_cyclize_out( AddExampleOutputPathToFilename( *new_molecule, "fragment_cyclize.sdf"));
////      io::OFStream output;
////      BCL_ExampleMustOpenOutputFile( output, fragment_cyclize_out);
////
////      // write out the constitution as we do not have coordinates
////      new_molecule->WriteMDL( output);
////      io::File::CloseClearFStream( output);
////      std::string correct_filename( fragment_cyclize_out + ".correct");
//
//    //////////////////////
//    // input and output //
//    //////////////////////
...
//
//  }; //end ExampleChemistryFragmentCyclize
//
//  const ExampleClass::EnumType ExampleChemistryFragmentCyclize::s_Instance
//  (
//    GetExamples().AddEnum( ExampleChemistryFragmentCyclize())
//  );
//
//} // namespace bcl
