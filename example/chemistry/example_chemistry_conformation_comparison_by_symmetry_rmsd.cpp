...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_chemistry_conformation_comparison_by_symmetry_rmsd.cpp
  //!
  //! @author kothiwsk
  //! @date Mar 11, 2015
  ...
  class ExampleChemistryConformationComparisonBySymmetryRmsd :
    public ExampleInterface
  {
  public:

    ExampleChemistryConformationComparisonBySymmetryRmsd *Clone() const
    { return new ExampleChemistryConformationComparisonBySymmetryRmsd( *this);}
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      const double rmsd_a( chemistry::ConformationComparisonBySymmetryRmsd()( ensemble_vector( 1), ensemble_vector( 0)));
      BCL_MessageStd( "The RMSD between the first and second elements in the set is: " + util::Format()( rmsd_a));

      const double rmsd_b( chemistry::ConformationComparisonBySymmetryRmsd()( ensemble_vector( 0), ensemble_vector( 0)));
      ...
      (
        util::IsDefined
        (
          chemistry::ConformationComparisonBySymmetryRmsd()
          (
        ...
        false,
        "ConformationComparisonBySymmetryRmsd should not be able to compare constitutional-non-isomorphic molecules"
      );

      // calculate the rmsd between molecules 0 and 1 in the vector in both directions to make sure the results are
      // symmetric
      const double rmsd_1_0( chemistry::ConformationComparisonBySymmetryRmsd()( ensemble_vector( 1), ensemble_vector( 0)));
      const double rmsd_0_1( chemistry::ConformationComparisonBySymmetryRmsd()( ensemble_vector( 0), ensemble_vector( 1)));
    ...
    static const ExampleClass::EnumType ExampleChemistryConformationComparisonBySymmetryRmsd_Instance;

  }; //end ExampleChemistryConformationComparisonBySymmetryRmsd

  const ExampleClass::EnumType ExampleChemistryConformationComparisonBySymmetryRmsd::ExampleChemistryConformationComparisonBySymmetryRmsd_Instance
  (
    GetExamples().AddEnum( ExampleChemistryConformationComparisonBySymmetryRmsd())
  );
