...
//#include "chemistry/bcl_chemistry_fragment_swap_amide.h"
//
...
//  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  //!
//  //! @example example_chemistry_fragment_swap_amide.cpp
//  //!
...
//  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//  class ExampleChemistryFragmentSwapAmide :
//    public ExampleInterface
//  {
//  public:
//
//    ExampleChemistryFragmentSwapAmide *Clone() const
//    {
//      return new ExampleChemistryFragmentSwapAmide( *this);
//    }
//
//  /////////////////
//  // data access //
...
//      chemistry::FragmentSwapAmide fragment_swap_amide;
//
//      // clone function
//      util::ShPtr< chemistry::FragmentSwapAmide> fragment_swap_amide_clone( fragment_swap_amide.Clone());
//      BCL_ExampleCheck( fragment_swap_amide_clone.IsDefined(), true);
//
//      // construct with arguments
////      chemistry::FragmentSwapAmide fragment_swap_amideer
////      (
...
////      new_mutate = fragment_swap_amide( d6w);
...
////      const std::string fragment_swap_amide_out( AddExampleOutputPathToFilename( *new_molecule, "fragment_swap_amide.sdf"));
////      io::OFStream output;
////      BCL_ExampleMustOpenOutputFile( output, fragment_swap_amide_out);
////
////      // write out the constitution as we do not have coordinates
////      new_molecule->WriteMDL( output);
////      io::File::CloseClearFStream( output);
////      std::string correct_filename( fragment_swap_amide_out + ".correct");
//
//    //////////////////////
//    // input and output //
//    //////////////////////
...
//
//  }; //end ExampleChemistryFragmentSwapAmide
//
//  const ExampleClass::EnumType ExampleChemistryFragmentSwapAmide::s_Instance
//  (
//    GetExamples().AddEnum( ExampleChemistryFragmentSwapAmide())
//  );
//
//} // namespace bcl
