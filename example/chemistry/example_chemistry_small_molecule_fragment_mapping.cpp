...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_chemistry_small_molecule_fragment_mapping.cpp
  //!
  //! @author kothiwsk
  //! @date Jul 17, 2012
  ...
  class ExampleChemistrySmallMoleculeFragmentMapping :
    public ExampleInterface
  {
  public:

    ExampleChemistrySmallMoleculeFragmentMapping *Clone() const
    {
      return new ExampleChemistrySmallMoleculeFragmentMapping( *this);
    }
  ...
  /////////////////
    ...
    ////////////////
      ...
      BCL_ExampleCheck( bond_mapping.GetSize(), size_t( 47));
  ...
  }; //end ExampleChemistrySmallMoleculeFragmentMapping

  const ExampleClass::EnumType ExampleChemistrySmallMoleculeFragmentMapping::s_Instance
  (
    GetExamples().AddEnum( ExampleChemistrySmallMoleculeFragmentMapping())
  );
