...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_chemistry_conformation_comparison_property_rmsd_x.cpp
  //!
  //! @author mendenjl
  //! @date Apr 12, 2013
  ...
  class ExampleChemistryConformationComparisonPropertyRMSDX :
    public ExampleInterface
  {
  public:

    ExampleChemistryConformationComparisonPropertyRMSDX *Clone() const
    { return new ExampleChemistryConformationComparisonPropertyRMSDX( *this);}
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      const double rmsd_a( chemistry::ConformationComparisonPropertyRMSDX()( ensemble_vector( 1), ensemble_vector( 0)));
      BCL_MessageStd( "The RMSD between the first and second elements in the set is: " + util::Format()( rmsd_a));

      const double rmsd_b( chemistry::ConformationComparisonPropertyRMSDX()( ensemble_vector( 0), ensemble_vector( 0)));
      ...
      (
        chemistry::ConformationComparisonPropertyRMSDX()
        (
        ...
        1.44706,
        0.50,
        "ConformationComparisonPropertyRMSDX should be able to compare constitutional-non-isomorphic molecules"
      );

      // calculate the rmsd between molecules 0 and 1 in the vector in both directions to make sure the results are
      // symmetric
      const double rmsd_1_0( chemistry::ConformationComparisonPropertyRMSDX()( ensemble_vector( 1), ensemble_vector( 0)));
      const double rmsd_0_1( chemistry::ConformationComparisonPropertyRMSDX()( ensemble_vector( 0), ensemble_vector( 1)));
    ...
    static const ExampleClass::EnumType ExampleChemistryConformationComparisonPropertyRMSDX_Instance;

  }; //end ExampleChemistryConformationComparisonPropertyRMSDX

  const ExampleClass::EnumType ExampleChemistryConformationComparisonPropertyRMSDX::ExampleChemistryConformationComparisonPropertyRMSDX_Instance
  (
    GetExamples().AddEnum( ExampleChemistryConformationComparisonPropertyRMSDX())
  );
