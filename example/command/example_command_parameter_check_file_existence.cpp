...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_command_parameter_check_file_existence.cpp
  //!
  //! @author heinzes1
  //! @date Nov 6, 2010
  ...
  class ExampleCommandParameterCheckFileExistence :
    public ExampleInterface
  {
  public:

    ExampleCommandParameterCheckFileExistence *Clone() const
    {
      return new ExampleCommandParameterCheckFileExistence( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      util::ShPtr< command::ParameterCheckInterface> param_check_exists( new command::ParameterCheckFileExistence());
    ...
    /////////////////
      ...
      BCL_ExampleCheck
      (
        GetStaticClassName< command::ParameterCheckFileExistence>(),
    ...
    //////////////////////
      ...
      command::ParameterCheckFileExistence parameter_check_exists_read;
  ...
  }; //end ExampleCommandParameterCheckFileExistence

  const ExampleClass::EnumType ExampleCommandParameterCheckFileExistence::s_Instance
  (
    GetExamples().AddEnum( ExampleCommandParameterCheckFileExistence())
  );
