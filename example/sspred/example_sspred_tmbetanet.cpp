...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_sspred_tmbetanet.cpp
  //!
  ...
  class ExampleSspredTMBETANET :
    public ExampleInterface
  {
  public:

    ExampleSspredTMBETANET *Clone() const
    {
      return new ExampleSspredTMBETANET( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      sspred::TMBETANET def_construct;
    ...
    /////////////////
      ...
      const std::string extension( ".tmbetanet");
    ...
    ////////////////
      ...
      // read from file
      BCL_ExampleMustOpenInputFile( read, AddExampleInputPathToFilename( e_Biology, "1b43A.tmbetanet"));
      def_construct.ReadPredictionsForAASequence( read, seq);
      const linal::Vector3D correct_pred( 0.0, 1.0, 0.0);
      const sspred::TMBETANET pred_construct( strand);
      ...
      (
        seq.GetAA( 14)->GetSSPrediction( sspred::GetMethods().e_TMBETANET)->GetThreeStatePrediction(),
        def_prediction,
        0.001
      );
      ...
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 15)->GetSSPrediction( sspred::GetMethods().e_TMBETANET)->GetThreeStatePrediction(),
        correct_pred,
        0.001
      );
      ...
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 25)->GetSSPrediction( sspred::GetMethods().e_TMBETANET)->GetThreeStatePrediction(),
        correct_pred,
        0.001
      );
      ...
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 26)->GetSSPrediction( sspred::GetMethods().e_TMBETANET)->GetThreeStatePrediction(),
        def_prediction,
        0.001
      );
      ...
      )
      {
        ...
        (
          ...
          ( *aa_itr)->GetSSPrediction( sspred::GetMethods().e_TMBETANET)->GetOneStateSSPrediction().GetName()
        );
      }
  ...
  }; //end ExampleSspredTMBETANET

  const ExampleClass::EnumType ExampleSspredTMBETANET::s_Instance
  (
    GetExamples().AddEnum( ExampleSspredTMBETANET())
  );
