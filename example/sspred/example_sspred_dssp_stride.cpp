...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_sspred_dssp_stride.cpp
  //!
  //! @author mendenjl
  //! @date Aug 19, 2013
  ...
  class ExampleSspredDsspStride :
    public ExampleInterface
  {
  public:

    ExampleSspredDsspStride *Clone() const
    {
      return new ExampleSspredDsspStride( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      sspred::DsspStride strand_construct( biol::GetSSTypes().STRAND);
      sspred::DsspStride helix_construct( biol::GetSSTypes().e_HelixLeftAlpha);
    ...
    /////////////////
      ...
      const std::string extension( ".stridedssp");
    ...
    ////////////////
      ...
      // read from file
      BCL_ExampleMustOpenInputFile( read, AddExampleInputPathToFilename( e_Biology, "1ubiA.stridedssp"));
      strand_construct.ReadPredictionsForAASequence( read, seq);

      // middle residue in strand
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 12)->GetSSPrediction( sspred::GetMethods().e_StrideDSSP)->GetThreeStatePrediction(),
        strand,
        0.001
      );
      ...
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 22)->GetSSPrediction( sspred::GetMethods().e_StrideDSSP)->GetThreeStatePrediction(),
        helix,
        0.001
      );
      ...
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 33)->GetSSPrediction( sspred::GetMethods().e_StrideDSSP)->GetThreeStatePrediction(),
        helix,
        0.001
      );
      ...
      )
      {
        ...
        (
          ...
          ( *aa_itr)->GetSSPrediction( sspred::GetMethods().e_StrideDSSP)->GetOneStateSSPrediction().GetName()
        );
      }
    ...
    //////////////////////
      ...
      sspred::DsspStride def_construct;
  ...
  }; //end ExampleSspredDsspStride

  const ExampleClass::EnumType ExampleSspredDsspStride::s_Instance
  (
    GetExamples().AddEnum( ExampleSspredDsspStride())
  );
