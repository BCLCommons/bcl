...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_sspred_dssp.cpp
  //!
  //! @author mendenjl
  //! @date Aug 19, 2013
  ...
  class ExampleSspredDssp :
    public ExampleInterface
  {
  public:

    ExampleSspredDssp *Clone() const
    {
      return new ExampleSspredDssp( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      sspred::Dssp strand_construct( biol::GetSSTypes().STRAND);
      sspred::Dssp helix_construct( biol::GetSSTypes().e_HelixLeftAlpha);
    ...
    /////////////////
      ...
      const std::string extension( ".dssp");
    ...
    ////////////////
      ...
      // read from file
      BCL_ExampleMustOpenInputFile( read, AddExampleInputPathToFilename( e_Biology, "1ubiA.dssp"));
      strand_construct.ReadPredictionsForAASequence( read, seq);

      // middle residue in strand
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 12)->GetSSPrediction( sspred::GetMethods().e_DSSP)->GetThreeStatePrediction(),
        strand,
        0.001
      );
      ...
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 22)->GetSSPrediction( sspred::GetMethods().e_DSSP)->GetThreeStatePrediction(),
        helix,
        0.001
      );
      ...
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 33)->GetSSPrediction( sspred::GetMethods().e_DSSP)->GetThreeStatePrediction(),
        helix,
        0.001
      );
      ...
      )
      {
        ...
        (
          ...
          ( *aa_itr)->GetSSPrediction( sspred::GetMethods().e_DSSP)->GetOneStateSSPrediction().GetName()
        );
      }
  ...
  }; //end ExampleSspredDssp

  const ExampleClass::EnumType ExampleSspredDssp::s_Instance
  (
    GetExamples().AddEnum( ExampleSspredDssp())
  );
