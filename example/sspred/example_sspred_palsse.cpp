...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_sspred_palsse.cpp
  //!
  //! @author mendenjl
  //! @date Aug 19, 2013
  ...
  class ExampleSspredPalsse :
    public ExampleInterface
  {
  public:

    ExampleSspredPalsse *Clone() const
    {
      return new ExampleSspredPalsse( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      sspred::Palsse strand_construct( biol::GetSSTypes().STRAND);
      sspred::Palsse helix_construct( biol::GetSSTypes().e_HelixLeftAlpha);
    ...
    /////////////////
      ...
      const std::string extension( ".palsse");
    ...
    ////////////////
      ...
      // read from file
      BCL_ExampleMustOpenInputFile( read, AddExampleInputPathToFilename( e_Biology, "1ubiA.palsse"));
      strand_construct.ReadPredictionsForAASequence( read, seq);

      // middle residue in strand
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 12)->GetSSPrediction( sspred::GetMethods().e_PALSSE)->GetThreeStatePrediction(),
        strand,
        0.001
      );
      ...
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 22)->GetSSPrediction( sspred::GetMethods().e_PALSSE)->GetThreeStatePrediction(),
        helix,
        0.001
      );
      ...
      BCL_ExampleCheckWithinTolerance
      (
        seq.GetAA( 33)->GetSSPrediction( sspred::GetMethods().e_PALSSE)->GetThreeStatePrediction(),
        helix,
        0.001
      );
      ...
      )
      {
        ...
        (
          ...
          ( *aa_itr)->GetSSPrediction( sspred::GetMethods().e_PALSSE)->GetOneStateSSPrediction().GetName()
        );
      }
  ...
  }; //end ExampleSspredPalsse

  const ExampleClass::EnumType ExampleSspredPalsse::s_Instance
  (
    GetExamples().AddEnum( ExampleSspredPalsse())
  );
