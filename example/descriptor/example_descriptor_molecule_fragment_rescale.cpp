...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_molecule_fragment_rescale.cpp
  //!
  //! @author mendenjl
  //! @date Sep 08, 2017
  ...
  class ExampleDescriptorMoleculeFragmentRescale :
    public ExampleInterface
  {
  public:

    ExampleDescriptorMoleculeFragmentRescale *Clone() const
    {
      return new ExampleDescriptorMoleculeFragmentRescale( *this);
    }
  ...
  }; //end ExampleDescriptorMoleculeFragmentRescale

  const ExampleClass::EnumType ExampleDescriptorMoleculeFragmentRescale::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorMoleculeFragmentRescale())
  );
