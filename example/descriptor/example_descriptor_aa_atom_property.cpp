...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_aa_atom_property.cpp
  //!
  //! @author mendenjl
  //! @date Sep 17, 2013
  ...
  class ExampleDescriptorAAAtomProperty :
    public ExampleInterface
  {
  public:

    ExampleDescriptorAAAtomProperty *Clone() const
    {
      return new ExampleDescriptorAAAtomProperty( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      // backbone
      descriptor::AAAtomProperty aa_vcharge
      (
        true,
        true,
        false,
        descriptor::CheminfoProperty( "Exponentiate( lhs=Exponentiate( lhs=Atom_Vcharge, rhs=2),rhs=0.5)")
      );
    ...
    /////////////////
      ...
      BCL_ExampleCheck( aa_vcharge.GetAlias(), "SumAtomProperty");
    ...
    ///////////////
      ...
      const double expected_aa_vcharge( 2.64513);
  ...
  }; //end ExampleDescriptorAAAtomProperty

  const ExampleClass::EnumType ExampleDescriptorAAAtomProperty::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorAAAtomProperty())
  );
