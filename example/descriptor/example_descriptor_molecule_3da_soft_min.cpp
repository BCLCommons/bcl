...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_molecule_3da_soft_min.cpp
  //!
  //! @author kothiwsk
  //! @date Feb 12, 2014
  ...
  class ExampleDescriptorMolecule3DASoftMin :
    public ExampleInterface
  {
  public:

    ExampleDescriptorMolecule3DASoftMin *Clone() const
    {
      return new ExampleDescriptorMolecule3DASoftMin( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      descriptor::Molecule3DASoftMin rdf_code( atom_property, 48, 0.25, 100);

      // test copy constructor
      descriptor::Molecule3DASoftMin copy_rdf_code( rdf_code);
    ...
    /////////////////
      ...
      {
        1.93146e-05, 0.49324, 0.49324, -0.222184, -0.390687, -0.441989, -0.101381, -0.104289, -0.0287338, -0.376031,
        -0.303917, -0.438851, -0.140678, -0.143946, -0.398371, -0.191292, -0.385211, -0.380022, -0.216155, -0.387017,
        -0.37946, -0.369288, -0.194058, -0.377173, -0.388412, -0.376919, -0.387345, -0.388577, -0.451912, -0.240781,
        -0.379604, -0.144818, -0.386838, -0.357707, -0.368963, -0.464699, -0.387908, -0.379639, -0.117516, -0.376376,
        -0.376401, -0.130824, -0.389431, -0.387526, -0.256352, -0.116173, -0.14919, -0.219168
      };
    ...
    //////////////////////
      ...
      (
        TestBCLObjectIOForSymmetry( rdf_code, descriptor::Molecule3DASoftMin( atom_property)),
        true,
        "Molecule3DASoftMin I/O"
      );
  ...
  }; //end ExampleDescriptorMolecule3DASoftMin

  const ExampleClass::EnumType ExampleDescriptorMolecule3DASoftMin::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorMolecule3DASoftMin())
  );
