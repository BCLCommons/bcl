...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_molecule_fragment_statistics.cpp
  //!
  //! @author mendenjl
  //! @date Jan 16, 2015
  ...
  class ExampleDescriptorMoleculeFragmentStatistics :
    public ExampleInterface
  {
  public:

    ExampleDescriptorMoleculeFragmentStatistics *Clone() const
    {
      return new ExampleDescriptorMoleculeFragmentStatistics( *this);
    }
  ...
  }; //end ExampleDescriptorMoleculeFragmentStatistics

  const ExampleClass::EnumType ExampleDescriptorMoleculeFragmentStatistics::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorMoleculeFragmentStatistics())
  );
