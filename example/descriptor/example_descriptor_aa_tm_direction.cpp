...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_aa_tm_direction.cpp
  //!
  //! @author mendenjl
  //! @date Sep 19, 2017
  ...
  class ExampleDescriptorAATMDirection :
    public ExampleInterface
  {
  public:

    ExampleDescriptorAATMDirection *Clone() const
    {
      return new ExampleDescriptorAATMDirection( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      // compute CIPhiPsi secondary structure labels
      sspred::CIPhiPsi().Calculate( ubiquiton, true);

      // create a descriptor that will retrieve jufo SS information
      descriptor::AATMDirection orientation( sspred::CIPhiPsi::e_NonMembrane, "NonMembrane");
  ...
  }; //end ExampleDescriptorAATMDirection

  const ExampleClass::EnumType ExampleDescriptorAATMDirection::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorAATMDirection())
  );
