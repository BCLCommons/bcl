...
#include "descriptor/bcl_descriptor_sort.h"
...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_sort.cpp
  //!
  //! @author kothiwsk
  //! @date Feb 18, 2014
  ...
  class ExampleDescriptorSort :
    public ExampleInterface
  {
  public:

    ExampleDescriptorSort *Clone() const
    {
      return new ExampleDescriptorSort( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      descriptor::Sort< chemistry::AtomConformationalInterface> small_mol_prop_log_default( true);

      // test Clone
      util::ShPtr< descriptor::Sort< chemistry::AtomConformationalInterface> > sp_small_mol_prop_log( small_mol_prop_log_default.Clone());
  ...
  }; //end ExampleDescriptorSort

  const ExampleClass::EnumType ExampleDescriptorSort::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorSort())
  );
