...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_atom_estimated_surface_area.cpp
  //!
  ...
  class ExampleDescriptorAtomEstimatedSurfaceArea :
    public ExampleInterface
  {
  public:

    ExampleDescriptorAtomEstimatedSurfaceArea *Clone() const
    {
      return new ExampleDescriptorAtomEstimatedSurfaceArea( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      descriptor::AtomEstimatedSurfaceArea surfacearea_a;

      // test copy constructor
      descriptor::AtomEstimatedSurfaceArea surfacearea_b( surfacearea_a);

      // test Clone
      util::ShPtr< descriptor::AtomEstimatedSurfaceArea> sp_surfacearea_c( surfacearea_b.Clone());
    ...
    ////////////////////////////////////////
      ...
      descriptor::AtomEstimatedSurfaceArea surfacearea_c( false, true);
      ...
      (
        descriptor::AtomEstimatedSurfaceArea( false, false).CollectValuesOnEachElementOfObject( small_mol),
  ...
  const ExampleClass::EnumType ExampleDescriptorAtomEstimatedSurfaceArea::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorAtomEstimatedSurfaceArea())
  );
} // namespace bcl
