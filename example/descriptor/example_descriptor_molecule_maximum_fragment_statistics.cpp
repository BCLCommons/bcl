...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_molecule_maximum_fragment_statistics.cpp
  //!
  //! @author kothiwsk
  //! @date Nov 24, 2015
  ...
  class ExampleDescriptorMoleculeMaximumFragmentStatistics :
    public ExampleInterface
  {
  public:

    ExampleDescriptorMoleculeMaximumFragmentStatistics *Clone() const
    {
      return new ExampleDescriptorMoleculeMaximumFragmentStatistics( *this);
    }
  ...
  }; //end ExampleDescriptorMoleculeMaximumFragmentStatistics

  const ExampleClass::EnumType ExampleDescriptorMoleculeMaximumFragmentStatistics::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorMoleculeMaximumFragmentStatistics())
  );
