...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_molecule_log_p2008.cpp
  //!
  //! @author geanesar
  //! @date Jun 30, 2015
  ...
  class ExampleDescriptorMoleculeLogP2008 :
    public ExampleInterface
  {
  public:

    ExampleDescriptorMoleculeLogP2008 *Clone() const
    {
      return new ExampleDescriptorMoleculeLogP2008( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      // default constructor
      descriptor::MoleculeLogP2008 logp;

      // copy constructor
      descriptor::MoleculeLogP2008 logp_copy( logp);

    /////////////////
    // data access //
    /////////////////

      BCL_ExampleCheck( logp.GetAlias(), "LogP2008");
      BCL_ExampleCheck( logp.GetString(), "LogP2008");
  ...
  }; //end ExampleDescriptorMoleculeLogP2008

  const ExampleClass::EnumType ExampleDescriptorMoleculeLogP2008::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorMoleculeLogP2008())
  );
