...
#include "descriptor/bcl_descriptor_outer_product.h"
...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_outer_product.cpp
  //!
  //! @author mendenjl
  //! @date May 17, 2014
  ...
  class ExampleDescriptorOuterProduct :
    public ExampleInterface
  {
  public:

    ExampleDescriptorOuterProduct *Clone() const
    {
      return new ExampleDescriptorOuterProduct( *this);
    }
  ...
  }; //end ExampleOuterProduct

  const ExampleClass::EnumType ExampleDescriptorOuterProduct::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorOuterProduct())
  );
} // namespace bcl
