...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_structure_search.cpp
  //!
  //! @author mendenjl
  //! @date Aug 27, 2014
  ...
  class ExampleDescriptorStructureSearch :
    public ExampleInterface
  {
  public:

    ExampleDescriptorStructureSearch *Clone() const
    {
      return new ExampleDescriptorStructureSearch( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      (
        "StructureSearch(ignore h=True,atom comparison=ElementType,bond comparison=Identity,"
        "filename=" + cyclohexane_filename + ")"
      );
      descriptor::CheminfoProperty has_cyclohexane
      (
        "StructureSearch(ignore h=True,atom comparison=AtomType,bond comparison=BondOrderOrAromaticWithRingness,"
        "filename=" + cyclohexane_filename + ")"
      );
      ...
      descriptor::StructureSearch structure_search;

      BCL_ExampleCheck( structure_search.GetAlias(), "StructureSearch");
      ...
      BCL_ExampleCheck( TestMoleculeWithDescriptor( taxol_filename, has_six_membered_carbon_ring), float( 1.0));
      BCL_ExampleCheck( TestMoleculeWithDescriptor( taxol_filename, has_cyclohexane), float( 1.0));
      BCL_ExampleCheck( TestMoleculeWithDescriptor( taxol_filename, has_benzene), float( 1.0));
      BCL_ExampleCheck( TestMoleculeWithDescriptor( diazepam_filename, has_six_membered_carbon_ring), float( 1.0));
      BCL_ExampleCheck( TestMoleculeWithDescriptor( diazepam_filename, has_cyclohexane), float( 0.0));
      BCL_ExampleCheck( TestMoleculeWithDescriptor( diazepam_filename, has_benzene), float( 1.0));
  ...
  }; //end ExampleDescriptorStructureSearch

  const ExampleClass::EnumType ExampleDescriptorStructureSearch::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorStructureSearch())
  );
