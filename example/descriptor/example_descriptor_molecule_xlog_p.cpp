...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_molecule_xlog_p.cpp
  //!
  //! @author brownbp1
  //! @date Mar 22, 2020
  ...
  class ExampleDescriptorMoleculeXLogP :
    public ExampleInterface
  {
  public:

    ExampleDescriptorMoleculeXLogP *Clone() const
    {
      return new ExampleDescriptorMoleculeXLogP( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      // default constructor
      descriptor::MoleculeXLogP logp;

      // copy constructor
      descriptor::MoleculeXLogP logp_copy( logp);

    /////////////////
    // data access //
    /////////////////

      BCL_ExampleCheck( logp.GetAlias(), "XLogP");
      BCL_ExampleCheck( logp.GetString(), "XLogP");
  ...
  }; //end ExampleDescriptorMoleculeXLogP

  const ExampleClass::EnumType ExampleDescriptorMoleculeXLogP::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorMoleculeXLogP())
  );
