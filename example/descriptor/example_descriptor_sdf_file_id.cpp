...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_descriptor_sdf_file_id.cpp
  //!
  //! @author kothiwsk
  //! @date Nov 10, 2014
  ...
  class ExampleDescriptorSdfFileId :
    public ExampleInterface
  {
  public:

    ExampleDescriptorSdfFileId *Clone() const
    {
      return new ExampleDescriptorSdfFileId( *this);
    }
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      descriptor::SdfFileId id_defualt( chemistry::MoleculeStorageFile::e_Conformation);
      ...
      (
        ...
        true,
        "SdfFileId construction from: " + label
      );
      BCL_ExampleIndirectCheck
      (
      ...
      )
      {
        ...
        if( id_vector != util::Format()( index))
        {
          ...
          (
            id_vector,
            util::Format()( index),
            "SdfFileId determined keys properly from a file"
          );
  ...
  }; //end ExampleDescriptorSdfFileId

  const ExampleClass::EnumType ExampleDescriptorSdfFileId::s_Instance
  (
    GetExamples().AddEnum( ExampleDescriptorSdfFileId())
  );
