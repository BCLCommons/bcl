...
namespace bcl
{
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_math_sum_function.cpp
  //!
  ...
  class ExampleMathSumFunction :
    public ExampleInterface
  {

  public:

    ExampleMathSumFunction *Clone() const
    {
      return new ExampleMathSumFunction( *this);
    }
  ...
  }; //end ExampleMathSumFunction

  const ExampleClass::EnumType ExampleMathSumFunction::s_Instance
  (
    GetExamples().AddEnum( ExampleMathSumFunction())
  );
