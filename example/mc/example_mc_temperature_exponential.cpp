...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_mc_temperature_exponential.cpp
  //!
  //! @author mendenjl
  //! @date Nov 23, 2013
  ...
  class ExampleMcTemperatureExponential :
    public ExampleInterface
  {
  public:

    ExampleMcTemperatureExponential *Clone() const
    {
      return new ExampleMcTemperatureExponential( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      mc::TemperatureExponential default_constructor;

      // test parameterized constructor
      const double start_temp( 100.0);
      const double end_temp( 1.0);
      const size_t iterations( 30);
      mc::TemperatureExponential param_constructor( start_temp, end_temp, iterations);
    ...
    //////////////////////
      ...
      BCL_ExampleIndirectCheck
      (
        TestBCLObjectIOForSymmetry( param_constructor, mc::TemperatureExponential()),
        true,
  ...
  }; //end ExampleMcTemperatureExponential

  const ExampleClass::EnumType ExampleMcTemperatureExponential::s_Instance
  (
    GetExamples().AddEnum( ExampleMcTemperatureExponential())
  );
