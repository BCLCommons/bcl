...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_score_data_set_pairwise_sse_term.cpp
  //!
  //! @author alexanns
  //! @date May 27, 2011
  ...
  class ExampleScoreDataSetPairwiseSSETerm :
    public ExampleInterface
  {
  public:

    ExampleScoreDataSetPairwiseSSETerm *Clone() const
    {
      return new ExampleScoreDataSetPairwiseSSETerm( *this);
    }
  ...
  /////////////////
    ...
    ///////////////
      ...
      score::DataSetPairwiseSSETerm score( sse_pool);
      ...
      // test data set with some data
      {
        ...
        const double expected_score( -0.878205);
  ...
  }; //end ExampleScoreDataSetPairwiseSSETerm

  const ExampleClass::EnumType ExampleScoreDataSetPairwiseSSETerm::s_Instance
  (
    GetExamples().AddEnum( ExampleScoreDataSetPairwiseSSETerm())
  );
