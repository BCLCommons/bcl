...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_score_data_set_pairwise_data_density.cpp
  //!
  //! @author alexanns
  //! @date May 26, 2011
  ...
  class ExampleScoreDataSetPairwiseDataDensity :
    public ExampleInterface
  {
  public:

    ExampleScoreDataSetPairwiseDataDensity *Clone() const
    {
      return new ExampleScoreDataSetPairwiseDataDensity( *this);
    }
  ...
  /////////////////
    ...
    ////////////////
      ...
      score::DataSetPairwiseDataDensity score( 100);
      ...
      // test data set with some data
      {
        ...
        const double expected_score( -0.0238506);
      ...
      // test data set with some data
      {
        ...
        const double score_of_dataset( score( data_set));
        const double expected_score( -0.0422876);
      ...
      // test data set with data point on same position
      {
        ...
        const double expected_score( -0.40236);
  ...
  }; //end ExampleScoreDataSetPairwiseDataDensity

  const ExampleClass::EnumType ExampleScoreDataSetPairwiseDataDensity::s_Instance
  (
    GetExamples().AddEnum( ExampleScoreDataSetPairwiseDataDensity())
  );
