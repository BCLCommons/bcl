...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_score_protein_model_sse_chirality.cpp
  //!
  //! @author mendenjl
  //! @date Mar 15, 2017
  ...
  class ExampleScoreProteinModelSSEChirality :
    public ExampleInterface
  {
  public:

    ExampleScoreProteinModelSSEChirality *Clone() const
    {
      return new ExampleScoreProteinModelSSEChirality( *this);
    }
  ...
  /////////////////
    ...
    //////////////////////////////////
      ...
      score::ProteinModelSSEChirality loop_dist_along_sse_unnorm;

      BCL_MessageStd( "test clone");
      util::ShPtr< score::ProteinModelSSEChirality> sp_loop( loop_dist_along_sse_unnorm.Clone());
    ...
    ////////////////
      ...
      BCL_ExampleCheckWithinAbsTolerance( loop_dist_along_sse_unnorm( native_model), -72.105, 0.01);
      BCL_ExampleCheckWithinAbsTolerance( loop_dist_along_sse_unnorm( bad_loops_model), -74.1434, 0.01);
  ...
  }; //end ExampleScoreProteinModelSSEChirality

  const ExampleClass::EnumType ExampleScoreProteinModelSSEChirality::s_Instance
  (
    GetExamples().AddEnum( ExampleScoreProteinModelSSEChirality())
  );
