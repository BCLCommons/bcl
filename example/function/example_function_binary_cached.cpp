...
#include "function/bcl_function_binary_cached.h"
...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_function_binary_cached.cpp
  //!
  ...
  class ExampleFunctionBinaryCached :
  ...
  public:
    ...
    class GradeExam :
      public function::BinaryInterface< const Teacher, const Student, double>
    {
    ...
    class GradeAverage :
      public function::BinaryInterface< const Student, const Student, double>
    {
      mutable size_t m_UseCounter; //!< Tracks how many times this object was called
    ...
    ExampleFunctionBinaryCached *Clone() const
    {
      return new ExampleFunctionBinaryCached( *this);
    }
  ...
  /////////////////
    ...
    (
      ...
      const function::BinaryCached< const Teacher, const Student, double> &CACHE_FUNC,
    ...
    (
      ...
      const function::BinaryCached< const Student, const Student, double> &CACHE_FUNC,
    ...
    //////////////////////////////////
      ...
      function::BinaryCached< const Teacher, const Student, double> cache_function_grade_exam
      (
        sp_evaluate_grade_exam, &Teacher::GetDestructorSignal, &Student::GetDestructorSignal
      );
      function::BinaryCached< const Teacher, const Student, double> cache_function_grade_exam_no_invalidate
      (
        sp_evaluate_grade_exam, &Teacher::GetDestructorSignal, &Student::GetDestructorSignal
      );

      // identical arguments
      function::BinaryCached< const Student, const Student, double> cache_function_grade_avg_sym
      (
        sp_evaluate_grade_avg, &Student::GetDestructorSignal, true
      );
      function::BinaryCached< const Student, const Student, double> cache_function_grade_diff
      (
        sp_evaluate_grade_diff, &Student::GetDestructorSignal, false
      );
      function::BinaryCached< const Student, const Student, double> cache_function_grade_diff_wrong
      (
        sp_evaluate_grade_diff, &Student::GetDestructorSignal, true
      );

      // copy constructor
      function::BinaryCached< const Teacher, const Student, double> copy_cache_function_grade_exam
      (
      ...
      function::BinaryCached< const Student, const Student, double> copy_cache_function_grade_diff( cache_function_grade_diff_wrong);
      BCL_Example_Check
      (
      ...
      // clone
      util::ShPtr< function::BinaryCached< const Teacher, const Student, double> >
        sp_clone_cache_function_grade_exam( cache_function_grade_exam.Clone());

      util::ShPtr< function::BinaryCached< const Student, const Student, double> >
    ...
    //////////////////////
      ...
      function::BinaryCached< const Teacher, const Student, double> cache_function_grade_exam_read
      (
        ( util::ShPtr< function::BinaryInterface< const Teacher, const Student, double> >()),
      ...
      // read into empty cache function
      function::BinaryCached< const Student, const Student, double> cache_function_grade_avg_sym_read
      (
        ( util::ShPtr< function::BinaryInterface< const Student, const Student, double> >()),
        &Student::GetDestructorSignal,
        false
      );
  ...
  }; //end ExampleFunctionBinaryCached

  const util::SiPtr< const util::ObjectInterface> ExampleFunctionBinaryCached::GradeExam::s_Instance
  (
    GetObjectInstances().AddInstance( new ExampleFunctionBinaryCached::GradeExam())
  );
  const util::SiPtr< const util::ObjectInterface> ExampleFunctionBinaryCached::GradeAverage::s_Instance
  (
    GetObjectInstances().AddInstance( new ExampleFunctionBinaryCached::GradeAverage())
  );
  const util::SiPtr< const util::ObjectInterface> ExampleFunctionBinaryCached::GradeDifference::s_Instance
  (
    GetObjectInstances().AddInstance( new ExampleFunctionBinaryCached::GradeDifference())
  );

  const ExampleClass::EnumType ExampleFunctionBinaryCached::s_Instance
  (
    GetExamples().AddEnum( ExampleFunctionBinaryCached())
  );
