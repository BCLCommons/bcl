...
#include "function/bcl_function_unary_cached.h"
...
namespace bcl
{
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //!
  //! @example example_function_unary_cached.cpp
  //!
  //! @author woetzen
  //! @date Nov 6, 2010
  ...
  class ExampleFunctionUnaryCached :
  ...
  public:
    ...
    class TimeToGraduation :
      public function::UnaryInterface< const Student, int>
    {
    private:
    ...
    ExampleFunctionUnaryCached *Clone() const
    {
      return new ExampleFunctionUnaryCached( *this);
    }
  ...
  /////////////////
    ...
    int Run() const
    {
      ...
      util::ShPtr< function::UnaryInterface< const Student, int> > sp_evaluate( new TimeToGraduation());
    ...
    //////////////////////////////////
      ...
      function::UnaryCached< const Student, int> cache_function( sp_evaluate, &Student::GetDestructorSignal);
      function::UnaryCached< const Student, int> cache_function_no_invalidate( sp_evaluate, &Student::GetDestructorSignal);
      ...
      // copy constructor
      function::UnaryCached< const Student, int> copy_cache_function( cache_function_no_invalidate);
      BCL_Example_Check
      (
      ...
      // clone
      util::ShPtr< function::UnaryCached< const Student, int> > sp_clone( cache_function.Clone());
      BCL_Example_Check
      (
    ...
    /////////////////
      ...
      BCL_ExampleCheck
      (
        ( GetStaticClassName< function::UnaryCached< const Student, int> >()),
        "bcl::function::UnaryCached<const-bcl::ExampleFunctionUnaryCached::Student,int>"
      );
    ...
    //////////////////////
      ...
      function::UnaryCached< const Student, int> cache_function_read
      (
        ( util::ShPtr< function::UnaryInterface< const Student, int> >()),
  ...
  }; //end ExampleFunctionUnaryCached

  const util::SiPtr< const util::ObjectInterface> ExampleFunctionUnaryCached::TimeToGraduation::s_Instance
  (
    GetObjectInstances().AddInstance( new ExampleFunctionUnaryCached::TimeToGraduation())
  );

  const ExampleClass::EnumType ExampleFunctionUnaryCached::s_Instance
  (
    GetExamples().AddEnum( ExampleFunctionUnaryCached())
  );
