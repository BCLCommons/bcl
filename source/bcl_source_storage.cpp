...
namespace bcl
{
  ...
  /////////////////////////////
    ...
    template class BCL_API Table< char>;
    template class BCL_API Table< double>;
    template class BCL_API Table< float>;
    template class BCL_API Table< size_t>;
...
namespace bcl
{
  namespace storage
  {
    ...
    template class BCL_API Vector< VectorND< 2, linal::Vector< double> > >;

    template class BCL_API VectorND< 2, linal::Vector< double> >;

    template class BCL_API Pair< double, util::ShPtr< math::FunctionInterfaceSerializable< assemble::ProteinModel, math::MutateResult< assemble::ProteinModel> > > >;

    template class BCL_API Pair< double, util::ShPtr< math::FunctionInterfaceSerializable< assemble::SSEPool, math::MutateResult< assemble::SSEPool> > > >;
