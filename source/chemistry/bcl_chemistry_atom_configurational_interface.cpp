...
namespace bcl
{
  ...
  /////////////////
    ...
    size_t AtomConfigurationalInterface::GetNumberValenceBonds() const
    {
    ...
    //! @return a reference the vector of valence bonds
    size_t AtomConfigurationalInterface::GetNumberElectronsInValenceBonds() const
    {
    ...
    const storage::Vector< ConstitutionalBondType> &AtomConfigurationalInterface::GetValenceBonds() const
    {
    ...
    sdf::AtomInfo AtomConfigurationalInterface::GetAtomInfo() const
    {
      return sdf::AtomInfo( GetAtomType(), GetChirality(), linal::Vector3D( 0.0), GetNumberValenceBonds() > 0);
    }
