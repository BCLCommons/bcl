...
namespace bcl
{
  namespace descriptor
  {
    ...
    const util::SiPtr< const util::ObjectInterface> Molecule3DDistribution::s_Instance
    (
      util::Enumerated< Base< chemistry::AtomConformationalInterface, float> >::AddInstance
      (
        new Molecule3DDistribution()
      )
    );
  ...
  //////////////////////////////////
    ...
    Molecule3DDistribution::Molecule3DDistribution() :
      m_NumberSteps( 12),
      m_StepSize( 1.0)
    {
      BCL_Assert
    ...
    (
      ...
      m_CenterProperty( CENTER_ATOM_PROPERTY),
    ...
    //! @return pointer to new Molecule3DDistribution
    Molecule3DDistribution *Molecule3DDistribution::Clone() const
    {
      return new Molecule3DDistribution( *this);
    }
  ...
  /////////////////
    ...
    const std::string &Molecule3DDistribution::GetClassIdentifier() const
    {
    ...
    const std::string &Molecule3DDistribution::GetAlias() const
    {
      static const std::string s_name( "3dDistribution");
      return s_name;
    }

    //! @brief get number of steps of code
    //! @return number of steps in 2da code
    size_t Molecule3DDistribution::GetNumberSteps() const
    {
    ...
    float Molecule3DDistribution::GetStepSize() const
    {
      return m_StepSize;
    }
    ...
    const CheminfoProperty &Molecule3DDistribution::GetAtomProperty() const
    {
  ...
  ////////////////
    ...
    //! implementations
    iterate::Generic< Base< chemistry::AtomConformationalInterface, float> > Molecule3DDistribution::GetInternalDescriptors()
    {
      return
    ...
    void Molecule3DDistribution::Calculate
    (
    ...
    )
    {
      ...
      )
      {
        ...
        weighted_center.AddWeightedObservation( itr_desc( 0)->GetPosition(), weight);
      }
  ...
  //////////////////////
    ...
    io::Serializer Molecule3DDistribution::GetSerializer() const
    {
    ...
    bool Molecule3DDistribution::ReadInitializerSuccessHook
    (
    ...
    void Molecule3DDistribution::Accumulate
    (
    ...
    )
    {
      ...
      {
        m_DiscreteCode( closest_step_low) += PROP_A;
      }
      else
      {
        ...
        if( closest_step_high == m_NumberSteps)
        {
          ...
          m_DiscreteCode( closest_step_low) += PROP_A * low_exp_factor;
        }
        else
        {
    ...
    void Molecule3DDistribution::SetObjectHook()
    {
    }
