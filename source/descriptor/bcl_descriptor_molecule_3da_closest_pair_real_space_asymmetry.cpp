...
#include "descriptor/bcl_descriptor_molecule_3da_closest_pair_real_space_asymmetry.h"
...
namespace bcl
{
  namespace descriptor
  {
    ...
    const util::SiPtr< const util::ObjectInterface> Molecule3DAClosestPairRealSpaceAsymmetry::s_Instance
    (
      util::Enumerated< Base< chemistry::AtomConformationalInterface, float> >::AddInstance
      (
        new Molecule3DAClosestPairRealSpaceAsymmetry()
      )
    );
  ...
  //////////////////////////////////
    ...
    Molecule3DAClosestPairRealSpaceAsymmetry::Molecule3DAClosestPairRealSpaceAsymmetry() :
          m_NumberSteps( 14),
          m_StepSize( 0.50),
          m_Temperature( 5.0),
          m_Smooth( true),
    ...
    //! @return pointer to new Molecule3DAClosestPairRealSpaceAsymmetry
    Molecule3DAClosestPairRealSpaceAsymmetry *Molecule3DAClosestPairRealSpaceAsymmetry::Clone() const
    {
      return new Molecule3DAClosestPairRealSpaceAsymmetry( *this);
    }
  ...
  /////////////////
    ...
    const std::string &Molecule3DAClosestPairRealSpaceAsymmetry::GetClassIdentifier() const
    {
    ...
    const std::string &Molecule3DAClosestPairRealSpaceAsymmetry::GetAlias() const
    {
      static const std::string s_name( "3DAClosestPairRealSpaceAsymmetry");
      return s_name;
    }

    //! @brief get number of steps of code
    //! @return number of steps in 2da code
    size_t Molecule3DAClosestPairRealSpaceAsymmetry::GetNumberSteps() const
    {
    ...
    float Molecule3DAClosestPairRealSpaceAsymmetry::GetStepSize() const
    {
      return m_StepSize;
    }
    ...
    const float &Molecule3DAClosestPairRealSpaceAsymmetry::GetTemperature() const
    {
    ...
    const CheminfoProperty &Molecule3DAClosestPairRealSpaceAsymmetry::GetAtomPropertyA() const
    {
      return m_AtomPropertyA;
    }
    //! @brief get atom property B of code
    //! @return atom property B mapped in 3da code
    const CheminfoProperty &Molecule3DAClosestPairRealSpaceAsymmetry::GetAtomPropertyB() const
    {
    ...
    storage::Map< std::string, storage::Pair< chemistry::FragmentComplete, storage::Map< util::ObjectDataLabel, linal::Vector< float> > > >
        Molecule3DAClosestPairRealSpaceAsymmetry::s_Pockets =
            storage::Map< std::string, storage::Pair< chemistry::FragmentComplete, storage::Map< util::ObjectDataLabel, linal::Vector< float> > > >();
    sched::Mutex Molecule3DAClosestPairRealSpaceAsymmetry::s_Mutex = sched::Mutex();
  ...
  ////////////////
    ...
    //! implementations
    iterate::Generic< Base< chemistry::AtomConformationalInterface, float> > Molecule3DAClosestPairRealSpaceAsymmetry::GetInternalDescriptors()
    {
      return
    ...
    CachePreference Molecule3DAClosestPairRealSpaceAsymmetry::GetNormalCachePreference() const
    {
    ...
    void Molecule3DAClosestPairRealSpaceAsymmetry::Calculate( linal::VectorReference< float> &STORAGE)
    {
      m_DiscreteCode = 0.0;
  ...
  //////////////////////
    ...
    void Molecule3DAClosestPairRealSpaceAsymmetry::Smooth( linal::VectorReference< float> &STORAGE) const
    {
      if( !m_Smooth)
      {
    ...
    void Molecule3DAClosestPairRealSpaceAsymmetry::Accumulate
    (
    ...
    )
    {
      ...
      if( product < 0)
      {
        ...
        // case where the mol a is negative and mol b is negative (-/+)
        if( PROP_A < 0)
        {
          sign_id = 2;
        }
        // case where the mol b is negative and mol a is negative (+/-)
        else
        {
          sign_id = 3;
        }
...
//      }
    ...
    io::Serializer Molecule3DAClosestPairRealSpaceAsymmetry::GetSerializer() const
    {
    ...
    bool Molecule3DAClosestPairRealSpaceAsymmetry::ReadInitializerSuccessHook
    (
    ...
    void Molecule3DAClosestPairRealSpaceAsymmetry::SetObjectHook()
    {
