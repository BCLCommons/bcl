...
#include "descriptor/bcl_descriptor_molecule_3da_pair_real_space_convolution.h"
...
namespace bcl
{
  namespace descriptor
  {
    ...
    const util::SiPtr< const util::ObjectInterface> Molecule3DAPairRealSpaceConvolution::s_Instance
    (
      util::Enumerated< Base< chemistry::AtomConformationalInterface, float> >::AddInstance
      (
        new Molecule3DAPairRealSpaceConvolution()
      )
    );
  ...
  //////////////////////////////////
    ...
    Molecule3DAPairRealSpaceConvolution::Molecule3DAPairRealSpaceConvolution() :
      Molecule3DAPairConvolution()
    {
    ...
    (
      ...
      Molecule3DAPairConvolution( ATOM_PROPERTY, NUMBER_STEPS, STEP_SIZE, WINDOW_SIZE),
      m_Cutoff( CUTOFF),
    ...
    //! @return pointer to new Molecule3DAPairRealSpaceConvolution
    Molecule3DAPairRealSpaceConvolution *Molecule3DAPairRealSpaceConvolution::Clone() const
    {
      return new Molecule3DAPairRealSpaceConvolution( *this);
    }
  ...
  /////////////////
    ...
    const std::string &Molecule3DAPairRealSpaceConvolution::GetClassIdentifier() const
    {
    ...
    const std::string &Molecule3DAPairRealSpaceConvolution::GetAlias() const
    {
      static const std::string s_name( "3DAPairRealSpaceConvolution");
      return s_name;
    }
  ...
  ////////////////
    ...
    void Molecule3DAPairRealSpaceConvolution::ReduceProteinPocket( chemistry::FragmentComplete &POCKET)
    {
  ...
  //////////////////////
    ...
    io::Serializer Molecule3DAPairRealSpaceConvolution::GetSerializer() const
    {
      io::Serializer parameters( Molecule3DAPairConvolution::GetSerializer());
    ...
    bool Molecule3DAPairRealSpaceConvolution::ReadInitializerSuccessHook
    (
      const util::ObjectDataLabel &LABEL,
      std::ostream &ERR_STREAM
    )
    {
      bool base( Molecule3DAPairConvolution::ReadInitializerSuccessHook( LABEL, ERR_STREAM));
      m_VoxelGridPocket = chemistry::VoxelGridAtom( m_Cutoff);
      return base;
    }

    //! @brief hook that derived classes can override to add behavior after every time SetObject is called
    void Molecule3DAPairRealSpaceConvolution::SetObjectHook()
    {
      // Reduce the protein pocket and then perform calculate in parent class
      Molecule3DAPairConvolution::SetObjectHook();
    }
