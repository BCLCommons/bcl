...
namespace bcl
{
  namespace descriptor
  {
    ...
    const util::SiPtr< const util::ObjectInterface> StructureCount::s_Instance
    (
  ...
  //////////////////////////////////
    ...
    StructureCount *StructureCount::Clone() const
    {
      return new StructureCount( *this);
    }
  ...
  /////////////////
    ...
    const std::string &StructureCount::GetClassIdentifier() const
    {
    ...
    const std::string &StructureCount::GetAlias() const
    {
      static const std::string s_name( "StructureCount");
      return s_name;
    }
  ...
  ////////////////
    ...
    )
    {
      ...
      )
      {
        ...
        if( isomorphism.FindDisparateIsomorphisms())
        {
          STORAGE( bit_position) = isomorphism.GetIsomorphisms().GetSize();
        }
      }
    } // calculate
    ...
    io::Serializer StructureCount::GetSerializer() const
    {
      io::Serializer parameters;
      parameters.SetClassDescription
      (
        "Searches for specified substructures within the query molecule. Returns the number of substructure matches that exist in the query "
        "molecule"
      );
      ...
      (
        "ignore h",
        "true to ignore hydrogens when comparing molecules",
    ...
    bool StructureCount::ReadInitializerSuccessHook( const util::ObjectDataLabel &LABEL, std::ostream &ERR_STREAM)
    {
      chemistry::ConformationGraphConverter graph_converter( m_AtomComparison, m_BondComparison, m_IgnoreH);
      io::IFStream input;
