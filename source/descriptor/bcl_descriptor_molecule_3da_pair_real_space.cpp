...
#include "descriptor/bcl_descriptor_molecule_3da_pair_real_space.h"
...
namespace bcl
{
  namespace descriptor
  {
    ...
    const util::SiPtr< const util::ObjectInterface> Molecule3DAPairRealSpace::s_Instance
    (
      util::Enumerated< Base< chemistry::AtomConformationalInterface, float> >::AddInstance
      (
        new Molecule3DAPairRealSpace()
      )
    );
    ...
    storage::Map< std::string, storage::Pair< chemistry::FragmentComplete, storage::Map< util::ObjectDataLabel, linal::Vector< float> > > >
        Molecule3DAPairRealSpace::s_Pockets =
            storage::Map< std::string, storage::Pair< chemistry::FragmentComplete, storage::Map< util::ObjectDataLabel, linal::Vector< float> > > >();
    sched::Mutex Molecule3DAPairRealSpace::s_Mutex = sched::Mutex();
  ...
  //////////////////////////////////
    ...
    Molecule3DAPairRealSpace::Molecule3DAPairRealSpace() :
      m_NumberSteps( 14),
      m_StepSize( 0.50),
      m_Temperature( 5.0),
      m_Smooth( true),
    ...
    //! @return pointer to new Molecule3DAPairRealSpace
    Molecule3DAPairRealSpace *Molecule3DAPairRealSpace::Clone() const
    {
      return new Molecule3DAPairRealSpace( *this);
    }
  ...
  /////////////////
    ...
    const std::string &Molecule3DAPairRealSpace::GetClassIdentifier() const
    {
    ...
    const std::string &Molecule3DAPairRealSpace::GetAlias() const
    {
      static const std::string s_name( "3DAPairRealSpace");
      return s_name;
    }

    //! @brief get number of steps of code
    //! @return number of steps in 2da code
    size_t Molecule3DAPairRealSpace::GetNumberSteps() const
    {
    ...
    float Molecule3DAPairRealSpace::GetStepSize() const
    {
      return m_StepSize;
    }
    ...
    const float &Molecule3DAPairRealSpace::GetTemperature() const
    {
    ...
    const CheminfoProperty &Molecule3DAPairRealSpace::GetAtomProperty() const
    {
  ...
  ////////////////
    ...
    //! implementations
    iterate::Generic< Base< chemistry::AtomConformationalInterface, float> > Molecule3DAPairRealSpace::GetInternalDescriptors()
    {
      return
    ...
    CachePreference Molecule3DAPairRealSpace::GetNormalCachePreference() const
    {
    ...
    void Molecule3DAPairRealSpace::Calculate( linal::VectorReference< float> &STORAGE)
    {
      m_DiscreteCode = 0.0;
      ...
      )
      {
        ...
        )
        {
          ...
          size_t bin_distance( 3 * size_t( itr_p->Second() / m_StepSize));
  ...
  //////////////////////
    ...
    void Molecule3DAPairRealSpace::Smooth( linal::VectorReference< float> &STORAGE) const
    {
      if( !m_Smooth)
      {
    ...
    void Molecule3DAPairRealSpace::Accumulate
    (
...
//      }
    ...
    io::Serializer Molecule3DAPairRealSpace::GetSerializer() const
    {
    ...
    bool Molecule3DAPairRealSpace::ReadInitializerSuccessHook
    (
    ...
    void Molecule3DAPairRealSpace::SetObjectHook()
    {
