...
cd -
# set log file
set REDIRECT_FILE = "${RESULTS_DIR}/make_log.txt"

# set cmake args
set CMAKE_ARGS = '-DCMAKE_BUILD_TYPE=Release'

# build bcl
set BUILD_COMMAND = "./scripts/nightly_build_helper/bcl_build.csh bcl-example-static ${TOOLCHAIN} ${CMAKE_ARGS} ${BUILD_MACHINE}"
...
# run examples
set COMMAND = "perl ./scripts/nightly_build_helper/bcl_run_individual_examples.pl ${RESULTS_DIR} ${EXECUTABLE}"
